...
goog.global = this,
    ...
    goog.provide = function (o) {
        if (!COMPILED) {
            if (goog.isProvided_(o))
                throw Error('Namespace "' + o + '" already declared.');
            delete goog.implicitNamespaces_[o];
            for (var t = o; (t = t.substring(0, t.lastIndexOf("."))) && !goog.getObjectByName(t);)
    ...
    goog.setTestOnly = function (o) {
        if (COMPILED && !goog.DEBUG)
            throw o = o || "",
            Error("Importing test-only code into non-debug environment" + (o ? ": " + o : "."))
    }
    ,
    goog.forwardDeclare = function (o) { }
    ,
    COMPILED || (goog.isProvided_ = function (o) {
        return !goog.implicitNamespaces_[o] && goog.isDefAndNotNull(goog.getObjectByName(o))
    }
        ,
        goog.implicitNamespaces_ = {}),
    goog.getObjectByName = function (o, t) {
        for (var e, i = o.split("."), n = t || goog.global; e = i.shift();) {
            if (!goog.isDefAndNotNull(n[e]))
                return null;
            n = n[e]
        }
        return n
    ...
    ,
    goog.addDependency = function (o, t, e) {
        if (goog.DEPENDENCIES_ENABLED) {
            for (var i, n, s = o.replace(/\\/g, "/"), r = goog.dependencies_, b = 0; i = t[b]; b++)
                r.nameToPath[i] = s,
                    s in r.pathToNames || (r.pathToNames[s] = {}),
                    r.pathToNames[s][i] = !0;
            for (var a = 0; n = e[a]; a++)
                s in r.requires || (r.requires[s] = {}),
                    r.requires[s][n] = !0
        }
    }
    ,
    ...
    goog.require = function (o) {
        if (!COMPILED) {
            ...
            var e = "goog.require could not find: " + o;
            throw goog.global.console && goog.global.console.error(e),
            Error(e)
        }
    }
    ,
    ...
    ,
    goog.identityFunction = function (o, t) {
        return o
    }
    ,
    ...
    goog.DEPENDENCIES_ENABLED && (goog.included_ = {},
            ...
            if (goog.global.CLOSURE_BASE_PATH)
                ...
                for (var o = goog.global.document.getElementsByTagName("script"), t = o.length - 1; t >= 0; --t) {
                    var e = o[t].src
                        , i = e.lastIndexOf("?")
                        , n = -1 == i ? e.length : i;
                    if ("base.js" == e.substr(n - 7, 7))
                        return void (goog.basePath = e.substr(0, n - 7))
                }
        }
        ,
        goog.importScript_ = function (o) {
            var t = goog.global.CLOSURE_IMPORT_SCRIPT || goog.writeScriptTag_;
            !goog.dependencies_.written[o] && t(o) && (goog.dependencies_.written[o] = !0)
        }
        ,
        goog.writeScriptTag_ = function (o) {
            if (goog.inHtmlDocument_()) {
                ...
                return t.write('<script type="text/javascript" src="' + o + '"><\/script>'),
                    !0
            }
            return !1
        }
        ...
        goog.writeScripts_ = function () {
            ...
            function i(n) {
                if (!(n in e.written))
                    if (n in e.visited)
                        ...
                        if (e.visited[n] = !0,
                            n in e.requires)
                            for (var s in e.requires[n])
                                if (!goog.isProvided_(s)) {
                                    if (!(s in e.nameToPath))
            ...
            for (var n in goog.included_)
                e.written[n] || i(n);
            for (var s = 0; s < o.length; s++) {
                if (!o[s])
                    throw Error("Undefined script input");
                goog.importScript_(goog.basePath + o[s])
            }
        }
        ,
    ...
    goog.typeOf = function (o) {
        ...
        if ("object" == t) {
            ...
            if ("[object Window]" == e)
                return "object";
            if ("[object Array]" == e || "number" == typeof o.length && void 0 !== o.splice && void 0 !== o.propertyIsEnumerable && !o.propertyIsEnumerable("splice"))
                return "array";
            if ("[object Function]" == e || void 0 !== o.call && void 0 !== o.propertyIsEnumerable && !o.propertyIsEnumerable("call"))
                return "function"
        } else if ("function" == t && void 0 === o.call)
            return "object";
        return t
    }
    ,
    ...
    goog.removeUid = function (o) {
        "removeAttribute" in o && o.removeAttribute(goog.UID_PROPERTY_);
        try {
    ...
    goog.globalEval = function (o) {
        if (goog.global.execScript)
            goog.global.execScript(o, "JavaScript");
        else {
            if (!goog.global.eval)
            ...
            if (null == goog.evalWorksForGlobals_ && (goog.global.eval("var _et_ = 1;"),
                ...
                e.type = "text/javascript",
                    e.defer = !1,
                    e.appendChild(t.createTextNode(o)),
    ...
    goog.getCssName = function (o, t) {
        var e, i = function (o) {
            return goog.cssNameMapping_[o] || o
        };
        return e = goog.cssNameMapping_ ? "BY_WHOLE" == goog.cssNameMappingStyle_ ? i : function (o) {
            for (var t = o.split("-"), e = [], n = 0; n < t.length; n++)
                e.push(i(t[n]));
            return e.join("-")
        }
            : function (o) {
    ...
    goog.inherits = function (o, t) {
        ...
        e.prototype = t.prototype,
            ...
            o.base = function (o, e, i) {
                var n = Array.prototype.slice.call(arguments, 2);
                return t.prototype[e].apply(o, n)
            }
    }
    ,
    goog.base = function (o, t, e) {
        ...
        if (i.superClass_)
            return i.superClass_.constructor.apply(o, Array.prototype.slice.call(arguments, 1));
        for (var n = Array.prototype.slice.call(arguments, 2), s = !1, r = o.constructor; r; r = r.superClass_ && r.superClass_.constructor)
            if (r.prototype[t] === i)
                s = !0;
            else if (s)
                return r.prototype[t].apply(o, n);
        if (o[t] === i)
            return o.constructor.prototype[t].apply(o, n);
    ...
    goog.defineClass = function (o, t) {
        ...
        var n = goog.defineClass.createSealingConstructor_(e, o);
        return o && goog.inherits(n, o),
            delete t.constructor,
            delete t.statics,
            goog.defineClass.applyProperties_(n.prototype, t),
            null != i && (i instanceof Function ? i(n) : goog.defineClass.applyProperties_(n, i)),
            n
    }
    ,
    goog.defineClass.ClassDescriptor,
    goog.define("goog.defineClass.SEAL_CLASS_INSTANCES", goog.DEBUG),
    goog.defineClass.createSealingConstructor_ = function (o, t) {
        if (goog.defineClass.SEAL_CLASS_INSTANCES && Object.seal instanceof Function) {
            if (t && t.prototype && t.prototype[goog.UNSEALABLE_CONSTRUCTOR_PROPERTY_])
                return o;
            var e = function () {
                var t = o.apply(this, arguments) || this;
                return this.constructor === e && Object.seal(t),
                    t
            };
            return e
        }
    ...
    goog.defineClass.applyProperties_ = function (o, t) {
        ...
        for (var i = 0; i < goog.defineClass.OBJECT_PROTOTYPE_FIELDS_.length; i++)
            e = goog.defineClass.OBJECT_PROTOTYPE_FIELDS_[i],
                Object.prototype.hasOwnProperty.call(t, e) && (o[e] = t[e])
    }
    ,
    ...
    Object.defineProperty || (Object.defineProperty = function (o, t, e) {
        Object.__defineGetter__ && ("get" in e ? o.__defineGetter__(t, e.get) : "value" in e && o.__defineGetter__(t, e.value)),
    ...
    box2d.b2_aabbExtension = .1,
    box2d.b2_aabbMultiplier = 2,
    box2d.b2_linearSlop = .008,
    ...
    box2d.b2_maxLinearCorrection = .2,
    ...
    box2d.b2_maxRotation = .5 * box2d.b2_pi,
    box2d.b2_maxRotationSquared = box2d.b2_maxRotation * box2d.b2_maxRotation,
    box2d.b2_baumgarte = .2,
    box2d.b2_toiBaumgarte = .75,
    box2d.b2_timeToSleep = .5,
    box2d.b2_linearSleepTolerance = .01,
    box2d.b2_angularSleepTolerance = 2 / 180 * box2d.b2_pi,
    box2d.b2Alloc = function (o) {
        return null
    }
    ,
    box2d.b2Free = function (o) { }
    ,
    box2d.b2Log = function (o) {
        goog.global.console.log.apply(null, arguments)
    }
    ,
    box2d.b2Version = function (o, t, e) {
        this.major = o || 0,
            this.minor = t || 0,
            this.revision = e || 0
    }
    ...
    ,
    box2d.b2ParseUInt = function (o) {
        return box2d.b2Abs(parseInt(o, 10))
    }
    ,
    box2d.b2MakeArray = function (o, t) {
        void 0 === o && (o = 0);
        var e = new Array(o);
        if (void 0 !== t)
            for (var i = 0; i < o; ++i)
    ...
    ,
    box2d.b2MakeNumberArray = function (o) {
    ...
    box2d.b2Abs = function (o) {
        return o < 0 ? -o : o
    }
    ,
    box2d.b2Min = function (o, t) {
        return o < t ? o : t
    }
    ,
    box2d.b2Max = function (o, t) {
        return o > t ? o : t
    }
    ,
    ...
    ,
    box2d.b2IsValid = function (o) {
        return isFinite(o)
    }
    ,
    box2d.b2Sq = function (o) {
        return o * o
    }
    ,
    box2d.b2InvSqrt = function (o) {
        return 1 / Math.sqrt(o)
    }
    ,
    box2d.b2Sqrt = function (o) {
        return Math.sqrt(o)
    }
    ,
    box2d.b2Pow = function (o, t) {
        return Math.pow(o, t)
    }
    ,
    box2d.b2DegToRad = function (o) {
        return o * box2d.b2_pi_over_180
    }
    ,
    box2d.b2RadToDeg = function (o) {
        return o * box2d.b2_180_over_pi
    }
    ,
    box2d.b2Cos = function (o) {
        return Math.cos(o)
    }
    ,
    box2d.b2Sin = function (o) {
        return Math.sin(o)
    }
    ,
    box2d.b2Acos = function (o) {
        return Math.acos(o)
    }
    ,
    box2d.b2Asin = function (o) {
        return Math.asin(o)
    }
    ,
    box2d.b2Atan2 = function (o, t) {
        return Math.atan2(o, t)
    }
    ,
    box2d.b2NextPowerOfTwo = function (o) {
        return o |= o >> 1 & 2147483647,
            o |= o >> 2 & 1073741823,
            o |= o >> 4 & 268435455,
            o |= o >> 8 & 16777215,
            (o |= o >> 16 & 65535) + 1
    ...
    ,
    box2d.b2IsPowerOfTwo = function (o) {
        return o > 0 && 0 == (o & o - 1)
    }
    ,
    ...
    ,
    box2d.b2RandomRange = function (o, t) {
        return (t - o) * Math.random() + o
    }
    ,
    box2d.b2Vec2 = function (o, t) {
        this.x = o || 0,
            this.y = t || 0
    }
    ,
    ...
    box2d.b2Vec2.MakeArray = function (o) {
        return box2d.b2MakeArray(o, function (o) {
    ...
    ,
    box2d.b2Vec2.prototype.SetXY = function (o, t) {
        return this.x = o,
            this.y = t,
            this
    }
    ...
    box2d.b2Vec2.prototype.SelfRotate = function (o, t) {
        var e = this.x
            , i = this.y;
        return this.x = o * e - t * i,
            this.y = t * e + o * i,
            this
    }
    ,
    box2d.b2Vec2.prototype.SelfRotateRadians = function (o) {
        return this.SelfRotate(Math.cos(o), Math.sin(o))
    }
    ,
    box2d.b2Vec2.prototype.SelfRotateDegrees = function (o) {
        return this.SelfRotateRadians(box2d.b2DegToRad(o))
    }
    ,
    ...
    ,
    box2d.b2Vec2.prototype.SelfCrossVS = function (o) {
        var t = this.x;
    ...
    ,
    box2d.b2Vec2.prototype.SelfCrossSV = function (o) {
        var t = this.x;
        return this.x = -o * this.y,
            this.y = o * t,
            this
    ...
    ,
    box2d.b2Vec2.prototype.SelfMinV = function (o) {
        return this.x = box2d.b2Min(this.x, o.x),
            this.y = box2d.b2Min(this.y, o.y),
            this
    }
    ,
    box2d.b2Vec2.prototype.SelfMaxV = function (o) {
        return this.x = box2d.b2Max(this.x, o.x),
            this.y = box2d.b2Max(this.y, o.y),
            this
    }
    ,
    box2d.b2Vec2.prototype.SelfAbs = function () {
        return this.x = box2d.b2Abs(this.x),
    ...
    ,
    box2d.b2AbsV = function (o, t) {
        return t.x = box2d.b2Abs(o.x),
            t.y = box2d.b2Abs(o.y),
            t
    }
    ,
    box2d.b2MinV = function (o, t, e) {
        return e.x = box2d.b2Min(o.x, t.x),
            e.y = box2d.b2Min(o.y, t.y),
            e
    }
    ,
    box2d.b2MaxV = function (o, t, e) {
        return e.x = box2d.b2Max(o.x, t.x),
            e.y = box2d.b2Max(o.y, t.y),
            e
    }
    ,
    box2d.b2ClampV = function (o, t, e, i) {
        return i.x = box2d.b2Clamp(o.x, t.x, e.x),
            i.y = box2d.b2Clamp(o.y, t.y, e.y),
            i
    }
    ,
    box2d.b2RotateV = function (o, t, e, i) {
        var n = o.x
            , s = o.y;
        return i.x = t * n - e * s,
            i.y = e * n + t * s,
    ...
    ,
    box2d.b2RotateRadiansV = function (o, t, e) {
        return box2d.b2RotateV(o, Math.cos(t), Math.sin(t), e)
    }
    ,
    box2d.b2RotateDegreesV = function (o, t, e) {
        return box2d.b2RotateRadiansV(o, box2d.b2DegToRad(t), e)
    }
    ,
    box2d.b2DotVV = function (o, t) {
        return o.x * t.x + o.y * t.y
    }
    ,
    box2d.b2CrossVV = function (o, t) {
        return o.x * t.y - o.y * t.x
    }
    ,
    box2d.b2CrossVS = function (o, t, e) {
        var i = o.x;
        return e.x = t * o.y,
            e.y = -t * i,
            e
    ...
    ,
    box2d.b2CrossVOne = function (o, t) {
        var e = o.x;
        return t.x = o.y,
            t.y = -e,
            t
    ...
    ,
    box2d.b2CrossSV = function (o, t, e) {
        var i = t.x;
        return e.x = -o * t.y,
            e.y = o * i,
            e
    ...
    ,
    box2d.b2CrossOneV = function (o, t) {
        var e = o.x;
        return t.x = -o.y,
            t.y = e,
            t
    ...
    ,
    box2d.b2AddVV = function (o, t, e) {
        return e.x = o.x + t.x,
            e.y = o.y + t.y,
            e
    }
    ,
    box2d.b2SubVV = function (o, t, e) {
        return e.x = o.x - t.x,
            e.y = o.y - t.y,
            e
    }
    ,
    box2d.b2MulSV = function (o, t, e) {
        return e.x = t.x * o,
            e.y = t.y * o,
            e
    }
    ,
    box2d.b2AddVMulSV = function (o, t, e, i) {
        return i.x = o.x + t * e.x,
            i.y = o.y + t * e.y,
            i
    }
    ,
    box2d.b2SubVMulSV = function (o, t, e, i) {
        return i.x = o.x - t * e.x,
            i.y = o.y - t * e.y,
            i
    }
    ,
    box2d.b2AddVCrossSV = function (o, t, e, i) {
        var n = e.x;
        return i.x = o.x - t * e.y,
            i.y = o.y + t * n,
            i
    }
    ,
    box2d.b2MidVV = function (o, t, e) {
        return e.x = .5 * (o.x + t.x),
            e.y = .5 * (o.y + t.y),
            e
    }
    ,
    box2d.b2ExtVV = function (o, t, e) {
        return e.x = .5 * (t.x - o.x),
            e.y = .5 * (t.y - o.y),
            e
    }
    ,
    box2d.b2IsEqualToV = function (o, t) {
        return o.x === t.x && o.y === t.y
    }
    ,
    box2d.b2DistanceVV = function (o, t) {
        var e = o.x - t.x
            , i = o.y - t.y;
        return Math.sqrt(e * e + i * i)
    }
    ,
    box2d.b2DistanceSquaredVV = function (o, t) {
        var e = o.x - t.x
            , i = o.y - t.y;
        return e * e + i * i
    }
    ,
    box2d.b2NegV = function (o, t) {
        return t.x = -o.x,
            t.y = -o.y,
            t
    }
    ,
    box2d.b2Vec3 = function (o, t, e) {
        this.x = o || 0,
            this.y = t || 0,
            this.z = e || 0
    }
    ...
    ,
    box2d.b2Vec3.prototype.SetXYZ = function (o, t, e) {
        return this.x = o,
            this.y = t,
            this.z = e,
            this
    ...
    ,
    box2d.b2DotV3V3 = function (o, t) {
        return o.x * t.x + o.y * t.y + o.z * t.z
    }
    ,
    box2d.b2CrossV3V3 = function (o, t, e) {
        var i = o.x
            , n = o.y
            , s = o.z
            , r = t.x
    ...
    ,
    box2d.b2Mat22.FromVV = function (o, t) {
        return (new box2d.b2Mat22).SetVV(o, t)
    }
    ,
    box2d.b2Mat22.FromSSSS = function (o, t, e, i) {
        return (new box2d.b2Mat22).SetSSSS(o, t, e, i)
    }
    ,
    box2d.b2Mat22.FromAngleRadians = function (o) {
        return (new box2d.b2Mat22).SetAngleRadians(o)
    }
    ,
    box2d.b2Mat22.prototype.SetSSSS = function (o, t, e, i) {
        return this.ex.SetXY(o, e),
            this.ey.SetXY(t, i),
            this
    }
    ,
    box2d.b2Mat22.prototype.SetVV = function (o, t) {
        return this.ex.Copy(o),
            this.ey.Copy(t),
            this
    }
    ,
    box2d.b2Mat22.prototype.SetAngle = function (o) {
        var t = Math.cos(o)
            , e = Math.sin(o);
        return this.ex.SetXY(t, e),
            this.ey.SetXY(-e, t),
            this
    }
    ,
    box2d.b2Mat22.prototype.SetAngleRadians = box2d.b2Mat22.prototype.SetAngle,
    box2d.b2Mat22.prototype.SetAngleDegrees = function (o) {
        return this.SetAngle(box2d.b2DegToRad(o))
    }
    ,
    box2d.b2Mat22.prototype.Copy = function (o) {
        return this.ex.Copy(o.ex),
            this.ey.Copy(o.ey),
            this
    }
    ,
    box2d.b2Mat22.prototype.SetIdentity = function () {
        return this.ex.SetXY(1, 0),
            this.ey.SetXY(0, 1),
            this
    }
    ,
    ...
    ,
    box2d.b2Mat22.prototype.SelfAddM = function (o) {
        return this.ex.SelfAdd(o.ex),
            this.ey.SelfAdd(o.ey),
            this
    }
    ,
    box2d.b2Mat22.prototype.SelfSubM = function (o) {
        return this.ex.SelfSub(o.ex),
            this.ey.SelfSub(o.ey),
            this
    }
    ,
    box2d.b2AbsM = function (o, t) {
        var e = o.ex
            , i = o.ey;
        return t.ex.x = box2d.b2Abs(e.x),
            t.ex.y = box2d.b2Abs(e.y),
            t.ey.x = box2d.b2Abs(i.x),
            t.ey.y = box2d.b2Abs(i.y),
            t
    }
    ,
    box2d.b2MulMV = function (o, t, e) {
        var i = o.ex
            , n = o.ey
            , s = t.x
            , r = t.y;
        return e.x = i.x * s + n.x * r,
            e.y = i.y * s + n.y * r,
            e
    }
    ,
    box2d.b2MulTMV = function (o, t, e) {
        var i = o.ex
            , n = o.ey
            , s = t.x
            , r = t.y;
        return e.x = i.x * s + i.y * r,
            e.y = n.x * s + n.y * r,
            e
    }
    ,
    box2d.b2AddMM = function (o, t, e) {
        var i = o.ex
            , n = o.ey
            , s = t.ex
            , r = t.ey;
        return e.ex.x = i.x + s.x,
            e.ex.y = i.y + s.y,
            e.ey.x = n.x + r.x,
            e.ey.y = n.y + r.y,
            e
    ...
    ,
    box2d.b2Mat33.prototype.SetVVV = function (o, t, e) {
        return this.ex.Copy(o),
            this.ey.Copy(t),
            this.ez.Copy(e),
            this
    ...
    ,
    box2d.b2Mat33.prototype.SelfAddM = function (o) {
        return this.ex.SelfAdd(o.ex),
            this.ey.SelfAdd(o.ey),
            this.ez.SelfAdd(o.ez),
            this
    }
    ,
    box2d.b2Mat33.prototype.Solve33 = function (o, t, e, i) {
        var n = this.ex.x
            , s = this.ex.y
            , r = this.ex.z
            , b = this.ey.x
            ...
            , x = this.ez.y
            , p = this.ez.z
            , m = n * (a * p - d * x) + s * (d * l - b * p) + r * (b * x - a * l);
        return 0 !== m && (m = 1 / m),
            i.x = m * (o * (a * p - d * x) + t * (d * l - b * p) + e * (b * x - a * l)),
            i.y = m * (n * (t * p - e * x) + s * (e * l - o * p) + r * (o * x - t * l)),
            i.z = m * (n * (a * e - d * t) + s * (d * o - b * e) + r * (b * t - a * o)),
            i
    }
    ,
    ...
    box2d.b2Mat33.prototype.GetSymInverse33 = function (o) {
        var t = box2d.b2DotV3V3(this.ex, box2d.b2CrossV3V3(this.ey, this.ez, box2d.b2Vec3.s_t0));
        0 !== t && (t = 1 / t);
        var e = this.ex.x
            , i = this.ey.x
            , n = this.ez.x
    ...
    ,
    box2d.b2MulM33V3 = function (o, t, e) {
        var i = t.x
            , n = t.y
            , s = t.z;
        return e.x = o.ex.x * i + o.ey.x * n + o.ez.x * s,
            e.y = o.ex.y * i + o.ey.y * n + o.ez.y * s,
            e.z = o.ex.z * i + o.ey.z * n + o.ez.z * s,
            e
    }
    ,
    box2d.b2MulM33XYZ = function (o, t, e, i, n) {
        return n.x = o.ex.x * t + o.ey.x * e + o.ez.x * i,
            n.y = o.ex.y * t + o.ey.y * e + o.ez.y * i,
            n.z = o.ex.z * t + o.ey.z * e + o.ez.z * i,
            n
    }
    ,
    box2d.b2MulM33V2 = function (o, t, e) {
        var i = t.x
            , n = t.y;
        return e.x = o.ex.x * i + o.ey.x * n,
            e.y = o.ex.y * i + o.ey.y * n,
            e
    }
    ,
    box2d.b2MulM33XY = function (o, t, e, i) {
        return i.x = o.ex.x * t + o.ey.x * e,
            i.y = o.ex.y * t + o.ey.y * e,
            i
    }
    ,
    box2d.b2Rot = function (o) {
        o && (this.angle = o,
            this.s = Math.sin(o),
            this.c = Math.cos(o))
    }
    ...
    ,
    box2d.b2Rot.prototype.SetAngle = function (o) {
        return this.angle !== o && (this.angle = o,
            this.s = Math.sin(o),
            this.c = Math.cos(o)),
            this
    }
    ...
    box2d.b2Rot.prototype.SetAngleDegrees = function (o) {
        return this.SetAngle(box2d.b2DegToRad(o))
    }
    ,
    ...
    box2d.b2MulRR = function (o, t, e) {
        ...
        for (e.s = n * s + i * r,
            e.c = i * s - n * r,
            e.angle = o.angle + t.angle; e.angle < -box2d.b2_pi;)
            e.angle += box2d.b2_two_pi;
        for (; e.angle >= box2d.b2_pi;)
            e.angle -= box2d.b2_two_pi;
        return e
    }
    ,
    box2d.b2MulTRR = function (o, t, e) {
        var i = o.c
            , n = o.s
            , s = t.c
            , r = t.s;
    ...
    box2d.b2Transform.prototype.Copy = function (o) {
        return this.p.Copy(o.p),
            this.q.Copy(o.q),
            this
    }
    ,
    box2d.b2Transform.prototype.SetIdentity = function () {
        return this.p.SetZero(),
            this.q.SetIdentity(),
            this
    }
    ,
    box2d.b2Transform.prototype.SetPositionRotation = function (o, t) {
        return this.p.Copy(o),
            this.q.Copy(t),
            this
    }
    ,
    box2d.b2Transform.prototype.SetPositionAngleRadians = function (o, t) {
        return this.p.Copy(o),
            this.q.SetAngleRadians(t),
            this
    }
    ,
    ...
    box2d.b2Transform.prototype.SetPositionXY = function (o, t) {
        return this.p.SetXY(o, t),
            this
    }
    ,
    box2d.b2Transform.prototype.SetRotation = function (o) {
        return this.q.Copy(o),
            this
    }
    ,
    box2d.b2Transform.prototype.SetRotationAngleRadians = function (o) {
        return this.q.SetAngleRadians(o),
            this
    }
    ,
    ...
    box2d.b2MulXV = function (o, t, e) {
        var i = o.q.c
            , n = o.q.s
            , s = t.x
            , r = t.y;
        return e.x = i * s - n * r + o.p.x,
            e.y = n * s + i * r + o.p.y,
            e
    }
    ,
    box2d.b2MulTXV = function (o, t, e) {
        var i = o.q.c
            , n = o.q.s
            , s = t.x - o.p.x
            , r = t.y - o.p.y;
    ...
    ,
    box2d.b2MulXX = function (o, t, e) {
        return box2d.b2MulRR(o.q, t.q, e.q),
            box2d.b2AddVV(box2d.b2MulRV(o.q, t.p, e.p), o.p, e.p),
            e
    }
    ,
    box2d.b2MulTXX = function (o, t, e) {
        return box2d.b2MulTRR(o.q, t.q, e.q),
            box2d.b2MulTRV(o.q, box2d.b2SubVV(t.p, o.p, e.p), e.p),
            e
    }
    ,
    ...
    box2d.b2Sweep.prototype.Copy = function (o) {
        return this.localCenter.Copy(o.localCenter),
            this.c0.Copy(o.c0),
            this.c.Copy(o.c),
            this.a0 = o.a0,
            this.a = o.a,
            this.alpha0 = o.alpha0,
            this
    }
    ,
    box2d.b2Sweep.prototype.GetTransform = function (o, t) {
        var e = 1 - t;
        o.p.x = e * this.c0.x + t * this.c.x,
            o.p.y = e * this.c0.y + t * this.c.y;
        var i = e * this.a0 + t * this.a;
        return o.q.SetAngleRadians(i),
            o.p.SelfSub(box2d.b2MulRV(o.q, this.localCenter, box2d.b2Vec2.s_t0)),
            o
    }
    ,
    box2d.b2Sweep.prototype.Advance = function (o) {
        ...
        this.c0.x += t * (this.c.x - this.c0.x),
            this.c0.y += t * (this.c.y - this.c0.y),
            this.a0 += t * (this.a - this.a0),
            this.alpha0 = o
    }
    ,
    box2d.b2Sweep.prototype.Normalize = function () {
        var o = box2d.b2_two_pi * Math.floor(this.a0 / box2d.b2_two_pi);
        this.a0 -= o,
            this.a -= o
    }
    ,
    ...
    box2d.b2Controller.prototype.Step = function (o) { }
    ,
    box2d.b2Controller.prototype.Draw = function (o) { }
    ,
    ...
    box2d.b2Controller.prototype.AddBody = function (o) {
        ...
        t.body = o,
            ...
            t.prevBody = null,
            this.m_bodyList && (this.m_bodyList.prevBody = t),
            this.m_bodyList = t,
            ++this.m_bodyCount,
            t.nextController = o.m_controllerList,
            t.prevController = null,
            o.m_controllerList && (o.m_controllerList.prevController = t),
            o.m_controllerList = t,
            ++o.m_controllerCount
    }
    ,
    box2d.b2Controller.prototype.RemoveBody = function (o) {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(this.m_bodyCount > 0);
        for (var t = this.m_bodyList; t && t.body !== o;)
            t = t.nextBody;
        box2d.ENABLE_ASSERTS && box2d.b2Assert(null !== t),
            t.prevBody && (t.prevBody.nextBody = t.nextBody),
            t.nextBody && (t.nextBody.prevBody = t.prevBody),
            this.m_bodyList === t && (this.m_bodyList = t.nextBody),
            --this.m_bodyCount,
            t.nextController && (t.nextController.prevController = t.prevController),
            t.prevController && (t.prevController.nextController = t.nextController),
            o.m_controllerList === t && (o.m_controllerList = t.nextController),
            --o.m_controllerCount
    }
    ,
    ...
    box2d.b2ConstantAccelController.prototype.Step = function (o) {
        for (var t = box2d.b2MulSV(o.dt, this.A, box2d.b2ConstantAccelController.prototype.Step.s_dtA), e = this.m_bodyList; e; e = e.nextBody) {
            var i = e.body;
            i.IsAwake() && i.SetLinearVelocity(box2d.b2AddVV(i.GetLinearVelocity(), t, box2d.b2Vec2.s_t0))
        }
    }
    ,
    ...
    box2d.b2Joint = function (o) {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(o.bodyA !== o.bodyB),
            this.m_type = o.type,
    ...
    ,
    box2d.b2Joint.prototype.InitVelocityConstraints = function (o) { }
    ,
    box2d.b2Joint.prototype.SolveVelocityConstraints = function (o) { }
    ,
    ...
    ,
    box2d.b2Joint.prototype.ShiftOrigin = function (o) { }
    ,
    ...
    box2d.b2RevoluteJointDef = function () {
        goog.base(this, box2d.b2JointType.e_revoluteJoint),
    ...
    box2d.b2RevoluteJoint = function (o) {
        goog.base(this, o),
            ...
            this.m_localAnchorA.Copy(o.localAnchorA),
            this.m_localAnchorB.Copy(o.localAnchorB),
            this.m_referenceAngle = o.referenceAngle,
            this.m_impulse.SetZero(),
            this.m_motorImpulse = 0,
            this.m_lowerAngle = o.lowerAngle,
            this.m_upperAngle = o.upperAngle,
            this.m_maxMotorTorque = o.maxMotorTorque,
            this.m_motorSpeed = o.motorSpeed,
            this.m_enableLimit = o.enableLimit,
            this.m_enableMotor = o.enableMotor,
    ...
    box2d.b2RevoluteJoint.prototype.InitVelocityConstraints = function (o) {
        ...
        var t = o.positions[this.m_indexA].a
            ...
            , s = o.velocities[this.m_indexB].v
            , r = o.velocities[this.m_indexB].w
            , b = this.m_qA.SetAngleRadians(t)
            , a = this.m_qB.SetAngleRadians(n);
        box2d.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA),
            box2d.b2MulRV(b, this.m_lalcA, this.m_rA),
            box2d.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB),
            box2d.b2MulRV(a, this.m_lalcB, this.m_rB);
        var d = this.m_invMassA
            , l = this.m_invMassB
            , x = this.m_invIA
            , p = this.m_invIB
            , m = x + p === 0;
        if (this.m_mass.ex.x = d + l + this.m_rA.y * this.m_rA.y * x + this.m_rB.y * this.m_rB.y * p,
            this.m_mass.ey.x = -this.m_rA.y * this.m_rA.x * x - this.m_rB.y * this.m_rB.x * p,
            this.m_mass.ez.x = -this.m_rA.y * x - this.m_rB.y * p,
            this.m_mass.ex.y = this.m_mass.ey.x,
            this.m_mass.ey.y = d + l + this.m_rA.x * this.m_rA.x * x + this.m_rB.x * this.m_rB.x * p,
            this.m_mass.ez.y = this.m_rA.x * x + this.m_rB.x * p,
            this.m_mass.ex.z = this.m_mass.ez.x,
            this.m_mass.ey.z = this.m_mass.ez.y,
            this.m_mass.ez.z = x + p,
            this.m_motorMass = x + p,
            this.m_motorMass > 0 && (this.m_motorMass = 1 / this.m_motorMass),
            (!1 === this.m_enableMotor || m) && (this.m_motorImpulse = 0),
            this.m_enableLimit && !1 === m) {
            var h = n - t - this.m_referenceAngle;
            box2d.b2Abs(this.m_upperAngle - this.m_lowerAngle) < 2 * box2d.b2_angularSlop ? this.m_limitState = box2d.b2LimitState.e_equalLimits : h <= this.m_lowerAngle ? (this.m_limitState !== box2d.b2LimitState.e_atLowerLimit && (this.m_impulse.z = 0),
                this.m_limitState = box2d.b2LimitState.e_atLowerLimit) : h >= this.m_upperAngle ? (this.m_limitState !== box2d.b2LimitState.e_atUpperLimit && (this.m_impulse.z = 0),
        ...
        if (o.step.warmStarting) {
            this.m_impulse.SelfMul(o.step.dtRatio),
                this.m_motorImpulse *= o.step.dtRatio;
            var _ = box2d.b2RevoluteJoint.prototype.InitVelocityConstraints.s_P.SetXY(this.m_impulse.x, this.m_impulse.y);
            e.SelfMulSub(d, _),
                i -= x * (box2d.b2CrossVV(this.m_rA, _) + this.m_motorImpulse + this.m_impulse.z),
                s.SelfMulAdd(l, _),
                r += p * (box2d.b2CrossVV(this.m_rB, _) + this.m_motorImpulse + this.m_impulse.z)
        } else
            this.m_impulse.SetZero(),
                this.m_motorImpulse = 0;
        o.velocities[this.m_indexA].w = i,
    ...
    box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints = function (o) {
        var t = o.velocities[this.m_indexA].v
            ...
            , a = this.m_invIB
            , d = b + a === 0;
        if (this.m_enableMotor && this.m_limitState !== box2d.b2LimitState.e_equalLimits && !1 === d) {
            var l = n - e - this.m_motorSpeed
                , x = -this.m_motorMass * l
                , p = this.m_motorImpulse
                , m = o.step.dt * this.m_maxMotorTorque;
            this.m_motorImpulse = box2d.b2Clamp(this.m_motorImpulse + x, -m, m),
                e -= b * (x = this.m_motorImpulse - p),
                n += a * x
        }
        if (this.m_enableLimit && this.m_limitState !== box2d.b2LimitState.e_inactiveLimit && !1 === d) {
            var h = box2d.b2SubVV(box2d.b2AddVCrossSV(i, n, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddVCrossSV(t, e, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_Cdot1)
                , _ = n - e;
            x = this.m_mass.Solve33(h.x, h.y, _, box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_impulse3).SelfNeg();
            if (this.m_limitState === box2d.b2LimitState.e_equalLimits)
                ...
                if (this.m_impulse.z + x.z < 0) {
                    var c = -h.x + this.m_impulse.z * this.m_mass.ez.x
                        , y = -h.y + this.m_impulse.z * this.m_mass.ez.y
                        , u = this.m_mass.Solve22(c, y, box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_reduced);
                    x.x = u.x,
                        x.y = u.y,
                        x.z = -this.m_impulse.z,
                ...
                if (this.m_impulse.z + x.z > 0) {
                    c = -h.x + this.m_impulse.z * this.m_mass.ez.x,
                        y = -h.y + this.m_impulse.z * this.m_mass.ez.y,
                        u = this.m_mass.Solve22(c, y, box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_reduced);
                    x.x = u.x,
                        x.y = u.y,
            ...
            var g = box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_P.SetXY(x.x, x.y);
            t.SelfMulSub(s, g),
                e -= b * (box2d.b2CrossVV(this.m_rA, g) + x.z),
                i.SelfMulAdd(r, g),
                n += a * (box2d.b2CrossVV(this.m_rB, g) + x.z)
        } else {
            l = box2d.b2SubVV(box2d.b2AddVCrossSV(i, n, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddVCrossSV(t, e, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_Cdot),
                x = this.m_mass.Solve22(-l.x, -l.y, box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_impulse2);
            this.m_impulse.x += x.x,
                this.m_impulse.y += x.y,
                t.SelfMulSub(s, x),
                e -= b * box2d.b2CrossVV(this.m_rA, x),
                i.SelfMulAdd(r, x),
                n += a * box2d.b2CrossVV(this.m_rB, x)
        }
        o.velocities[this.m_indexA].w = e,
            o.velocities[this.m_indexB].w = n
    }
    ,
    ...
    box2d.b2RevoluteJoint.prototype.SolvePositionConstraints = function (o) {
        var t, e = o.positions[this.m_indexA].c, i = o.positions[this.m_indexA].a, n = o.positions[this.m_indexB].c, s = o.positions[this.m_indexB].a, r = this.m_qA.SetAngleRadians(i), b = this.m_qB.SetAngleRadians(s), a = 0, d = this.m_invIA + this.m_invIB === 0;
        if (this.m_enableLimit && this.m_limitState !== box2d.b2LimitState.e_inactiveLimit && !1 === d) {
            var l = s - i - this.m_referenceAngle
                , x = 0;
            if (this.m_limitState === box2d.b2LimitState.e_equalLimits) {
                var p = box2d.b2Clamp(l - this.m_lowerAngle, -box2d.b2_maxAngularCorrection, box2d.b2_maxAngularCorrection);
                x = -this.m_motorMass * p,
                    a = box2d.b2Abs(p)
            } else if (this.m_limitState === box2d.b2LimitState.e_atLowerLimit) {
                a = -(p = l - this.m_lowerAngle),
                    p = box2d.b2Clamp(p + box2d.b2_angularSlop, -box2d.b2_maxAngularCorrection, 0),
                    x = -this.m_motorMass * p
            } else if (this.m_limitState === box2d.b2LimitState.e_atUpperLimit) {
                a = p = l - this.m_upperAngle,
                    p = box2d.b2Clamp(p - box2d.b2_angularSlop, 0, box2d.b2_maxAngularCorrection),
                    x = -this.m_motorMass * p
            }
            i -= this.m_invIA * x,
                s += this.m_invIB * x
        ...
        r.SetAngleRadians(i),
            b.SetAngleRadians(s),
            box2d.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
        var m = box2d.b2MulRV(r, this.m_lalcA, this.m_rA);
        box2d.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
        var h = box2d.b2MulRV(b, this.m_lalcB, this.m_rB);
        t = (p = box2d.b2SubVV(box2d.b2AddVV(n, h, box2d.b2Vec2.s_t0), box2d.b2AddVV(e, m, box2d.b2Vec2.s_t1), box2d.b2RevoluteJoint.prototype.SolvePositionConstraints.s_C)).GetLength();
        var _ = this.m_invMassA
            , c = this.m_invMassB
            , y = this.m_invIA
            , u = this.m_invIB
            , g = this.m_K;
        g.ex.x = _ + c + y * m.y * m.y + u * h.y * h.y,
            g.ex.y = -y * m.x * m.y - u * h.x * h.y,
            g.ey.x = g.ex.y,
            g.ey.y = _ + c + y * m.x * m.x + u * h.x * h.x;
        var f = g.Solve(p.x, p.y, box2d.b2RevoluteJoint.prototype.SolvePositionConstraints.s_impulse).SelfNeg();
        return e.SelfMulSub(_, f),
            i -= y * box2d.b2CrossVV(m, f),
            n.SelfMulAdd(c, f),
            s += u * box2d.b2CrossVV(h, f),
            o.positions[this.m_indexA].a = i,
            o.positions[this.m_indexB].a = s,
            t <= box2d.b2_linearSlop && a <= box2d.b2_angularSlop
    }
    ,
    ...
    box2d.b2RevoluteJoint.prototype.GetReactionForce = function (o, t) {
        return t.SetXY(o * this.m_impulse.x, o * this.m_impulse.y)
    }
    ,
    ...
    box2d.b2RevoluteJoint.prototype.EnableMotor = function (o) {
        this.m_enableMotor !== o && (this.m_bodyA.SetAwake(!0),
    ...
    box2d.b2RevoluteJoint.prototype.EnableLimit = function (o) {
        o !== this.m_enableLimit && (this.m_bodyA.SetAwake(!0),
            this.m_bodyB.SetAwake(!0),
            this.m_enableLimit = o,
            this.m_impulse.z = 0)
    }
    ,
    ...
    box2d.b2RevoluteJoint.prototype.SetMotorSpeed = function (o) {
        this.m_motorSpeed !== o && (this.m_bodyA.SetAwake(!0),
            this.m_bodyB.SetAwake(!0),
            this.m_motorSpeed = o)
    }
    ,
    ...
    box2d.b2PrismaticJointDef = function () {
        goog.base(this, box2d.b2JointType.e_prismaticJoint),
    ...
    box2d.b2PrismaticJointDef.prototype.Initialize = function (o, t, e, i) {
        this.bodyA = o,
            this.bodyB = t,
            this.bodyA.GetLocalPoint(e, this.localAnchorA),
            this.bodyB.GetLocalPoint(e, this.localAnchorB),
            this.bodyA.GetLocalVector(i, this.localAxisA),
            this.referenceAngle = this.bodyB.GetAngleRadians() - this.bodyA.GetAngleRadians()
    }
    ,
    box2d.b2PrismaticJoint = function (o) {
        goog.base(this, o),
            this.m_localAnchorA = o.localAnchorA.Clone(),
            this.m_localAnchorB = o.localAnchorB.Clone(),
            this.m_localXAxisA = o.localAxisA.Clone().SelfNormalize(),
            this.m_localYAxisA = box2d.b2CrossOneV(this.m_localXAxisA, new box2d.b2Vec2),
            this.m_referenceAngle = o.referenceAngle,
            this.m_impulse = new box2d.b2Vec3(0, 0, 0),
            this.m_lowerTranslation = o.lowerTranslation,
            this.m_upperTranslation = o.upperTranslation,
            this.m_maxMotorForce = o.maxMotorForce,
            this.m_motorSpeed = o.motorSpeed,
            this.m_enableLimit = o.enableLimit,
            this.m_enableMotor = o.enableMotor,
            this.m_localCenterA = new box2d.b2Vec2,
    ...
    box2d.b2PrismaticJoint.prototype.InitVelocityConstraints = function (o) {
        ...
        var t = o.positions[this.m_indexA].c
            ...
            , i = o.velocities[this.m_indexA].v
            , n = o.velocities[this.m_indexA].w
            , s = o.positions[this.m_indexB].c
            , r = o.positions[this.m_indexB].a
            , b = o.velocities[this.m_indexB].v
            , a = o.velocities[this.m_indexB].w
            , d = this.m_qA.SetAngleRadians(e)
            , l = this.m_qB.SetAngleRadians(r);
        box2d.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
        var x = box2d.b2MulRV(d, this.m_lalcA, this.m_rA);
        box2d.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
        var p = box2d.b2MulRV(l, this.m_lalcB, this.m_rB)
            , m = box2d.b2AddVV(box2d.b2SubVV(s, t, box2d.b2Vec2.s_t0), box2d.b2SubVV(p, x, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.InitVelocityConstraints.s_d)
            , h = this.m_invMassA
            , _ = this.m_invMassB
            , c = this.m_invIA
            , y = this.m_invIB;
        if (box2d.b2MulRV(d, this.m_localXAxisA, this.m_axis),
            this.m_a1 = box2d.b2CrossVV(box2d.b2AddVV(m, x, box2d.b2Vec2.s_t0), this.m_axis),
            this.m_a2 = box2d.b2CrossVV(p, this.m_axis),
            this.m_motorMass = h + _ + c * this.m_a1 * this.m_a1 + y * this.m_a2 * this.m_a2,
            this.m_motorMass > 0 && (this.m_motorMass = 1 / this.m_motorMass),
            box2d.b2MulRV(d, this.m_localYAxisA, this.m_perp),
            this.m_s1 = box2d.b2CrossVV(box2d.b2AddVV(m, x, box2d.b2Vec2.s_t0), this.m_perp),
            this.m_s2 = box2d.b2CrossVV(p, this.m_perp),
            this.m_K.ex.x = h + _ + c * this.m_s1 * this.m_s1 + y * this.m_s2 * this.m_s2,
            this.m_K.ex.y = c * this.m_s1 + y * this.m_s2,
            this.m_K.ex.z = c * this.m_s1 * this.m_a1 + y * this.m_s2 * this.m_a2,
            this.m_K.ey.x = this.m_K.ex.y,
            this.m_K.ey.y = c + y,
            0 === this.m_K.ey.y && (this.m_K.ey.y = 1),
            this.m_K.ey.z = c * this.m_a1 + y * this.m_a2,
            this.m_K.ez.x = this.m_K.ex.z,
            this.m_K.ez.y = this.m_K.ey.z,
            this.m_K.ez.z = h + _ + c * this.m_a1 * this.m_a1 + y * this.m_a2 * this.m_a2,
            this.m_enableLimit) {
            var u = box2d.b2DotVV(this.m_axis, m);
            box2d.b2Abs(this.m_upperTranslation - this.m_lowerTranslation) < 2 * box2d.b2_linearSlop ? this.m_limitState = box2d.b2LimitState.e_equalLimits : u <= this.m_lowerTranslation ? this.m_limitState !== box2d.b2LimitState.e_atLowerLimit && (this.m_limitState = box2d.b2LimitState.e_atLowerLimit,
                this.m_impulse.z = 0) : u >= this.m_upperTranslation ? this.m_limitState !== box2d.b2LimitState.e_atUpperLimit && (this.m_limitState = box2d.b2LimitState.e_atUpperLimit,
        ...
        if (!1 === this.m_enableMotor && (this.m_motorImpulse = 0),
            ...
            var g = box2d.b2AddVV(box2d.b2MulSV(this.m_impulse.x, this.m_perp, box2d.b2Vec2.s_t0), box2d.b2MulSV(this.m_motorImpulse + this.m_impulse.z, this.m_axis, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.InitVelocityConstraints.s_P)
                , f = this.m_impulse.x * this.m_s1 + this.m_impulse.y + (this.m_motorImpulse + this.m_impulse.z) * this.m_a1
            ...
            this.m_impulse.SetZero(),
                this.m_motorImpulse = 0;
        o.velocities[this.m_indexA].w = n,
            o.velocities[this.m_indexB].w = a
    }
    ,
    ...
    box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints = function (o) {
        ...
        if (this.m_enableMotor && this.m_limitState !== box2d.b2LimitState.e_equalLimits) {
            var d = box2d.b2DotVV(this.m_axis, box2d.b2SubVV(i, t, box2d.b2Vec2.s_t0)) + this.m_a2 * n - this.m_a1 * e
                , l = this.m_motorMass * (this.m_motorSpeed - d)
                , x = this.m_motorImpulse
                , p = o.step.dt * this.m_maxMotorForce;
            this.m_motorImpulse = box2d.b2Clamp(this.m_motorImpulse + l, -p, p),
                l = this.m_motorImpulse - x;
            var m = box2d.b2MulSV(l, this.m_axis, box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_P)
                , h = l * this.m_a1
                , _ = l * this.m_a2;
            t.SelfMulSub(s, m),
                e -= b * h,
        ...
        var c = box2d.b2DotVV(this.m_perp, box2d.b2SubVV(i, t, box2d.b2Vec2.s_t0)) + this.m_s2 * n - this.m_s1 * e
            , y = n - e;
        if (this.m_enableLimit && this.m_limitState !== box2d.b2LimitState.e_inactiveLimit) {
            var u = box2d.b2DotVV(this.m_axis, box2d.b2SubVV(i, t, box2d.b2Vec2.s_t0)) + this.m_a2 * n - this.m_a1 * e
                , g = box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_f1.Copy(this.m_impulse)
                , f = this.m_K.Solve33(-c, -y, -u, box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_df3);
            this.m_impulse.SelfAdd(f),
                this.m_limitState === box2d.b2LimitState.e_atLowerLimit ? this.m_impulse.z = box2d.b2Max(this.m_impulse.z, 0) : this.m_limitState === box2d.b2LimitState.e_atUpperLimit && (this.m_impulse.z = box2d.b2Min(this.m_impulse.z, 0));
            var S = -c - (this.m_impulse.z - g.z) * this.m_K.ez.x
                , A = -y - (this.m_impulse.z - g.z) * this.m_K.ez.y
                , C = this.m_K.Solve22(S, A, box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_f2r);
            C.x += g.x,
                C.y += g.y,
                this.m_impulse.x = C.x,
                this.m_impulse.y = C.y,
                f.x = this.m_impulse.x - g.x,
                f.y = this.m_impulse.y - g.y,
                f.z = this.m_impulse.z - g.z;
            m = box2d.b2AddVV(box2d.b2MulSV(f.x, this.m_perp, box2d.b2Vec2.s_t0), box2d.b2MulSV(f.z, this.m_axis, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_P),
                h = f.x * this.m_s1 + f.y + f.z * this.m_a1,
                _ = f.x * this.m_s2 + f.y + f.z * this.m_a2;
            t.SelfMulSub(s, m),
                e -= b * h,
                i.SelfMulAdd(r, m),
                n += a * _
        } else {
            f = this.m_K.Solve22(-c, -y, box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_df2);
            this.m_impulse.x += f.x,
                this.m_impulse.y += f.y;
            m = box2d.b2MulSV(f.x, this.m_perp, box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_P),
                h = f.x * this.m_s1 + f.y,
                _ = f.x * this.m_s2 + f.y;
            t.SelfMulSub(s, m),
                e -= b * h,
    ...
    box2d.b2PrismaticJoint.prototype.SolvePositionConstraints = function (o) {
        var t = o.positions[this.m_indexA].c
            ...
            , n = o.positions[this.m_indexB].a
            , s = this.m_qA.SetAngleRadians(e)
            , r = this.m_qB.SetAngleRadians(n)
            , b = this.m_invMassA
            , a = this.m_invMassB
            , d = this.m_invIA
            , l = this.m_invIB
            , x = box2d.b2MulRV(s, this.m_lalcA, this.m_rA)
            , p = box2d.b2MulRV(r, this.m_lalcB, this.m_rB)
            , m = box2d.b2SubVV(box2d.b2AddVV(i, p, box2d.b2Vec2.s_t0), box2d.b2AddVV(t, x, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_d)
            , h = box2d.b2MulRV(s, this.m_localXAxisA, this.m_axis)
            , _ = box2d.b2CrossVV(box2d.b2AddVV(m, x, box2d.b2Vec2.s_t0), h)
            , c = box2d.b2CrossVV(p, h)
            , y = box2d.b2MulRV(s, this.m_localYAxisA, this.m_perp)
            , u = box2d.b2CrossVV(box2d.b2AddVV(m, x, box2d.b2Vec2.s_t0), y)
            , g = box2d.b2CrossVV(p, y)
            , f = box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_impulse
            , S = box2d.b2DotVV(y, m)
            , A = n - e - this.m_referenceAngle
            , C = box2d.b2Abs(S)
            , v = box2d.b2Abs(A)
            , V = !1
            , B = 0;
        if (this.m_enableLimit) {
            var w = box2d.b2DotVV(h, m);
            box2d.b2Abs(this.m_upperTranslation - this.m_lowerTranslation) < 2 * box2d.b2_linearSlop ? (B = box2d.b2Clamp(w, -box2d.b2_maxLinearCorrection, box2d.b2_maxLinearCorrection),
                C = box2d.b2Max(C, box2d.b2Abs(w)),
                V = !0) : w <= this.m_lowerTranslation ? (B = box2d.b2Clamp(w - this.m_lowerTranslation + box2d.b2_linearSlop, -box2d.b2_maxLinearCorrection, 0),
                    C = box2d.b2Max(C, this.m_lowerTranslation - w),
                    V = !0) : w >= this.m_upperTranslation && (B = box2d.b2Clamp(w - this.m_upperTranslation - box2d.b2_linearSlop, 0, box2d.b2_maxLinearCorrection),
                        C = box2d.b2Max(C, w - this.m_upperTranslation),
                        V = !0)
        }
        if (V) {
            var P = b + a + d * u * u + l * g * g
                , M = d * u + l * g
                , D = d * u * _ + l * g * c;
            0 === (I = d + l) && (I = 1);
            var J = d * _ + l * c
            ...
            L.ex.SetXY(P, M),
                L.ey.SetXY(M, I);
            var E = L.Solve(-S, -A, box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_impulse1);
            f.x = E.x,
                f.y = E.y,
                f.z = 0
        }
        var F = box2d.b2AddVV(box2d.b2MulSV(f.x, y, box2d.b2Vec2.s_t0), box2d.b2MulSV(f.z, h, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_P)
            , G = f.x * u + f.y + f.z * _
            , k = f.x * g + f.y + f.z * c;
        return t.SelfMulSub(b, F),
            e -= d * G,
            i.SelfMulAdd(a, F),
            n += l * k,
            o.positions[this.m_indexA].a = e,
            o.positions[this.m_indexB].a = n,
            C <= box2d.b2_linearSlop && v <= box2d.b2_angularSlop
    }
    ,
    ...
    box2d.b2PrismaticJoint.prototype.GetReactionForce = function (o, t) {
        return t.SetXY(o * (this.m_impulse.x * this.m_perp.x + (this.m_motorImpulse + this.m_impulse.z) * this.m_axis.x), o * (this.m_impulse.x * this.m_perp.y + (this.m_motorImpulse + this.m_impulse.z) * this.m_axis.y))
    }
    ,
    ...
    box2d.b2PrismaticJoint.prototype.GetJointTranslation = function () {
        var o = this.m_bodyA.GetWorldPoint(this.m_localAnchorA, box2d.b2PrismaticJoint.prototype.GetJointTranslation.s_pA)
            ...
            , e = box2d.b2SubVV(t, o, box2d.b2PrismaticJoint.prototype.GetJointTranslation.s_d)
            , i = this.m_bodyA.GetWorldVector(this.m_localXAxisA, box2d.b2PrismaticJoint.prototype.GetJointTranslation.s_axis);
        return box2d.b2DotVV(e, i)
    }
    ,
    ...
    box2d.b2PrismaticJoint.prototype.GetJointSpeed = function () {
        var o = this.m_bodyA
            , t = this.m_bodyB;
        box2d.b2SubVV(this.m_localAnchorA, o.m_sweep.localCenter, this.m_lalcA);
        var e = box2d.b2MulRV(o.m_xf.q, this.m_lalcA, this.m_rA);
        box2d.b2SubVV(this.m_localAnchorB, t.m_sweep.localCenter, this.m_lalcB);
        var i = box2d.b2MulRV(t.m_xf.q, this.m_lalcB, this.m_rB)
            , n = box2d.b2AddVV(o.m_sweep.c, e, box2d.b2Vec2.s_t0)
            , s = box2d.b2AddVV(t.m_sweep.c, i, box2d.b2Vec2.s_t1)
            , r = box2d.b2SubVV(s, n, box2d.b2Vec2.s_t2)
            , b = o.GetWorldVector(this.m_localXAxisA, this.m_axis)
            , a = o.m_linearVelocity
            , d = t.m_linearVelocity
            , l = o.m_angularVelocity
            , x = t.m_angularVelocity;
        return box2d.b2DotVV(r, box2d.b2CrossSV(l, b, box2d.b2Vec2.s_t0)) + box2d.b2DotVV(b, box2d.b2SubVV(box2d.b2AddVCrossSV(d, x, i, box2d.b2Vec2.s_t0), box2d.b2AddVCrossSV(a, l, e, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0))
    }
    ,
    ...
    box2d.b2GearJoint = function (o) {
        var t, e;
        goog.base(this, o),
            this.m_joint1 = o.joint1,
            this.m_joint2 = o.joint2,
            this.m_localAnchorA = new box2d.b2Vec2,
            this.m_localAnchorB = new box2d.b2Vec2,
        ...
        var i = this.m_bodyA.m_xf
            , n = this.m_bodyA.m_sweep.a
            , s = this.m_bodyC.m_xf
            , r = this.m_bodyC.m_sweep.a;
        if (this.m_typeA === box2d.b2JointType.e_revoluteJoint) {
            var b = o.joint1;
            this.m_localAnchorC.Copy(b.m_localAnchorA),
                this.m_localAnchorA.Copy(b.m_localAnchorB),
                this.m_referenceAngleA = b.m_referenceAngle,
                this.m_localAxisC.SetZero(),
                t = n - r - this.m_referenceAngleA
        } else {
            var a = o.joint1;
            this.m_localAnchorC.Copy(a.m_localAnchorA),
                this.m_localAnchorA.Copy(a.m_localAnchorB),
                this.m_referenceAngleA = a.m_referenceAngle,
                this.m_localAxisC.Copy(a.m_localXAxisA);
            var d = this.m_localAnchorC
                , l = box2d.b2MulTRV(s.q, box2d.b2AddVV(box2d.b2MulRV(i.q, this.m_localAnchorA, box2d.b2Vec2.s_t0), box2d.b2SubVV(i.p, s.p, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0);
            t = box2d.b2DotVV(box2d.b2SubVV(l, d, box2d.b2Vec2.s_t0), this.m_localAxisC)
        }
        this.m_bodyD = this.m_joint2.GetBodyA(),
            this.m_bodyB = this.m_joint2.GetBodyB();
        var x = this.m_bodyB.m_xf
            , p = this.m_bodyB.m_sweep.a
            , m = this.m_bodyD.m_xf
            , h = this.m_bodyD.m_sweep.a;
        if (this.m_typeB === box2d.b2JointType.e_revoluteJoint) {
            b = o.joint2;
            this.m_localAnchorD.Copy(b.m_localAnchorA),
                this.m_localAnchorB.Copy(b.m_localAnchorB),
                this.m_referenceAngleB = b.m_referenceAngle,
                this.m_localAxisD.SetZero(),
                e = p - h - this.m_referenceAngleB
        } else {
            a = o.joint2;
            this.m_localAnchorD.Copy(a.m_localAnchorA),
                this.m_localAnchorB.Copy(a.m_localAnchorB),
                this.m_referenceAngleB = a.m_referenceAngle,
                this.m_localAxisD.Copy(a.m_localXAxisA);
            var _ = this.m_localAnchorD
                , c = box2d.b2MulTRV(m.q, box2d.b2AddVV(box2d.b2MulRV(x.q, this.m_localAnchorB, box2d.b2Vec2.s_t0), box2d.b2SubVV(x.p, m.p, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0);
            e = box2d.b2DotVV(box2d.b2SubVV(c, _, box2d.b2Vec2.s_t0), this.m_localAxisD)
        }
        this.m_ratio = o.ratio,
            this.m_constant = t + this.m_ratio * e,
            this.m_impulse = 0
    }
    ,
    ...
    box2d.b2GearJoint.prototype.InitVelocityConstraints = function (o) {
        ...
        var t = o.positions[this.m_indexA].a
            ...
            , s = o.velocities[this.m_indexB].v
            , r = o.velocities[this.m_indexB].w
            , b = o.positions[this.m_indexC].a
            , a = o.velocities[this.m_indexC].v
            , d = o.velocities[this.m_indexC].w
            , l = o.positions[this.m_indexD].a
            , x = o.velocities[this.m_indexD].v
            , p = o.velocities[this.m_indexD].w
            , m = this.m_qA.SetAngleRadians(t)
            , h = this.m_qB.SetAngleRadians(n)
            , _ = this.m_qC.SetAngleRadians(b)
            , c = this.m_qD.SetAngleRadians(l);
        if (this.m_mass = 0,
            ...
            var y = box2d.b2MulRV(_, this.m_localAxisC, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_u);
            box2d.b2SubVV(this.m_localAnchorC, this.m_lcC, this.m_lalcC);
            var u = box2d.b2MulRV(_, this.m_lalcC, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rC);
            box2d.b2SubVV(this.m_localAnchorA, this.m_lcA, this.m_lalcA);
            var g = box2d.b2MulRV(m, this.m_lalcA, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rA);
            this.m_JvAC.Copy(y),
                this.m_JwC = box2d.b2CrossVV(u, y),
                this.m_JwA = box2d.b2CrossVV(g, y),
        ...
        if (this.m_typeB === box2d.b2JointType.e_revoluteJoint)
            ...
            y = box2d.b2MulRV(c, this.m_localAxisD, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_u);
            box2d.b2SubVV(this.m_localAnchorD, this.m_lcD, this.m_lalcD);
            var f = box2d.b2MulRV(c, this.m_lalcD, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rD);
            box2d.b2SubVV(this.m_localAnchorB, this.m_lcB, this.m_lalcB);
            var S = box2d.b2MulRV(h, this.m_lalcB, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rB);
            box2d.b2MulSV(this.m_ratio, y, this.m_JvBD),
                this.m_JwD = this.m_ratio * box2d.b2CrossVV(f, y),
                this.m_JwB = this.m_ratio * box2d.b2CrossVV(S, y),
                this.m_mass += this.m_ratio * this.m_ratio * (this.m_mD + this.m_mB) + this.m_iD * this.m_JwD * this.m_JwD + this.m_iB * this.m_JwB * this.m_JwB
        }
        this.m_mass = this.m_mass > 0 ? 1 / this.m_mass : 0,
            o.step.warmStarting ? (e.SelfMulAdd(this.m_mA * this.m_impulse, this.m_JvAC),
                i += this.m_iA * this.m_impulse * this.m_JwA,
                s.SelfMulAdd(this.m_mB * this.m_impulse, this.m_JvBD),
                r += this.m_iB * this.m_impulse * this.m_JwB,
                a.SelfMulSub(this.m_mC * this.m_impulse, this.m_JvAC),
                d -= this.m_iC * this.m_impulse * this.m_JwC,
                x.SelfMulSub(this.m_mD * this.m_impulse, this.m_JvBD),
                p -= this.m_iD * this.m_impulse * this.m_JwD) : this.m_impulse = 0,
            o.velocities[this.m_indexA].w = i,
            o.velocities[this.m_indexB].w = r,
            o.velocities[this.m_indexC].w = d,
            o.velocities[this.m_indexD].w = p
    }
    ,
    ...
    box2d.b2GearJoint.prototype.SolveVelocityConstraints = function (o) {
        var t = o.velocities[this.m_indexA].v
            ...
            , i = o.velocities[this.m_indexB].v
            , n = o.velocities[this.m_indexB].w
            , s = o.velocities[this.m_indexC].v
            , r = o.velocities[this.m_indexC].w
            , b = o.velocities[this.m_indexD].v
            , a = o.velocities[this.m_indexD].w
            , d = box2d.b2DotVV(this.m_JvAC, box2d.b2SubVV(t, s, box2d.b2Vec2.s_t0)) + box2d.b2DotVV(this.m_JvBD, box2d.b2SubVV(i, b, box2d.b2Vec2.s_t0));
        d += this.m_JwA * e - this.m_JwC * r + (this.m_JwB * n - this.m_JwD * a);
        var l = -this.m_mass * d;
        this.m_impulse += l,
            t.SelfMulAdd(this.m_mA * l, this.m_JvAC),
            e += this.m_iA * l * this.m_JwA,
            i.SelfMulAdd(this.m_mB * l, this.m_JvBD),
            n += this.m_iB * l * this.m_JwB,
            s.SelfMulSub(this.m_mC * l, this.m_JvAC),
            r -= this.m_iC * l * this.m_JwC,
            b.SelfMulSub(this.m_mD * l, this.m_JvBD),
            a -= this.m_iD * l * this.m_JwD,
            o.velocities[this.m_indexA].w = e,
            o.velocities[this.m_indexB].w = n,
            o.velocities[this.m_indexC].w = r,
            o.velocities[this.m_indexD].w = a
    }
    ,
    box2d.b2GearJoint.prototype.SolvePositionConstraints = function (o) {
        var t, e, i, n, s, r, b = o.positions[this.m_indexA].c, a = o.positions[this.m_indexA].a, d = o.positions[this.m_indexB].c, l = o.positions[this.m_indexB].a, x = o.positions[this.m_indexC].c, p = o.positions[this.m_indexC].a, m = o.positions[this.m_indexD].c, h = o.positions[this.m_indexD].a, _ = this.m_qA.SetAngleRadians(a), c = this.m_qB.SetAngleRadians(l), y = this.m_qC.SetAngleRadians(p), u = this.m_qD.SetAngleRadians(h), g = this.m_JvAC, f = this.m_JvBD, S = 0;
        if (this.m_typeA === box2d.b2JointType.e_revoluteJoint)
            g.SetZero(),
                i = 1,
                s = 1,
                S += this.m_iA + this.m_iC,
                t = a - p - this.m_referenceAngleA;
        else {
            var A = box2d.b2MulRV(y, this.m_localAxisC, box2d.b2GearJoint.prototype.SolvePositionConstraints.s_u)
                , C = box2d.b2MulRV(y, this.m_lalcC, box2d.b2GearJoint.prototype.SolvePositionConstraints.s_rC)
                , v = box2d.b2MulRV(_, this.m_lalcA, box2d.b2GearJoint.prototype.SolvePositionConstraints.s_rA);
            g.Copy(A),
                s = box2d.b2CrossVV(C, A),
                i = box2d.b2CrossVV(v, A),
                S += this.m_mC + this.m_mA + this.m_iC * s * s + this.m_iA * i * i;
            var V = this.m_lalcC
                , B = box2d.b2MulTRV(y, box2d.b2AddVV(v, box2d.b2SubVV(b, x, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0);
            t = box2d.b2DotVV(box2d.b2SubVV(B, V, box2d.b2Vec2.s_t0), this.m_localAxisC)
        }
        if (this.m_typeB === box2d.b2JointType.e_revoluteJoint)
            f.SetZero(),
                n = this.m_ratio,
                ...
                e = l - h - this.m_referenceAngleB;
        else {
            A = box2d.b2MulRV(u, this.m_localAxisD, box2d.b2GearJoint.prototype.SolvePositionConstraints.s_u);
            var w = box2d.b2MulRV(u, this.m_lalcD, box2d.b2GearJoint.prototype.SolvePositionConstraints.s_rD)
                , P = box2d.b2MulRV(c, this.m_lalcB, box2d.b2GearJoint.prototype.SolvePositionConstraints.s_rB);
            box2d.b2MulSV(this.m_ratio, A, f),
                r = this.m_ratio * box2d.b2CrossVV(w, A),
                n = this.m_ratio * box2d.b2CrossVV(P, A),
                S += this.m_ratio * this.m_ratio * (this.m_mD + this.m_mB) + this.m_iD * r * r + this.m_iB * n * n;
            var M = this.m_lalcD
                , D = box2d.b2MulTRV(u, box2d.b2AddVV(P, box2d.b2SubVV(d, m, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0);
            e = box2d.b2DotVV(box2d.b2SubVV(D, M, box2d.b2Vec2.s_t0), this.m_localAxisD)
        }
        var J = t + this.m_ratio * e - this.m_constant
            , T = 0;
        return S > 0 && (T = -J / S),
            b.SelfMulAdd(this.m_mA * T, g),
            a += this.m_iA * T * i,
            d.SelfMulAdd(this.m_mB * T, f),
            l += this.m_iB * T * n,
            x.SelfMulSub(this.m_mC * T, g),
            p -= this.m_iC * T * s,
            m.SelfMulSub(this.m_mD * T, f),
            h -= this.m_iD * T * r,
            o.positions[this.m_indexA].a = a,
            o.positions[this.m_indexB].a = l,
            o.positions[this.m_indexC].a = p,
            o.positions[this.m_indexD].a = h,
    ...
    box2d.b2GearJoint.prototype.GetReactionForce = function (o, t) {
        return box2d.b2MulSV(o * this.m_impulse, this.m_JvAC, t)
    }
    ,
    ...
    box2d.b2GearJoint.prototype.SetRatio = function (o) {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(box2d.b2IsValid(o)),
            this.m_ratio = o
    }
    ,
    ...
    box2d.b2DistanceProxy.prototype.GetSupport = function (o) {
        for (var t = 0, e = box2d.b2DotVV(this.m_vertices[0], o), i = 1; i < this.m_count; ++i) {
            var n = box2d.b2DotVV(this.m_vertices[i], o);
            n > e && (t = i,
                e = n)
        }
        return t
    ...
    box2d.b2DistanceProxy.prototype.GetSupportVertex = function (o, t) {
        for (var e = 0, i = box2d.b2DotVV(this.m_vertices[0], o), n = 1; n < this.m_count; ++n) {
            var s = box2d.b2DotVV(this.m_vertices[n], o);
            s > i && (e = n,
                i = s)
        }
    ...
    box2d.b2DistanceProxy.prototype.GetVertex = function (o) {
        return box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= o && o < this.m_count),
            this.m_vertices[o]
    }
    ,
    ...
    box2d.b2Simplex.prototype.ReadCache = function (o, t, e, i, n) {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= o.count && o.count <= 3),
            this.m_count = o.count;
        for (var s = this.m_vertices, r = 0; r < this.m_count; ++r) {
            (x = s[r]).indexA = o.indexA[r],
                x.indexB = o.indexB[r];
            var b = t.GetVertex(x.indexA)
                , a = i.GetVertex(x.indexB);
            box2d.b2MulXV(e, b, x.wA),
                box2d.b2MulXV(n, a, x.wB),
                box2d.b2SubVV(x.wB, x.wA, x.w),
                x.a = 0
        }
        if (this.m_count > 1) {
            var d = o.metric
                , l = this.GetMetric();
            (l < .5 * d || 2 * d < l || l < box2d.b2_epsilon) && (this.m_count = 0)
        }
        if (0 === this.m_count) {
            var x;
            (x = s[0]).indexA = 0,
    ...
    box2d.b2Simplex.prototype.WriteCache = function (o) {
        o.metric = this.GetMetric(),
            o.count = this.m_count;
        for (var t = this.m_vertices, e = 0; e < this.m_count; ++e)
            o.indexA[e] = t[e].indexA,
    ...
    box2d.b2Simplex.prototype.GetSearchDirection = function (o) {
        switch (this.m_count) {
            case 1:
                return box2d.b2NegV(this.m_v1.w, o);
            case 2:
                var t = box2d.b2SubVV(this.m_v2.w, this.m_v1.w, o);
                return box2d.b2CrossVV(t, box2d.b2NegV(this.m_v1.w, box2d.b2Vec2.s_t0)) > 0 ? box2d.b2CrossOneV(t, o) : box2d.b2CrossVOne(t, o);
            default:
                return box2d.ENABLE_ASSERTS && box2d.b2Assert(!1),
                    o.SetZero()
        }
    }
    ,
    box2d.b2Simplex.prototype.GetClosestPoint = function (o) {
        switch (this.m_count) {
            ...
            case 2:
                return o.SetXY(this.m_v1.a * this.m_v1.w.x + this.m_v2.a * this.m_v2.w.x, this.m_v1.a * this.m_v1.w.y + this.m_v2.a * this.m_v2.w.y);
            case 3:
                return o.SetZero();
            default:
                return box2d.ENABLE_ASSERTS && box2d.b2Assert(!1),
    ...
    box2d.b2Simplex.prototype.GetWitnessPoints = function (o, t) {
        switch (this.m_count) {
            ...
            case 1:
                ...
                break;
            case 2:
                o.x = this.m_v1.a * this.m_v1.wA.x + this.m_v2.a * this.m_v2.wA.x,
                    o.y = this.m_v1.a * this.m_v1.wA.y + this.m_v2.a * this.m_v2.wA.y,
    ...
    box2d.b2Simplex.prototype.Solve2 = function () {
        var o = this.m_v1.w
            , t = this.m_v2.w
            , e = box2d.b2SubVV(t, o, box2d.b2Simplex.s_e12)
            , i = -box2d.b2DotVV(o, e);
        if (i <= 0)
            return this.m_v1.a = 1,
                void (this.m_count = 1);
        var n = box2d.b2DotVV(t, e);
        if (n <= 0)
    ...
    box2d.b2Simplex.prototype.Solve3 = function () {
        var o = this.m_v1.w
            , t = this.m_v2.w
            , e = this.m_v3.w
            , i = box2d.b2SubVV(t, o, box2d.b2Simplex.s_e12)
            , n = box2d.b2DotVV(o, i)
            , s = box2d.b2DotVV(t, i)
            , r = -n
            , b = box2d.b2SubVV(e, o, box2d.b2Simplex.s_e13)
            , a = box2d.b2DotVV(o, b)
            , d = box2d.b2DotVV(e, b)
            , l = -a
            , x = box2d.b2SubVV(e, t, box2d.b2Simplex.s_e23)
            , p = box2d.b2DotVV(t, x)
            , m = box2d.b2DotVV(e, x)
            , h = -p
            , _ = box2d.b2CrossVV(i, b)
            , c = _ * box2d.b2CrossVV(t, e)
            , y = _ * box2d.b2CrossVV(e, o)
            , u = _ * box2d.b2CrossVV(o, t);
        if (r <= 0 && l <= 0)
            return this.m_v1.a = 1,
                void (this.m_count = 1);
        if (s > 0 && r > 0 && u <= 0) {
            var g = 1 / (s + r);
            return this.m_v1.a = s * g,
                this.m_v2.a = r * g,
                void (this.m_count = 2)
        }
        if (d > 0 && l > 0 && y <= 0) {
            var f = 1 / (d + l);
            return this.m_v1.a = d * f,
                this.m_v3.a = l * f,
                this.m_count = 2,
    ...
    box2d.b2Distance = function (o, t, e) {
        ++box2d.b2_gjkCalls;
        var i = e.proxyA
            , n = e.proxyB
            , s = e.transformA
            , r = e.transformB
            , b = box2d.b2Distance.s_simplex;
        b.ReadCache(t, i, s, n, r);
        for (var a = b.m_vertices, d = box2d.b2Distance.s_saveA, l = box2d.b2Distance.s_saveB, x = 0, p = (box2d.b2_maxFloat,
            0); p < 20;) {
            x = b.m_count;
            for (var m = 0; m < x; ++m)
                d[m] = a[m].indexA,
            ...
            if (3 === b.m_count)
                break;
            (f = b.GetClosestPoint(box2d.b2Distance.s_p)).GetLengthSquared();
            var h = b.GetSearchDirection(box2d.b2Distance.s_d);
            if (h.GetLengthSquared() < box2d.b2_epsilon_sq)
                break;
            var _ = a[b.m_count];
            _.indexA = i.GetSupport(box2d.b2MulTRV(s.q, box2d.b2NegV(h, box2d.b2Vec2.s_t0), box2d.b2Distance.s_supportA)),
                box2d.b2MulXV(s, i.GetVertex(_.indexA), _.wA),
                _.indexB = n.GetSupport(box2d.b2MulTRV(r.q, h, box2d.b2Distance.s_supportB)),
                box2d.b2MulXV(r, n.GetVertex(_.indexB), _.wB),
                box2d.b2SubVV(_.wB, _.wA, _.w),
                ++p,
                ++box2d.b2_gjkIters;
            var c = !1;
            for (m = 0; m < x; ++m)
                if (_.indexA === d[m] && _.indexB === l[m]) {
                    c = !0;
                    break
                }
            if (c)
        ...
        if (box2d.b2_gjkMaxIters = box2d.b2Max(box2d.b2_gjkMaxIters, p),
            b.GetWitnessPoints(o.pointA, o.pointB),
            o.distance = box2d.b2DistanceVV(o.pointA, o.pointB),
            o.iterations = p,
            b.WriteCache(t),
            e.useRadii) {
            var y = i.m_radius
                , u = n.m_radius;
            if (o.distance > y + u && o.distance > box2d.b2_epsilon) {
                o.distance -= y + u;
                var g = box2d.b2SubVV(o.pointB, o.pointA, box2d.b2Distance.s_normal);
                g.Normalize(),
                    o.pointA.SelfMulAdd(y, g),
                    o.pointB.SelfMulSub(u, g)
            } else {
                var f = box2d.b2MidVV(o.pointA, o.pointB, box2d.b2Distance.s_p);
                o.pointA.Copy(f),
                    o.pointB.Copy(f),
                    o.distance = 0
            }
    ...
    box2d.b2WeldJointDef = function () {
        goog.base(this, box2d.b2JointType.e_weldJoint),
            this.localAnchorA = new box2d.b2Vec2,
            this.localAnchorB = new box2d.b2Vec2
    }
    ,
    ...
    box2d.b2WeldJoint = function (o) {
        goog.base(this, o),
            this.m_frequencyHz = o.frequencyHz,
            this.m_dampingRatio = o.dampingRatio,
            this.m_localAnchorA = o.localAnchorA.Clone(),
            this.m_localAnchorB = o.localAnchorB.Clone(),
            this.m_referenceAngle = o.referenceAngle,
            this.m_impulse = new box2d.b2Vec3(0, 0, 0),
...
box2d.b2WeldJoint.prototype.m_invMassB = 0,
    ...
    box2d.b2WeldJoint.prototype.InitVelocityConstraints = function (o) {
        ...
        var d = this.m_invMassA
            ...
            , p = this.m_invIB
            , m = this.m_K;
        if (m.ex.x = d + l + this.m_rA.y * this.m_rA.y * x + this.m_rB.y * this.m_rB.y * p,
            m.ey.x = -this.m_rA.y * this.m_rA.x * x - this.m_rB.y * this.m_rB.x * p,
            m.ez.x = -this.m_rA.y * x - this.m_rB.y * p,
            m.ex.y = m.ey.x,
            m.ey.y = d + l + this.m_rA.x * this.m_rA.x * x + this.m_rB.x * this.m_rB.x * p,
            m.ez.y = this.m_rA.x * x + this.m_rB.x * p,
            m.ex.z = m.ez.x,
            m.ey.z = m.ez.y,
            m.ez.z = x + p,
            ...
            var h = x + p
                , _ = h > 0 ? 1 / h : 0
                , c = n - t - this.m_referenceAngle
                , y = 2 * box2d.b2_pi * this.m_frequencyHz
                , u = 2 * _ * this.m_dampingRatio * y
                , g = _ * y * y
                , f = o.step.dt;
            this.m_gamma = f * (u + f * g),
                this.m_gamma = 0 !== this.m_gamma ? 1 / this.m_gamma : 0,
                this.m_bias = c * f * g * this.m_gamma,
                h += this.m_gamma,
        ...
        if (o.step.warmStarting) {
            this.m_impulse.SelfMul(o.step.dtRatio);
            var S = box2d.b2WeldJoint.prototype.InitVelocityConstraints.s_P.SetXY(this.m_impulse.x, this.m_impulse.y);
            e.SelfMulSub(d, S),
                i -= x * (box2d.b2CrossVV(this.m_rA, S) + this.m_impulse.z),
                s.SelfMulAdd(l, S),
                r += p * (box2d.b2CrossVV(this.m_rB, S) + this.m_impulse.z)
        } else
            this.m_impulse.SetZero();
        o.velocities[this.m_indexA].w = i,
            o.velocities[this.m_indexB].w = r
    ...
    box2d.b2WeldJoint.prototype.SolveVelocityConstraints = function (o) {
        ...
        if (this.m_frequencyHz > 0) {
            var d = n - e
                , l = -this.m_mass.ez.z * (d + this.m_bias + this.m_gamma * this.m_impulse.z);
            this.m_impulse.z += l,
                e -= b * l,
                n += a * l;
            var x = box2d.b2SubVV(box2d.b2AddVCrossSV(i, n, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddVCrossSV(t, e, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2WeldJoint.prototype.SolveVelocityConstraints.s_Cdot1)
                , p = box2d.b2MulM33XY(this.m_mass, x.x, x.y, box2d.b2WeldJoint.prototype.SolveVelocityConstraints.s_impulse1).SelfNeg();
            this.m_impulse.x += p.x,
                this.m_impulse.y += p.y;
            var m = p;
            t.SelfMulSub(s, m),
                e -= b * box2d.b2CrossVV(this.m_rA, m),
                i.SelfMulAdd(r, m),
                n += a * box2d.b2CrossVV(this.m_rB, m)
        } else {
            x = box2d.b2SubVV(box2d.b2AddVCrossSV(i, n, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddVCrossSV(t, e, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2WeldJoint.prototype.SolveVelocityConstraints.s_Cdot1),
                d = n - e;
            var h = box2d.b2MulM33XYZ(this.m_mass, x.x, x.y, d, box2d.b2WeldJoint.prototype.SolveVelocityConstraints.s_impulse).SelfNeg();
            this.m_impulse.SelfAdd(h);
            m = box2d.b2WeldJoint.prototype.SolveVelocityConstraints.s_P.SetXY(h.x, h.y);
            t.SelfMulSub(s, m),
                e -= b * (box2d.b2CrossVV(this.m_rA, m) + h.z),
                i.SelfMulAdd(r, m),
                n += a * (box2d.b2CrossVV(this.m_rB, m) + h.z)
        }
        o.velocities[this.m_indexA].w = e,
            o.velocities[this.m_indexB].w = n
    }
    ...
    box2d.b2WeldJoint.prototype.SolvePositionConstraints = function (o) {
        var t = o.positions[this.m_indexA].c
            , e = o.positions[this.m_indexA].a
            , i = o.positions[this.m_indexB].c
            , n = o.positions[this.m_indexB].a
            ...
            , l = this.m_invIB;
        box2d.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
        var x = box2d.b2MulRV(s, this.m_lalcA, this.m_rA);
        box2d.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
        var p, m, h = box2d.b2MulRV(r, this.m_lalcB, this.m_rB), _ = this.m_K;
        if (_.ex.x = b + a + x.y * x.y * d + h.y * h.y * l,
            _.ey.x = -x.y * x.x * d - h.y * h.x * l,
            _.ez.x = -x.y * d - h.y * l,
            _.ex.y = _.ey.x,
            _.ey.y = b + a + x.x * x.x * d + h.x * h.x * l,
            _.ez.y = x.x * d + h.x * l,
            _.ex.z = _.ez.x,
            _.ey.z = _.ez.y,
            _.ez.z = d + l,
            this.m_frequencyHz > 0) {
            p = (y = box2d.b2SubVV(box2d.b2AddVV(i, h, box2d.b2Vec2.s_t0), box2d.b2AddVV(t, x, box2d.b2Vec2.s_t1), box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_C1)).GetLength(),
                m = 0;
            var c = _.Solve22(y.x, y.y, box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_P).SelfNeg();
            t.SelfMulSub(b, c),
                e -= d * box2d.b2CrossVV(x, c),
                i.SelfMulAdd(a, c),
                n += l * box2d.b2CrossVV(h, c)
        } else {
            var y = box2d.b2SubVV(box2d.b2AddVV(i, h, box2d.b2Vec2.s_t0), box2d.b2AddVV(t, x, box2d.b2Vec2.s_t1), box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_C1)
                , u = n - e - this.m_referenceAngle;
            p = y.GetLength(),
                m = box2d.b2Abs(u);
            var g = _.Solve33(y.x, y.y, u, box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_impulse).SelfNeg();
            c = box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_P.SetXY(g.x, g.y);
            t.SelfMulSub(b, c),
                e -= d * (box2d.b2CrossVV(this.m_rA, c) + g.z),
                i.SelfMulAdd(a, c),
                n += l * (box2d.b2CrossVV(this.m_rB, c) + g.z)
        }
        return o.positions[this.m_indexA].a = e,
            o.positions[this.m_indexB].a = n,
            p <= box2d.b2_linearSlop && m <= box2d.b2_angularSlop
    }
    ,
    ...
    box2d.b2RopeJointDef = function () {
        goog.base(this, box2d.b2JointType.e_ropeJoint),
    ...
    box2d.b2RopeJoint.prototype.InitVelocityConstraints = function (o) {
        ...
        var t = o.positions[this.m_indexA].c
            ...
            , l = this.m_qB.SetAngleRadians(r);
        box2d.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA),
            box2d.b2MulRV(d, this.m_lalcA, this.m_rA),
            box2d.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB),
            box2d.b2MulRV(l, this.m_lalcB, this.m_rB),
            this.m_u.Copy(s).SelfAdd(this.m_rB).SelfSub(t).SelfSub(this.m_rA),
            this.m_length = this.m_u.GetLength();
        var x = this.m_length - this.m_maxLength;
        if (this.m_state = x > 0 ? box2d.b2LimitState.e_atUpperLimit : box2d.b2LimitState.e_inactiveLimit,
        ...
        var p = box2d.b2CrossVV(this.m_rA, this.m_u)
            , m = box2d.b2CrossVV(this.m_rB, this.m_u)
            , h = this.m_invMassA + this.m_invIA * p * p + this.m_invMassB + this.m_invIB * m * m;
        if (this.m_mass = 0 !== h ? 1 / h : 0,
            o.step.warmStarting) {
            this.m_impulse *= o.step.dtRatio;
            var _ = box2d.b2MulSV(this.m_impulse, this.m_u, box2d.b2RopeJoint.prototype.InitVelocityConstraints.s_P);
            i.SelfMulSub(this.m_invMassA, _),
                n -= this.m_invIA * box2d.b2CrossVV(this.m_rA, _),
                b.SelfMulAdd(this.m_invMassB, _),
                a += this.m_invIB * box2d.b2CrossVV(this.m_rB, _)
        } else
            this.m_impulse = 0;
        o.velocities[this.m_indexA].w = n,
            o.velocities[this.m_indexB].w = a
    ...
    box2d.b2RopeJoint.prototype.SolveVelocityConstraints = function (o) {
        var t = o.velocities[this.m_indexA].v
            , e = o.velocities[this.m_indexA].w
            , i = o.velocities[this.m_indexB].v
            , n = o.velocities[this.m_indexB].w
            , s = box2d.b2AddVCrossSV(t, e, this.m_rA, box2d.b2RopeJoint.prototype.SolveVelocityConstraints.s_vpA)
            , r = box2d.b2AddVCrossSV(i, n, this.m_rB, box2d.b2RopeJoint.prototype.SolveVelocityConstraints.s_vpB)
            , b = this.m_length - this.m_maxLength
            , a = box2d.b2DotVV(this.m_u, box2d.b2SubVV(r, s, box2d.b2Vec2.s_t0));
        b < 0 && (a += o.step.inv_dt * b);
        var d = -this.m_mass * a
            , l = this.m_impulse;
        this.m_impulse = box2d.b2Min(0, this.m_impulse + d),
            d = this.m_impulse - l;
        var x = box2d.b2MulSV(d, this.m_u, box2d.b2RopeJoint.prototype.SolveVelocityConstraints.s_P);
        t.SelfMulSub(this.m_invMassA, x),
            e -= this.m_invIA * box2d.b2CrossVV(this.m_rA, x),
            i.SelfMulAdd(this.m_invMassB, x),
            n += this.m_invIB * box2d.b2CrossVV(this.m_rB, x),
            o.velocities[this.m_indexA].w = e,
            o.velocities[this.m_indexB].w = n
    }
    ,
    ...
    box2d.b2RopeJoint.prototype.SolvePositionConstraints = function (o) {
        var t = o.positions[this.m_indexA].c
            , e = o.positions[this.m_indexA].a
            , i = o.positions[this.m_indexB].c
            , n = o.positions[this.m_indexB].a
            ...
            , r = this.m_qB.SetAngleRadians(n);
        box2d.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
        var b = box2d.b2MulRV(s, this.m_lalcA, this.m_rA);
        box2d.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
        var a = box2d.b2MulRV(r, this.m_lalcB, this.m_rB)
            , d = this.m_u.Copy(i).SelfAdd(a).SelfSub(t).SelfSub(b)
            , l = d.Normalize()
            , x = l - this.m_maxLength;
        x = box2d.b2Clamp(x, 0, box2d.b2_maxLinearCorrection);
        var p = -this.m_mass * x
            , m = box2d.b2MulSV(p, d, box2d.b2RopeJoint.prototype.SolvePositionConstraints.s_P);
        return t.SelfMulSub(this.m_invMassA, m),
            e -= this.m_invIA * box2d.b2CrossVV(b, m),
            i.SelfMulAdd(this.m_invMassB, m),
            n += this.m_invIB * box2d.b2CrossVV(a, m),
            o.positions[this.m_indexA].a = e,
            o.positions[this.m_indexB].a = n,
            l - this.m_maxLength < box2d.b2_linearSlop
    }
    ,
    box2d.b2RopeJoint.prototype.SolvePositionConstraints.s_P = new box2d.b2Vec2,
    box2d.b2RopeJoint.prototype.GetAnchorA = function (o) {
        return this.m_bodyA.GetWorldPoint(this.m_localAnchorA, o)
    }
    ,
    ...
    box2d.b2RopeJoint.prototype.GetReactionForce = function (o, t) {
        return box2d.b2MulSV(o * this.m_impulse, this.m_u, t)
    }
    ,
    ...
    box2d.b2GravityController.prototype.Step = function (o) {
        if (this.invSqr)
            for (var t = this.m_bodyList; t; t = t.nextBody)
                for (var e = (b = t.body).GetWorldCenter(), i = b.GetMass(), n = this.m_bodyList; n !== t; n = n.nextBody) {
                    var s = (a = n.body).GetWorldCenter()
                        , r = a.GetMass();
                    if (!((x = (d = s.x - e.x) * d + (l = s.y - e.y) * l) < box2d.b2_epsilon))
                        (p = box2d.b2GravityController.prototype.Step.s_f.SetXY(d, l)).SelfMul(this.G / x / box2d.b2Sqrt(x) * i * r),
                            b.IsAwake() && b.ApplyForce(p, e),
                            a.IsAwake() && a.ApplyForce(p.SelfMul(-1), s)
                }
        else
            for (t = this.m_bodyList; t; t = t.nextBody) {
                var b;
                for (e = (b = t.body).GetWorldCenter(),
                    i = b.GetMass(),
                    n = this.m_bodyList; n !== t; n = n.nextBody) {
                    var a, d, l, x, p;
                    s = (a = n.body).GetWorldCenter(),
                        r = a.GetMass();
                    if (!((x = (d = s.x - e.x) * d + (l = s.y - e.y) * l) < box2d.b2_epsilon))
                        (p = box2d.b2GravityController.prototype.Step.s_f.SetXY(d, l)).SelfMul(this.G / x * i * r),
                            b.IsAwake() && b.ApplyForce(p, e),
                            a.IsAwake() && a.ApplyForce(p.SelfMul(-1), s)
                }
            }
    ...
    box2d.b2TimeStep.prototype.Copy = function (o) {
        return this.dt = o.dt,
            this.inv_dt = o.inv_dt,
            this.dtRatio = o.dtRatio,
            this.positionIterations = o.positionIterations,
            this.velocityIterations = o.velocityIterations,
            this.warmStarting = o.warmStarting,
            this
    }
    ,
    ...
    box2d.b2ContactFeature = function (o) {
        this._id = o
    }
    ,
    ...
    Object.defineProperty(box2d.b2ContactFeature.prototype, "indexA", {
        ...
        set: function (o) {
            this._indexA = o,
                this._id._key = 4294967040 & this._id._key | 255 & this._indexA
        }
    }),
    Object.defineProperty(box2d.b2ContactFeature.prototype, "indexB", {
        ...
        set: function (o) {
            this._indexB = o,
                this._id._key = 4294902015 & this._id._key | this._indexB << 8 & 65280
        }
    }),
    Object.defineProperty(box2d.b2ContactFeature.prototype, "typeA", {
        ...
        set: function (o) {
            this._typeA = o,
                this._id._key = 4278255615 & this._id._key | this._typeA << 16 & 16711680
        }
    }),
    Object.defineProperty(box2d.b2ContactFeature.prototype, "typeB", {
        ...
        set: function (o) {
            this._typeB = o,
                this._id._key = 16777215 & this._id._key | this._typeB << 24 & 4278190080
        }
    }),
    ...
    box2d.b2ManifoldPoint.prototype.Copy = function (o) {
        return this.localPoint.Copy(o.localPoint),
    ...
    box2d.b2Manifold.prototype.Reset = function () {
        for (var o = 0, t = box2d.b2_maxManifoldPoints; o < t; ++o)
            this.points[o].Reset();
    ...
    box2d.b2Manifold.prototype.Copy = function (o) {
        ...
        for (var t = 0, e = box2d.b2_maxManifoldPoints; t < e; ++t)
            this.points[t].Copy(o.points[t]);
        return this.localNormal.Copy(o.localNormal),
    ...
    box2d.b2WorldManifold.prototype.Initialize = function (o, t, e, i, n) {
        if (0 !== o.pointCount)
            switch (o.type) {
                case box2d.b2ManifoldType.e_circles:
                    this.normal.SetXY(1, 0);
                    var s = box2d.b2MulXV(t, o.localPoint, box2d.b2WorldManifold.prototype.Initialize.s_pointA)
                        , r = box2d.b2MulXV(i, o.points[0].localPoint, box2d.b2WorldManifold.prototype.Initialize.s_pointB);
                    box2d.b2DistanceSquaredVV(s, r) > box2d.b2_epsilon_sq && box2d.b2SubVV(r, s, this.normal).SelfNormalize();
                    var b = box2d.b2AddVMulSV(s, e, this.normal, box2d.b2WorldManifold.prototype.Initialize.s_cA)
                        , a = box2d.b2SubVMulSV(r, n, this.normal, box2d.b2WorldManifold.prototype.Initialize.s_cB);
                    box2d.b2MidVV(b, a, this.points[0]),
                        this.separations[0] = box2d.b2DotVV(box2d.b2SubVV(a, b, box2d.b2Vec2.s_t0), this.normal);
                    break;
                case box2d.b2ManifoldType.e_faceA:
                    box2d.b2MulRV(t.q, o.localNormal, this.normal);
                    for (var d = box2d.b2MulXV(t, o.localPoint, box2d.b2WorldManifold.prototype.Initialize.s_planePoint), l = 0, x = o.pointCount; l < x; ++l) {
                        var p = box2d.b2MulXV(i, o.points[l].localPoint, box2d.b2WorldManifold.prototype.Initialize.s_clipPoint)
                            , m = e - box2d.b2DotVV(box2d.b2SubVV(p, d, box2d.b2Vec2.s_t0), this.normal);
                        b = box2d.b2AddVMulSV(p, m, this.normal, box2d.b2WorldManifold.prototype.Initialize.s_cA),
                            a = box2d.b2SubVMulSV(p, n, this.normal, box2d.b2WorldManifold.prototype.Initialize.s_cB);
                        box2d.b2MidVV(b, a, this.points[l]),
                            this.separations[l] = box2d.b2DotVV(box2d.b2SubVV(a, b, box2d.b2Vec2.s_t0), this.normal)
                    }
                    break;
                case box2d.b2ManifoldType.e_faceB:
                    box2d.b2MulRV(i.q, o.localNormal, this.normal);
                    for (d = box2d.b2MulXV(i, o.localPoint, box2d.b2WorldManifold.prototype.Initialize.s_planePoint),
                        l = 0,
                        x = o.pointCount; l < x; ++l) {
                        p = box2d.b2MulXV(t, o.points[l].localPoint, box2d.b2WorldManifold.prototype.Initialize.s_clipPoint),
                            m = n - box2d.b2DotVV(box2d.b2SubVV(p, d, box2d.b2Vec2.s_t0), this.normal),
                            a = box2d.b2AddVMulSV(p, m, this.normal, box2d.b2WorldManifold.prototype.Initialize.s_cB),
                            b = box2d.b2SubVMulSV(p, e, this.normal, box2d.b2WorldManifold.prototype.Initialize.s_cA);
                        box2d.b2MidVV(b, a, this.points[l]),
                            this.separations[l] = box2d.b2DotVV(box2d.b2SubVV(b, a, box2d.b2Vec2.s_t0), this.normal)
                    }
                    this.normal.SelfNeg()
            }
    }
    ...
    box2d.b2GetPointStates = function (o, t, e, i) {
        for (var n = 0, s = e.pointCount; n < s; ++n) {
            var r = e.points[n].id.key;
            o[n] = box2d.b2PointState.b2_removeState;
            for (var b = 0, a = i.pointCount; b < a; ++b)
                if (i.points[b].id.key === r) {
                    o[n] = box2d.b2PointState.b2_persistState;
                    break
                }
        }
        for (s = box2d.b2_maxManifoldPoints; n < s; ++n)
            o[n] = box2d.b2PointState.b2_nullState;
        for (n = 0,
            s = i.pointCount; n < s; ++n) {
            r = i.points[n].id.key;
            t[n] = box2d.b2PointState.b2_addState;
            for (b = 0,
                a = e.pointCount; b < a; ++b)
                if (e.points[b].id.key === r) {
                    t[n] = box2d.b2PointState.b2_persistState;
                    break
                }
        }
        for (s = box2d.b2_maxManifoldPoints; n < s; ++n)
            t[n] = box2d.b2PointState.b2_nullState
    }
    ,
    ...
    box2d.b2RayCastOutput.prototype.Copy = function (o) {
        return this.normal.Copy(o.normal),
    ...
    box2d.b2AABB.prototype.IsValid = function () {
        var o = this.upperBound.x - this.lowerBound.x
    ...
    box2d.b2AABB.prototype.Combine1 = function (o) {
        return this.lowerBound.x = box2d.b2Min(this.lowerBound.x, o.lowerBound.x),
            this.lowerBound.y = box2d.b2Min(this.lowerBound.y, o.lowerBound.y),
            this.upperBound.x = box2d.b2Max(this.upperBound.x, o.upperBound.x),
            this.upperBound.y = box2d.b2Max(this.upperBound.y, o.upperBound.y),
            this
    }
    ,
    box2d.b2AABB.prototype.Combine2 = function (o, t) {
        return this.lowerBound.x = box2d.b2Min(o.lowerBound.x, t.lowerBound.x),
            this.lowerBound.y = box2d.b2Min(o.lowerBound.y, t.lowerBound.y),
            this.upperBound.x = box2d.b2Max(o.upperBound.x, t.upperBound.x),
            this.upperBound.y = box2d.b2Max(o.upperBound.y, t.upperBound.y),
            this
    }
    ,
    box2d.b2AABB.Combine = function (o, t, e) {
        return e.Combine2(o, t),
            e
    }
    ,
    box2d.b2AABB.prototype.Contains = function (o) {
        var t = !0;
        return t = (t = (t = (t = t && this.lowerBound.x <= o.lowerBound.x) && this.lowerBound.y <= o.lowerBound.y) && o.upperBound.x <= this.upperBound.x) && o.upperBound.y <= this.upperBound.y
    }
    ,
    box2d.b2AABB.prototype.RayCast = function (o, t) {
        ...
        if (a < box2d.b2_epsilon) {
            ...
            var x = 1 / r
                , p = -1;
            if ((h = (this.lowerBound.x - n) * x) > (_ = (this.upperBound.x - n) * x)) {
                var m = h;
                h = _,
                    _ = m,
                    p = 1
        ...
        if (d < box2d.b2_epsilon) {
            ...
            x = 1 / b,
                p = -1;
            if ((h = (this.lowerBound.y - s) * x) > (_ = (this.upperBound.y - s) * x)) {
                m = h;
                h = _,
                    _ = m,
                    p = 1
        ...
        return !(e < 0 || t.maxFraction < e) && (o.fraction = e,
            !0)
    }
    ,
    box2d.b2AABB.prototype.TestOverlap = function (o) {
        var t = o.lowerBound.x - this.upperBound.x
            , e = o.lowerBound.y - this.upperBound.y
            , i = this.lowerBound.x - o.upperBound.x
            , n = this.lowerBound.y - o.upperBound.y;
        return !(t > 0 || e > 0) && !(i > 0 || n > 0)
    }
    ,
    box2d.b2TestOverlapAABB = function (o, t) {
        var e = t.lowerBound.x - o.upperBound.x
            , i = t.lowerBound.y - o.upperBound.y
            , n = o.lowerBound.x - t.upperBound.x
            , s = o.lowerBound.y - t.upperBound.y;
        return !(e > 0 || i > 0) && !(n > 0 || s > 0)
    }
    ,
    box2d.b2ClipSegmentToLine = function (o, t, e, i, n) {
        var s = 0
            , r = t[0]
            , b = t[1]
            , a = box2d.b2DotVV(e, r.v) - i
            , d = box2d.b2DotVV(e, b.v) - i;
        if (a <= 0 && o[s++].Copy(r),
            d <= 0 && o[s++].Copy(b),
            a * d < 0) {
            var l = a / (a - d)
                , x = o[s].v;
            x.x = r.v.x + l * (b.v.x - r.v.x),
                x.y = r.v.y + l * (b.v.y - r.v.y);
            var p = o[s].id;
            p.cf.indexA = n,
                p.cf.indexB = r.id.cf.indexB,
                p.cf.typeA = box2d.b2ContactFeatureType.e_vertex,
                p.cf.typeB = box2d.b2ContactFeatureType.e_face,
                ++s
        }
        return s
    }
    ,
    box2d.b2TestOverlapShape = function (o, t, e, i, n, s) {
        var r = box2d.b2TestOverlapShape.s_input.Reset();
        r.proxyA.SetShape(o, t),
            r.proxyB.SetShape(e, i),
            r.transformA.Copy(n),
            r.transformB.Copy(s),
            r.useRadii = !0;
        var b = box2d.b2TestOverlapShape.s_simplexCache.Reset();
        b.count = 0;
        var a = box2d.b2TestOverlapShape.s_output.Reset();
        return box2d.b2Distance(a, b, r),
            a.distance < 10 * box2d.b2_epsilon
    }
    ,
    ...
    box2d.b2Timer.prototype.Reset = function () {
        return this.m_start = (new Date).getTime(),
            this
    }
    ,
    ...
    box2d.b2SeparationFunction.prototype.Initialize = function (o, t, e, i, n, s) {
        this.m_proxyA = t,
            this.m_proxyB = i;
        var r = o.count;
        box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < r && r < 3),
            this.m_sweepA.Copy(e),
            this.m_sweepB.Copy(n);
        var b = box2d.b2TimeOfImpact.s_xfA
            , a = box2d.b2TimeOfImpact.s_xfB;
        if (this.m_sweepA.GetTransform(b, s),
            this.m_sweepB.GetTransform(a, s),
            1 === r) {
            this.m_type = box2d.b2SeparationFunctionType.e_points;
            var d = this.m_proxyA.GetVertex(o.indexA[0])
                , l = this.m_proxyB.GetVertex(o.indexB[0])
                , x = box2d.b2MulXV(b, d, box2d.b2TimeOfImpact.s_pointA)
                , p = box2d.b2MulXV(a, l, box2d.b2TimeOfImpact.s_pointB);
            return box2d.b2SubVV(p, x, this.m_axis),
                u = this.m_axis.Normalize()
        }
        if (o.indexA[0] === o.indexA[1]) {
            this.m_type = box2d.b2SeparationFunctionType.e_faceB;
            var m = this.m_proxyB.GetVertex(o.indexB[0])
                , h = this.m_proxyB.GetVertex(o.indexB[1]);
            box2d.b2CrossVOne(box2d.b2SubVV(h, m, box2d.b2Vec2.s_t0), this.m_axis).SelfNormalize();
            var _ = box2d.b2MulRV(a.q, this.m_axis, box2d.b2TimeOfImpact.s_normal);
            box2d.b2MidVV(m, h, this.m_localPoint);
            p = box2d.b2MulXV(a, this.m_localPoint, box2d.b2TimeOfImpact.s_pointB),
                d = this.m_proxyA.GetVertex(o.indexA[0]),
                x = box2d.b2MulXV(b, d, box2d.b2TimeOfImpact.s_pointA);
            return (u = box2d.b2DotVV(box2d.b2SubVV(x, p, box2d.b2Vec2.s_t0), _)) < 0 && (this.m_axis.SelfNeg(),
                u = -u),
                u
        }
        this.m_type = box2d.b2SeparationFunctionType.e_faceA;
        var c = this.m_proxyA.GetVertex(o.indexA[0])
            , y = this.m_proxyA.GetVertex(o.indexA[1]);
        box2d.b2CrossVOne(box2d.b2SubVV(y, c, box2d.b2Vec2.s_t0), this.m_axis).SelfNormalize();
        _ = box2d.b2MulRV(b.q, this.m_axis, box2d.b2TimeOfImpact.s_normal);
        box2d.b2MidVV(c, y, this.m_localPoint);
        var u;
        x = box2d.b2MulXV(b, this.m_localPoint, box2d.b2TimeOfImpact.s_pointA),
            l = this.m_proxyB.GetVertex(o.indexB[0]),
            p = box2d.b2MulXV(a, l, box2d.b2TimeOfImpact.s_pointB);
        return (u = box2d.b2DotVV(box2d.b2SubVV(p, x, box2d.b2Vec2.s_t0), _)) < 0 && (this.m_axis.SelfNeg(),
            u = -u),
            u
    }
    ,
    box2d.b2SeparationFunction.prototype.FindMinSeparation = function (o, t, e) {
        var i = box2d.b2TimeOfImpact.s_xfA
            , n = box2d.b2TimeOfImpact.s_xfB;
        switch (this.m_sweepA.GetTransform(i, e),
        this.m_sweepB.GetTransform(n, e),
        this.m_type) {
            case box2d.b2SeparationFunctionType.e_points:
                var s = box2d.b2MulTRV(i.q, this.m_axis, box2d.b2TimeOfImpact.s_axisA)
                    , r = box2d.b2MulTRV(n.q, box2d.b2NegV(this.m_axis, box2d.b2Vec2.s_t0), box2d.b2TimeOfImpact.s_axisB);
                o[0] = this.m_proxyA.GetSupport(s),
                    t[0] = this.m_proxyB.GetSupport(r);
                var b = this.m_proxyA.GetVertex(o[0])
                    , a = this.m_proxyB.GetVertex(t[0])
                    , d = box2d.b2MulXV(i, b, box2d.b2TimeOfImpact.s_pointA)
                    , l = box2d.b2MulXV(n, a, box2d.b2TimeOfImpact.s_pointB);
                return box2d.b2DotVV(box2d.b2SubVV(l, d, box2d.b2Vec2.s_t0), this.m_axis);
            case box2d.b2SeparationFunctionType.e_faceA:
                var x = box2d.b2MulRV(i.q, this.m_axis, box2d.b2TimeOfImpact.s_normal);
                d = box2d.b2MulXV(i, this.m_localPoint, box2d.b2TimeOfImpact.s_pointA),
                    r = box2d.b2MulTRV(n.q, box2d.b2NegV(x, box2d.b2Vec2.s_t0), box2d.b2TimeOfImpact.s_axisB);
                o[0] = -1,
                    t[0] = this.m_proxyB.GetSupport(r);
                a = this.m_proxyB.GetVertex(t[0]),
                    l = box2d.b2MulXV(n, a, box2d.b2TimeOfImpact.s_pointB);
                return box2d.b2DotVV(box2d.b2SubVV(l, d, box2d.b2Vec2.s_t0), x);
            case box2d.b2SeparationFunctionType.e_faceB:
                x = box2d.b2MulRV(n.q, this.m_axis, box2d.b2TimeOfImpact.s_normal),
                    l = box2d.b2MulXV(n, this.m_localPoint, box2d.b2TimeOfImpact.s_pointB),
                    s = box2d.b2MulTRV(i.q, box2d.b2NegV(x, box2d.b2Vec2.s_t0), box2d.b2TimeOfImpact.s_axisA);
                t[0] = -1,
                    o[0] = this.m_proxyA.GetSupport(s);
                b = this.m_proxyA.GetVertex(o[0]),
                    d = box2d.b2MulXV(i, b, box2d.b2TimeOfImpact.s_pointA);
                return box2d.b2DotVV(box2d.b2SubVV(d, l, box2d.b2Vec2.s_t0), x);
            default:
                return box2d.ENABLE_ASSERTS && box2d.b2Assert(!1),
                    o[0] = -1,
                    t[0] = -1,
    ...
    box2d.b2SeparationFunction.prototype.Evaluate = function (o, t, e) {
        ...
        this.m_type) {
            case box2d.b2SeparationFunctionType.e_points:
                var s = this.m_proxyA.GetVertex(o)
                    , r = this.m_proxyB.GetVertex(t)
                    , b = box2d.b2MulXV(i, s, box2d.b2TimeOfImpact.s_pointA)
                    , a = box2d.b2MulXV(n, r, box2d.b2TimeOfImpact.s_pointB);
                return box2d.b2DotVV(box2d.b2SubVV(a, b, box2d.b2Vec2.s_t0), this.m_axis);
            case box2d.b2SeparationFunctionType.e_faceA:
                var d = box2d.b2MulRV(i.q, this.m_axis, box2d.b2TimeOfImpact.s_normal);
                b = box2d.b2MulXV(i, this.m_localPoint, box2d.b2TimeOfImpact.s_pointA),
                    r = this.m_proxyB.GetVertex(t),
                    a = box2d.b2MulXV(n, r, box2d.b2TimeOfImpact.s_pointB);
                return box2d.b2DotVV(box2d.b2SubVV(a, b, box2d.b2Vec2.s_t0), d);
            case box2d.b2SeparationFunctionType.e_faceB:
                d = box2d.b2MulRV(n.q, this.m_axis, box2d.b2TimeOfImpact.s_normal),
                    a = box2d.b2MulXV(n, this.m_localPoint, box2d.b2TimeOfImpact.s_pointB),
                    s = this.m_proxyA.GetVertex(o),
                    b = box2d.b2MulXV(i, s, box2d.b2TimeOfImpact.s_pointA);
                return box2d.b2DotVV(box2d.b2SubVV(b, a, box2d.b2Vec2.s_t0), d);
            default:
                return box2d.ENABLE_ASSERTS && box2d.b2Assert(!1),
                    0
        }
    ...
    box2d.b2TimeOfImpact = function (o, t) {
        ...
        ++box2d.b2_toiCalls,
            o.state = box2d.b2TOIOutputState.e_unknown,
            o.t = t.tMax;
        var i = t.proxyA
            , n = t.proxyB
            , s = box2d.b2TimeOfImpact.s_sweepA.Copy(t.sweepA)
            , r = box2d.b2TimeOfImpact.s_sweepB.Copy(t.sweepB);
        s.Normalize(),
            r.Normalize();
        var b = t.tMax
            , a = i.m_radius + n.m_radius
            , d = box2d.b2Max(box2d.b2_linearSlop, a - 3 * box2d.b2_linearSlop)
            , l = .25 * box2d.b2_linearSlop;
        box2d.ENABLE_ASSERTS && box2d.b2Assert(d > l);
        var x = 0
            , p = 0
            , m = box2d.b2TimeOfImpact.s_cache;
        m.count = 0;
        var h = box2d.b2TimeOfImpact.s_distanceInput;
        for (h.proxyA = t.proxyA,
            h.proxyB = t.proxyB,
            h.useRadii = !1; ;) {
            var _ = box2d.b2TimeOfImpact.s_xfA
                , c = box2d.b2TimeOfImpact.s_xfB;
            s.GetTransform(_, x),
                r.GetTransform(c, x),
                h.transformA.Copy(_),
                h.transformB.Copy(c);
            var y = box2d.b2TimeOfImpact.s_distanceOutput;
            if (box2d.b2Distance(y, m, h),
                y.distance <= 0) {
                o.state = box2d.b2TOIOutputState.e_overlapped,
                    o.t = 0;
                break
            }
            if (y.distance < d + l) {
                o.state = box2d.b2TOIOutputState.e_touching,
                    o.t = x;
                break
            }
            var u = box2d.b2TimeOfImpact.s_fcn;
            u.Initialize(m, i, s, n, r, x);
            for (var g = !1, f = b, S = 0; ;) {
                var A = box2d.b2TimeOfImpact.s_indexA
                    , C = box2d.b2TimeOfImpact.s_indexB
                    , v = u.FindMinSeparation(A, C, f);
                if (v > d + l) {
                    o.state = box2d.b2TOIOutputState.e_separated,
                        o.t = b,
                        g = !0;
                    break
                }
                ...
                var V = u.Evaluate(A[0], C[0], x);
                if (V < d - l) {
                    o.state = box2d.b2TOIOutputState.e_failed,
                        o.t = x,
                        g = !0;
                    break
                }
                ...
                for (var B = 0, w = x, P = f; ;) {
                    var M = 0;
                    M = 1 & B ? w + (d - V) * (P - w) / (v - V) : .5 * (w + P),
                        ++B,
                        ++box2d.b2_toiRootIters;
                    var D = u.Evaluate(A[0], C[0], M);
                    if (box2d.b2Abs(D - d) < l) {
                        f = M;
                        break
                    }
                    if (D > d ? (w = M,
                ...
                if (box2d.b2_toiMaxRootIters = box2d.b2Max(box2d.b2_toiMaxRootIters, B),
                    ++S === box2d.b2_maxPolygonVertices)
                    break
            }
            if (++p,
                ++box2d.b2_toiIters,
        ...
        var J = e.GetMilliseconds();
        box2d.b2_toiMaxTime = box2d.b2Max(box2d.b2_toiMaxTime, J),
            box2d.b2_toiTime += J
    }
    ,
    ...
    ,
    box2d.b2MixRestitution = function (o, t) {
        return o > t ? o : t
    }
    ,
    ...
    box2d.b2Contact.prototype.GetWorldManifold = function (o) {
        ...
        o.Initialize(this.m_manifold, t.GetTransform(), i.m_radius, e.GetTransform(), n.m_radius)
    }
    ,
    ...
    box2d.b2Contact.prototype.SetEnabled = function (o) {
        o ? this.m_flags |= box2d.b2ContactFlag.e_enabledFlag : this.m_flags &= ~box2d.b2ContactFlag.e_enabledFlag
    }
    ,
    ...
    ,
    box2d.b2Contact.prototype.Evaluate = function (o, t, e) { }
    ,
    ...
    ,
    box2d.b2Contact.prototype.Reset = function (o, t, e, i) {
    ...
    box2d.b2Contact.prototype.Update = function (o) {
        ...
        this.m_oldManifold = this.m_manifold,
            ...
            this.m_flags |= box2d.b2ContactFlag.e_enabledFlag;
        var e = !1
            , i = (this.m_flags & box2d.b2ContactFlag.e_touchingFlag) === box2d.b2ContactFlag.e_touchingFlag
            , n = this.m_fixtureA.IsSensor()
            , s = this.m_fixtureB.IsSensor()
            , r = n || s
            , b = this.m_fixtureA.GetBody()
            , a = this.m_fixtureB.GetBody()
            , d = b.GetTransform()
            , l = a.GetTransform();
        if (r) {
            var x = this.m_fixtureA.GetShape()
                , p = this.m_fixtureB.GetShape();
            e = box2d.b2TestOverlapShape(x, this.m_indexA, p, this.m_indexB, d, l),
                this.m_manifold.pointCount = 0
        } else {
            this.Evaluate(this.m_manifold, d, l),
                e = this.m_manifold.pointCount > 0;
            for (var m = 0; m < this.m_manifold.pointCount; ++m) {
                var h = this.m_manifold.points[m];
                h.normalImpulse = 0,
                    h.tangentImpulse = 0;
                for (var _ = h.id, c = 0; c < this.m_oldManifold.pointCount; ++c) {
                    var y = this.m_oldManifold.points[c];
                    if (y.id.key === _.key) {
                        h.normalImpulse = y.normalImpulse,
                            h.tangentImpulse = y.tangentImpulse;
                        break
                    }
                }
            }
        ...
        e ? this.m_flags |= box2d.b2ContactFlag.e_touchingFlag : this.m_flags &= ~box2d.b2ContactFlag.e_touchingFlag,
            !1 === i && !0 === e && o && o.BeginContact(this),
            !0 === i && !1 === e && o && o.EndContact(this),
            !1 === r && e && o && o.PreSolve(this, this.m_oldManifold)
    }
    ,
    box2d.b2Contact.prototype.ComputeTOI = function (o, t) {
        var e = box2d.b2Contact.prototype.ComputeTOI.s_input;
        e.proxyA.SetShape(this.m_fixtureA.GetShape(), this.m_indexA),
            e.proxyB.SetShape(this.m_fixtureB.GetShape(), this.m_indexB),
            e.sweepA.Copy(o),
            e.sweepB.Copy(t),
            e.tMax = box2d.b2_linearSlop;
        var i = box2d.b2Contact.prototype.ComputeTOI.s_output;
        return box2d.b2TimeOfImpact(i, e),
            i.t
    }
    ,
    ...
    ,
    box2d.b2PolygonAndCircleContact.Destroy = function (o, t) { }
    ,
    box2d.b2PolygonAndCircleContact.prototype.Reset = function (o, t, e, i) {
        goog.base(this, "Reset", o, t, e, i),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(o.GetType() === box2d.b2ShapeType.e_polygonShape),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(e.GetType() === box2d.b2ShapeType.e_circleShape)
    }
    ,
    box2d.b2PolygonAndCircleContact.prototype.Evaluate = function (o, t, e) {
        var i = this.m_fixtureA.GetShape()
            , n = this.m_fixtureB.GetShape();
        box2d.ENABLE_ASSERTS && box2d.b2Assert(i instanceof box2d.b2PolygonShape),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(n instanceof box2d.b2CircleShape),
            box2d.b2CollidePolygonAndCircle(o, i instanceof box2d.b2PolygonShape ? i : null, t, n instanceof box2d.b2CircleShape ? n : null, e)
    }
    ,
    ...
    ,
    box2d.b2EdgeAndPolygonContact.Destroy = function (o, t) { }
    ,
    box2d.b2EdgeAndPolygonContact.prototype.Reset = function (o, t, e, i) {
        goog.base(this, "Reset", o, t, e, i),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(o.GetType() === box2d.b2ShapeType.e_edgeShape),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(e.GetType() === box2d.b2ShapeType.e_polygonShape)
    }
    ,
    box2d.b2EdgeAndPolygonContact.prototype.Evaluate = function (o, t, e) {
        var i = this.m_fixtureA.GetShape()
            , n = this.m_fixtureB.GetShape();
        box2d.ENABLE_ASSERTS && box2d.b2Assert(i instanceof box2d.b2EdgeShape),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(n instanceof box2d.b2PolygonShape),
            box2d.b2CollideEdgeAndPolygon(o, i instanceof box2d.b2EdgeShape ? i : null, t, n instanceof box2d.b2PolygonShape ? n : null, e)
    }
    ,
    ...
    box2d.b2Shape.prototype.Copy = function (o) {
        return box2d.ENABLE_ASSERTS && box2d.b2Assert(this.m_type === o.m_type),
            this.m_radius = o.m_radius,
            this
    }
    ,
    ...
    box2d.b2Shape.prototype.GetChildCount = function () {
        return box2d.ENABLE_ASSERTS && box2d.b2Assert(!1, "pure virtual"),
            0
    }
    ,
    ...
    ,
    box2d.b2Shape.prototype.RayCast = function (o, t, e, i) {
        return box2d.ENABLE_ASSERTS && box2d.b2Assert(!1, "pure virtual"),
            !1
    }
    ,
    ...
    ,
    box2d.b2Shape.prototype.ComputeSubmergedArea = function (o, t, e, i) {
        return box2d.ENABLE_ASSERTS && box2d.b2Assert(!1, "pure virtual"),
            0
    }
    ,
    ...
    box2d.b2PolygonShape.prototype.Copy = function (o) {
        goog.base(this, "Copy", o),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(o instanceof box2d.b2PolygonShape),
            this.m_centroid.Copy(o.m_centroid),
            this.m_count = o.m_count;
        for (var t = 0, e = this.m_count; t < e; ++t)
            this.m_vertices[t].Copy(o.m_vertices[t]),
                this.m_normals[t].Copy(o.m_normals[t]);
        return this
    }
    ,
    box2d.b2PolygonShape.prototype.SetAsBox = function (o, t) {
        return this.m_count = 4,
            this.m_vertices[0].SetXY(-o, -t),
            this.m_vertices[1].SetXY(o, -t),
            this.m_vertices[2].SetXY(o, t),
            this.m_vertices[3].SetXY(-o, t),
    ...
    ,
    box2d.b2PolygonShape.prototype.SetAsOrientedBox = function (o, t, e, i) {
        this.m_count = 4,
            this.m_vertices[0].SetXY(-o, -t),
            this.m_vertices[1].SetXY(o, -t),
            this.m_vertices[2].SetXY(o, t),
            ...
            this.m_normals[2].SetXY(0, 1),
            this.m_normals[3].SetXY(-1, 0),
            this.m_centroid.Copy(e);
        var n = new box2d.b2Transform;
        n.SetPosition(e),
            n.SetRotationAngleRadians(i);
        for (var s = 0, r = this.m_count; s < r; ++s)
            box2d.b2MulXV(n, this.m_vertices[s], this.m_vertices[s]),
                box2d.b2MulRV(n.q, this.m_normals[s], this.m_normals[s]);
        return this
    }
    ,
    box2d.b2PolygonShape.prototype.Set = function (o, t) {
        if (void 0 === t && (t = o.length),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(3 <= t && t <= box2d.b2_maxPolygonVertices),
            t < 3)
            return this.SetAsBox(1, 1);
        for (var e = box2d.b2Min(t, box2d.b2_maxPolygonVertices), i = box2d.b2PolygonShape.prototype.Set.s_ps, n = 0, s = 0; s < e; ++s) {
            for (var r = o[s], b = !0, a = 0; a < n; ++a)
                if (box2d.b2DistanceSquaredVV(r, i[a]) < .5 * box2d.b2_linearSlop) {
                    b = !1;
                    break
                }
            b && i[n++].Copy(r)
        ...
        for (s = 1; s < e; ++s) {
            var x = i[s].x;
            (x > l || x === l && i[s].y < i[d].y) && (d = s,
                l = x)
        }
        for (var p = box2d.b2PolygonShape.prototype.Set.s_hull, m = 0, h = d; ;) {
            p[m] = h;
            var _ = 0;
            for (a = 1; a < e; ++a)
                if (_ !== h) {
                    var c = box2d.b2SubVV(i[_], i[p[m]], box2d.b2PolygonShape.prototype.Set.s_r)
                        , y = (r = box2d.b2SubVV(i[a], i[p[m]], box2d.b2PolygonShape.prototype.Set.s_v),
                            box2d.b2CrossVV(c, r));
                    y < 0 && (_ = a),
                        0 === y && r.GetLengthSquared() > c.GetLengthSquared() && (_ = a)
                } else
                    _ = a;
            if (++m,
                h = _,
        ...
        this.m_count = m;
        for (s = 0; s < m; ++s)
            this.m_vertices[s].Copy(i[p[s]]);
        s = 0;
        for (var u = m; s < u; ++s) {
            var g = this.m_vertices[s]
                , f = this.m_vertices[(s + 1) % u]
                , S = box2d.b2SubVV(f, g, box2d.b2Vec2.s_t0);
            box2d.ENABLE_ASSERTS && box2d.b2Assert(S.GetLengthSquared() > box2d.b2_epsilon_sq),
                box2d.b2CrossVOne(S, this.m_normals[s]).SelfNormalize()
        }
        return box2d.b2PolygonShape.ComputeCentroid(this.m_vertices, m, this.m_centroid),
            this
    }
    ,
    ...
    box2d.b2PolygonShape.prototype.SetAsVector = function (o, t) {
        return this.Set(o, t),
            this
    }
    ,
    box2d.b2PolygonShape.prototype.SetAsArray = function (o, t) {
        return this.Set(o, t),
            this
    }
    ,
    ...
    box2d.b2PolygonShape.prototype.TestPoint = function (o, t) {
        for (var e = box2d.b2MulTXV(o, t, box2d.b2PolygonShape.prototype.TestPoint.s_pLocal), i = 0, n = this.m_count; i < n; ++i) {
            if (box2d.b2DotVV(this.m_normals[i], box2d.b2SubVV(e, this.m_vertices[i], box2d.b2Vec2.s_t0)) > 0)
                return !1
        }
        return !0
    }
    ...
    box2d.b2PolygonShape.prototype.RayCast = function (o, t, e, i) {
        for (var n = box2d.b2MulTXV(e, t.p1, box2d.b2PolygonShape.prototype.RayCast.s_p1), s = box2d.b2MulTXV(e, t.p2, box2d.b2PolygonShape.prototype.RayCast.s_p2), r = box2d.b2SubVV(s, n, box2d.b2PolygonShape.prototype.RayCast.s_d), b = 0, a = t.maxFraction, d = -1, l = 0, x = this.m_count; l < x; ++l) {
            var p = box2d.b2DotVV(this.m_normals[l], box2d.b2SubVV(this.m_vertices[l], n, box2d.b2Vec2.s_t0))
                , m = box2d.b2DotVV(this.m_normals[l], r);
            if (0 === m) {
                if (p < 0)
                    return !1
            } else
        ...
        return box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= b && b <= t.maxFraction),
            d >= 0 && (o.fraction = b,
                box2d.b2MulRV(e.q, this.m_normals[d], o.normal),
                !0)
    }
    ,
    ...
    box2d.b2PolygonShape.prototype.ComputeAABB = function (o, t, e) {
        for (var i = box2d.b2MulXV(t, this.m_vertices[0], o.lowerBound), n = o.upperBound.Copy(i), s = 0, r = this.m_count; s < r; ++s) {
            var b = box2d.b2MulXV(t, this.m_vertices[s], box2d.b2PolygonShape.prototype.ComputeAABB.s_v);
            box2d.b2MinV(b, i, i),
                box2d.b2MaxV(b, n, n)
        }
        var a = this.m_radius;
    ...
    box2d.b2PolygonShape.prototype.ComputeMass = function (o, t) {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(this.m_count >= 3);
        for (var e = box2d.b2PolygonShape.prototype.ComputeMass.s_center.SetZero(), i = 0, n = 0, s = box2d.b2PolygonShape.prototype.ComputeMass.s_s.SetZero(), r = 0, b = this.m_count; r < b; ++r)
            s.SelfAdd(this.m_vertices[r]);
        s.SelfMul(1 / this.m_count);
        for (r = 0,
            b = this.m_count; r < b; ++r) {
            var a = box2d.b2SubVV(this.m_vertices[r], s, box2d.b2PolygonShape.prototype.ComputeMass.s_e1)
                , d = box2d.b2SubVV(this.m_vertices[(r + 1) % b], s, box2d.b2PolygonShape.prototype.ComputeMass.s_e2)
                , l = box2d.b2CrossVV(a, d)
                , x = .5 * l;
            i += x,
                e.SelfAdd(box2d.b2MulSV(x * (1 / 3), box2d.b2AddVV(a, d, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t1));
            var p = a.x
                , m = a.y
                , h = d.x
                , _ = d.y;
            n += 1 / 3 * .25 * l * (p * p + h * p + h * h + (m * m + _ * m + _ * _))
        }
        o.mass = t * i,
            box2d.ENABLE_ASSERTS && box2d.b2Assert(i > box2d.b2_epsilon),
            e.SelfMul(1 / i),
            box2d.b2AddVV(e, s, o.center),
            o.I = t * n,
            o.I += o.mass * (box2d.b2DotVV(o.center, o.center) - box2d.b2DotVV(e, e))
    }
    ,
    ...
    box2d.b2PolygonShape.prototype.Validate = function () {
        for (var o = 0; o < this.m_count; ++o)
            for (var t = o, e = (o + 1) % this.m_count, i = this.m_vertices[t], n = box2d.b2SubVV(this.m_vertices[e], i, box2d.b2PolygonShape.prototype.Validate.s_e), s = 0; s < this.m_count; ++s)
                if (s !== t && s !== e) {
                    var r = box2d.b2SubVV(this.m_vertices[s], i, box2d.b2PolygonShape.prototype.Validate.s_v);
                    if (box2d.b2CrossVV(n, r) < 0)
                        return !1
                }
        return !0
    }
    ...
    box2d.b2PolygonShape.prototype.SetupDistanceProxy = function (o, t) {
        o.m_vertices = this.m_vertices,
            o.m_count = this.m_count,
            o.m_radius = this.m_radius
    }
    ,
    box2d.b2PolygonShape.prototype.ComputeSubmergedArea = function (o, t, e, i) {
        for (var n = box2d.b2MulTRV(e.q, o, box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_normalL), s = t - box2d.b2DotVV(o, e.p), r = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_depths, b = 0, a = -1, d = -1, l = !1, x = 0, p = this.m_count; x < p; ++x) {
            r[x] = box2d.b2DotVV(n, this.m_vertices[x]) - s;
            var m = r[x] < -box2d.b2_epsilon;
            x > 0 && (m ? l || (a = x - 1,
                b++) : l && (d = x - 1,
                    b++)),
                l = m
        ...
        switch (b) {
            case 0:
                if (l) {
                    var h = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_md;
                    return this.ComputeMass(h, 1),
                        box2d.b2MulXV(e, h.center, i),
                        h.mass
                }
                return 0;
            case 1:
                -1 === a ? a = this.m_count - 1 : d = this.m_count - 1
        }
        var _ = (a + 1) % this.m_count
            , c = (d + 1) % this.m_count
            , y = (0 - r[a]) / (r[_] - r[a])
            , u = (0 - r[d]) / (r[c] - r[d])
            , g = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_intoVec.SetXY(this.m_vertices[a].x * (1 - y) + this.m_vertices[_].x * y, this.m_vertices[a].y * (1 - y) + this.m_vertices[_].y * y)
            , f = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_outoVec.SetXY(this.m_vertices[d].x * (1 - u) + this.m_vertices[c].x * u, this.m_vertices[d].y * (1 - u) + this.m_vertices[c].y * u)
            , S = 0
            , A = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_center.SetZero()
            , C = this.m_vertices[_]
            , v = null;
        for (x = _; x !== c;) {
            v = (x = (x + 1) % this.m_count) === c ? f : this.m_vertices[x];
            var V = .5 * ((C.x - g.x) * (v.y - g.y) - (C.y - g.y) * (v.x - g.x));
            S += V,
                A.x += V * (g.x + C.x + v.x) / 3,
                A.y += V * (g.y + C.y + v.y) / 3,
                C = v
        }
        return A.SelfMul(1 / S),
            box2d.b2MulXV(e, A, i),
            S
    }
    ,
    ...
    box2d.b2PolygonShape.ComputeCentroid = function (o, t, e) {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(t >= 3);
        var i = e;
        i.SetZero();
        for (var n = 0, s = box2d.b2PolygonShape.ComputeCentroid.s_pRef.SetZero(), r = 0; r < t; ++r) {
            var b = s
                , a = o[r]
                , d = o[(r + 1) % t]
                , l = box2d.b2SubVV(a, b, box2d.b2PolygonShape.ComputeCentroid.s_e1)
                , x = box2d.b2SubVV(d, b, box2d.b2PolygonShape.ComputeCentroid.s_e2)
                , p = .5 * box2d.b2CrossVV(l, x);
            n += p,
                i.x += p * (1 / 3) * (b.x + a.x + d.x),
                i.y += p * (1 / 3) * (b.y + a.y + d.y)
        }
        return box2d.ENABLE_ASSERTS && box2d.b2Assert(n > box2d.b2_epsilon),
            i.SelfMul(1 / n),
            i
    }
    ,
    ...
    goog.require("box2d.b2Collision"),
    box2d.b2CollideEdgeAndCircle = function (o, t, e, i, n) {
        o.pointCount = 0;
        var s = box2d.b2MulTXV(e, box2d.b2MulXV(n, i.m_p, box2d.b2Vec2.s_t0), box2d.b2CollideEdgeAndCircle.s_Q)
            , r = t.m_vertex1
            , b = t.m_vertex2
            , a = box2d.b2SubVV(b, r, box2d.b2CollideEdgeAndCircle.s_e)
            , d = box2d.b2DotVV(a, box2d.b2SubVV(b, s, box2d.b2Vec2.s_t0))
            , l = box2d.b2DotVV(a, box2d.b2SubVV(s, r, box2d.b2Vec2.s_t0))
            , x = t.m_radius + i.m_radius
            , p = box2d.b2CollideEdgeAndCircle.s_id;
        if (p.cf.indexB = 0,
            p.cf.typeB = box2d.b2ContactFeatureType.e_vertex,
            l <= 0) {
            var m = r
                , h = box2d.b2SubVV(s, m, box2d.b2CollideEdgeAndCircle.s_d);
            if (box2d.b2DotVV(h, h) > x * x)
                return;
            if (t.m_hasVertex0) {
                var _ = t.m_vertex0
                    , c = r
                    , y = box2d.b2SubVV(c, _, box2d.b2CollideEdgeAndCircle.s_e1);
                if (box2d.b2DotVV(y, box2d.b2SubVV(c, s, box2d.b2Vec2.s_t0)) > 0)
                    return
            }
            return p.cf.indexA = 0,
                p.cf.typeA = box2d.b2ContactFeatureType.e_vertex,
                o.pointCount = 1,
                o.type = box2d.b2ManifoldType.e_circles,
                o.localNormal.SetZero(),
                o.localPoint.Copy(m),
                o.points[0].id.Copy(p),
                void o.points[0].localPoint.Copy(i.m_p)
        }
        if (d <= 0) {
            m = b,
                h = box2d.b2SubVV(s, m, box2d.b2CollideEdgeAndCircle.s_d);
            ...
            if (t.m_hasVertex3) {
                var u = t.m_vertex3
                    , g = b
                    , f = box2d.b2SubVV(u, g, box2d.b2CollideEdgeAndCircle.s_e2);
                if (box2d.b2DotVV(f, box2d.b2SubVV(s, g, box2d.b2Vec2.s_t0)) > 0)
                    return
            }
            return p.cf.indexA = 1,
                p.cf.typeA = box2d.b2ContactFeatureType.e_vertex,
                o.pointCount = 1,
                o.type = box2d.b2ManifoldType.e_circles,
                o.localNormal.SetZero(),
        ...
        var S = box2d.b2DotVV(a, a);
        box2d.ENABLE_ASSERTS && box2d.b2Assert(S > 0),
            (m = box2d.b2CollideEdgeAndCircle.s_P).x = 1 / S * (d * r.x + l * b.x),
            m.y = 1 / S * (d * r.y + l * b.y);
        h = box2d.b2SubVV(s, m, box2d.b2CollideEdgeAndCircle.s_d);
        if (!(box2d.b2DotVV(h, h) > x * x)) {
            var A = box2d.b2CollideEdgeAndCircle.s_n.SetXY(-a.y, a.x);
            box2d.b2DotVV(A, box2d.b2SubVV(s, r, box2d.b2Vec2.s_t0)) < 0 && A.SetXY(-A.x, -A.y),
                A.Normalize(),
                p.cf.indexA = 0,
                p.cf.typeA = box2d.b2ContactFeatureType.e_face,
                o.pointCount = 1,
                o.type = box2d.b2ManifoldType.e_faceA,
                o.localNormal.Copy(A),
                o.localPoint.Copy(r),
                o.points[0].id.Copy(p),
                o.points[0].localPoint.Copy(i.m_p)
        }
    }
    ,
    ...
    box2d.b2EPCollider.prototype.Collide = function (o, t, e, i, n) {
        box2d.b2MulTXX(e, n, this.m_xf),
            box2d.b2MulXV(this.m_xf, i.m_centroid, this.m_centroidB),
            this.m_v0.Copy(t.m_vertex0),
            this.m_v1.Copy(t.m_vertex1),
            this.m_v2.Copy(t.m_vertex2),
            this.m_v3.Copy(t.m_vertex3);
        var s = t.m_hasVertex0
            , r = t.m_hasVertex3
            , b = box2d.b2SubVV(this.m_v2, this.m_v1, box2d.b2EPCollider.s_edge1);
        b.Normalize(),
            this.m_normal1.SetXY(b.y, -b.x);
        var a = box2d.b2DotVV(this.m_normal1, box2d.b2SubVV(this.m_centroidB, this.m_v1, box2d.b2Vec2.s_t0))
            , d = 0
            , l = 0
            , x = !1
            , p = !1;
        if (s) {
            var m = box2d.b2SubVV(this.m_v1, this.m_v0, box2d.b2EPCollider.s_edge0);
            m.Normalize(),
                this.m_normal0.SetXY(m.y, -m.x),
                x = box2d.b2CrossVV(m, b) >= 0,
                d = box2d.b2DotVV(this.m_normal0, box2d.b2SubVV(this.m_centroidB, this.m_v0, box2d.b2Vec2.s_t0))
        }
        if (r) {
            var h = box2d.b2SubVV(this.m_v3, this.m_v2, box2d.b2EPCollider.s_edge2);
            h.Normalize(),
                this.m_normal2.SetXY(h.y, -h.x),
                p = box2d.b2CrossVV(b, h) > 0,
                l = box2d.b2DotVV(this.m_normal2, box2d.b2SubVV(this.m_centroidB, this.m_v2, box2d.b2Vec2.s_t0))
        }
        s && r ? x && p ? (this.m_front = d >= 0 || a >= 0 || l >= 0,
            this.m_front ? (this.m_normal.Copy(this.m_normal1),
                this.m_lowerLimit.Copy(this.m_normal0),
                this.m_upperLimit.Copy(this.m_normal2)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
                    this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
                    this.m_upperLimit.Copy(this.m_normal1).SelfNeg())) : x ? (this.m_front = d >= 0 || a >= 0 && l >= 0,
                        this.m_front ? (this.m_normal.Copy(this.m_normal1),
                            this.m_lowerLimit.Copy(this.m_normal0),
                            this.m_upperLimit.Copy(this.m_normal1)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
                                this.m_lowerLimit.Copy(this.m_normal2).SelfNeg(),
                                this.m_upperLimit.Copy(this.m_normal1).SelfNeg())) : p ? (this.m_front = l >= 0 || d >= 0 && a >= 0,
                                    this.m_front ? (this.m_normal.Copy(this.m_normal1),
                                        this.m_lowerLimit.Copy(this.m_normal1),
                                        this.m_upperLimit.Copy(this.m_normal2)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
                                            this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
                                            this.m_upperLimit.Copy(this.m_normal0).SelfNeg())) : (this.m_front = d >= 0 && a >= 0 && l >= 0,
                                                this.m_front ? (this.m_normal.Copy(this.m_normal1),
                                                    this.m_lowerLimit.Copy(this.m_normal1),
                                                    this.m_upperLimit.Copy(this.m_normal1)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
                                                        this.m_lowerLimit.Copy(this.m_normal2).SelfNeg(),
                                                        this.m_upperLimit.Copy(this.m_normal0).SelfNeg())) : s ? x ? (this.m_front = d >= 0 || a >= 0,
                                                            this.m_front ? (this.m_normal.Copy(this.m_normal1),
                                                                this.m_lowerLimit.Copy(this.m_normal0),
                                                                this.m_upperLimit.Copy(this.m_normal1).SelfNeg()) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
                                                                    this.m_lowerLimit.Copy(this.m_normal1),
                                                                    this.m_upperLimit.Copy(this.m_normal1).SelfNeg())) : (this.m_front = d >= 0 && a >= 0,
                                                                        this.m_front ? (this.m_normal.Copy(this.m_normal1),
                                                                            this.m_lowerLimit.Copy(this.m_normal1),
                                                                            this.m_upperLimit.Copy(this.m_normal1).SelfNeg()) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
                                                                                this.m_lowerLimit.Copy(this.m_normal1),
                                                                                this.m_upperLimit.Copy(this.m_normal0).SelfNeg())) : r ? p ? (this.m_front = a >= 0 || l >= 0,
                                                                                    this.m_front ? (this.m_normal.Copy(this.m_normal1),
                                                                                        this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
                                                                                        this.m_upperLimit.Copy(this.m_normal2)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
                                                                                            this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
                                                                                            this.m_upperLimit.Copy(this.m_normal1))) : (this.m_front = a >= 0 && l >= 0,
                                                                                                this.m_front ? (this.m_normal.Copy(this.m_normal1),
                                                                                                    this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
                                                                                                    this.m_upperLimit.Copy(this.m_normal1)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
                                                                                                        this.m_lowerLimit.Copy(this.m_normal2).SelfNeg(),
                                                                                                        this.m_upperLimit.Copy(this.m_normal1))) : (this.m_front = a >= 0,
                                                                                                            this.m_front ? (this.m_normal.Copy(this.m_normal1),
                                                                                                                this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),
                                                                                                                this.m_upperLimit.Copy(this.m_normal1).SelfNeg()) : (this.m_normal.Copy(this.m_normal1).SelfNeg(),
                                                                                                                    this.m_lowerLimit.Copy(this.m_normal1),
                                                                                                                    this.m_upperLimit.Copy(this.m_normal1))),
            this.m_polygonB.count = i.m_count;
        for (var _ = 0, c = i.m_count; _ < c; ++_)
            box2d.b2MulXV(this.m_xf, i.m_vertices[_], this.m_polygonB.vertices[_]),
                box2d.b2MulRV(this.m_xf.q, i.m_normals[_], this.m_polygonB.normals[_]);
        this.m_radius = 2 * box2d.b2_polygonRadius,
            o.pointCount = 0;
        var y = this.ComputeEdgeSeparation(box2d.b2EPCollider.s_edgeAxis);
        if (y.type !== box2d.b2EPAxisType.e_unknown && !(y.separation > this.m_radius)) {
            var u = this.ComputePolygonSeparation(box2d.b2EPCollider.s_polygonAxis);
            if (!(u.type !== box2d.b2EPAxisType.e_unknown && u.separation > this.m_radius)) {
                var g;
                g = u.type === box2d.b2EPAxisType.e_unknown ? y : u.separation > .98 * y.separation + .001 ? u : y;
                var f = box2d.b2EPCollider.s_ie
                    , S = box2d.b2EPCollider.s_rf;
                if (g.type === box2d.b2EPAxisType.e_edgeA) {
                    o.type = box2d.b2ManifoldType.e_faceA;
                    var A = 0
                        , C = box2d.b2DotVV(this.m_normal, this.m_polygonB.normals[0]);
                    for (_ = 1,
                        c = this.m_polygonB.count; _ < c; ++_) {
                        var v = box2d.b2DotVV(this.m_normal, this.m_polygonB.normals[_]);
                        v < C && (C = v,
                            A = _)
                    }
                    var V = A
                        , B = (V + 1) % this.m_polygonB.count;
                    (w = f[0]).v.Copy(this.m_polygonB.vertices[V]),
                        w.id.cf.indexA = 0,
                        w.id.cf.indexB = V,
                        w.id.cf.typeA = box2d.b2ContactFeatureType.e_face,
                        w.id.cf.typeB = box2d.b2ContactFeatureType.e_vertex,
                        (P = f[1]).v.Copy(this.m_polygonB.vertices[B]),
                        P.id.cf.indexA = 0,
                        P.id.cf.indexB = B,
                        P.id.cf.typeA = box2d.b2ContactFeatureType.e_face,
                        P.id.cf.typeB = box2d.b2ContactFeatureType.e_vertex,
                        this.m_front ? (S.i1 = 0,
                            S.i2 = 1,
                            S.v1.Copy(this.m_v1),
                            S.v2.Copy(this.m_v2),
                            S.normal.Copy(this.m_normal1)) : (S.i1 = 1,
                                S.i2 = 0,
                                S.v1.Copy(this.m_v2),
                                S.v2.Copy(this.m_v1),
                                S.normal.Copy(this.m_normal1).SelfNeg())
                } else {
                    var w, P;
                    o.type = box2d.b2ManifoldType.e_faceB,
                        (w = f[0]).v.Copy(this.m_v1),
                        w.id.cf.indexA = 0,
                        w.id.cf.indexB = g.index,
                        w.id.cf.typeA = box2d.b2ContactFeatureType.e_vertex,
                        w.id.cf.typeB = box2d.b2ContactFeatureType.e_face,
                        (P = f[1]).v.Copy(this.m_v2),
                        P.id.cf.indexA = 0,
                        P.id.cf.indexB = g.index,
                        P.id.cf.typeA = box2d.b2ContactFeatureType.e_vertex,
                        P.id.cf.typeB = box2d.b2ContactFeatureType.e_face,
                        S.i1 = g.index,
                        S.i2 = (S.i1 + 1) % this.m_polygonB.count,
                        S.v1.Copy(this.m_polygonB.vertices[S.i1]),
                        S.v2.Copy(this.m_polygonB.vertices[S.i2]),
                        S.normal.Copy(this.m_polygonB.normals[S.i1])
                }
                S.sideNormal1.SetXY(S.normal.y, -S.normal.x),
                    S.sideNormal2.Copy(S.sideNormal1).SelfNeg(),
                    S.sideOffset1 = box2d.b2DotVV(S.sideNormal1, S.v1),
                    S.sideOffset2 = box2d.b2DotVV(S.sideNormal2, S.v2);
                var M = box2d.b2EPCollider.s_clipPoints1
                    , D = box2d.b2EPCollider.s_clipPoints2;
                if (!(box2d.b2ClipSegmentToLine(M, f, S.sideNormal1, S.sideOffset1, S.i1) < box2d.b2_maxManifoldPoints || box2d.b2ClipSegmentToLine(D, M, S.sideNormal2, S.sideOffset2, S.i2) < box2d.b2_maxManifoldPoints)) {
                    g.type === box2d.b2EPAxisType.e_edgeA ? (o.localNormal.Copy(S.normal),
                        o.localPoint.Copy(S.v1)) : (o.localNormal.Copy(i.m_normals[S.i1]),
                            o.localPoint.Copy(i.m_vertices[S.i1]));
                    var J = 0;
                    for (_ = 0,
                        c = box2d.b2_maxManifoldPoints; _ < c; ++_) {
                        if (box2d.b2DotVV(S.normal, box2d.b2SubVV(D[_].v, S.v1, box2d.b2Vec2.s_t0)) <= this.m_radius) {
                            var T = o.points[J];
                            g.type === box2d.b2EPAxisType.e_edgeA ? (box2d.b2MulTXV(this.m_xf, D[_].v, T.localPoint),
                                T.id = D[_].id) : (T.localPoint.Copy(D[_].v),
                                    T.id.cf.typeA = D[_].id.cf.typeB,
                                    T.id.cf.typeB = D[_].id.cf.typeA,
                                    T.id.cf.indexA = D[_].id.cf.indexB,
                                    T.id.cf.indexB = D[_].id.cf.indexA),
                                ++J
                        }
                    }
                    o.pointCount = J
    ...
    box2d.b2EPCollider.prototype.ComputeEdgeSeparation = function (o) {
        var t = o;
        t.type = box2d.b2EPAxisType.e_edgeA,
            t.index = this.m_front ? 0 : 1,
            t.separation = box2d.b2_maxFloat;
        for (var e = 0, i = this.m_polygonB.count; e < i; ++e) {
            var n = box2d.b2DotVV(this.m_normal, box2d.b2SubVV(this.m_polygonB.vertices[e], this.m_v1, box2d.b2Vec2.s_t0));
            n < t.separation && (t.separation = n)
        }
        return t
    }
    ,
    box2d.b2EPCollider.prototype.ComputePolygonSeparation = function (o) {
        var t = o;
        t.type = box2d.b2EPAxisType.e_unknown,
            t.index = -1,
            t.separation = -box2d.b2_maxFloat;
        for (var e = box2d.b2EPCollider.s_perp.SetXY(-this.m_normal.y, this.m_normal.x), i = 0, n = this.m_polygonB.count; i < n; ++i) {
            var s = box2d.b2NegV(this.m_polygonB.normals[i], box2d.b2EPCollider.s_n)
                , r = box2d.b2DotVV(s, box2d.b2SubVV(this.m_polygonB.vertices[i], this.m_v1, box2d.b2Vec2.s_t0))
                , b = box2d.b2DotVV(s, box2d.b2SubVV(this.m_polygonB.vertices[i], this.m_v2, box2d.b2Vec2.s_t0))
                , a = box2d.b2Min(r, b);
            if (a > this.m_radius)
                return t.type = box2d.b2EPAxisType.e_edgeB,
                    t.index = i,
                    t.separation = a,
                    t;
            if (box2d.b2DotVV(s, e) >= 0) {
                if (box2d.b2DotVV(box2d.b2SubVV(s, this.m_upperLimit, box2d.b2Vec2.s_t0), this.m_normal) < -box2d.b2_angularSlop)
                    continue
            } else if (box2d.b2DotVV(box2d.b2SubVV(s, this.m_lowerLimit, box2d.b2Vec2.s_t0), this.m_normal) < -box2d.b2_angularSlop)
                continue;
            a > t.separation && (t.type = box2d.b2EPAxisType.e_edgeB,
                t.index = i,
                t.separation = a)
        }
        return t
    ...
    box2d.b2CollideEdgeAndPolygon = function (o, t, e, i, n) {
        box2d.b2CollideEdgeAndPolygon.s_collider.Collide(o, t, e, i, n)
    }
    ,
    ...
    box2d.b2EdgeShape = function () {
        goog.base(this, box2d.b2ShapeType.e_edgeShape, box2d.b2_polygonRadius),
    ...
    box2d.b2EdgeShape.prototype.Copy = function (o) {
        return goog.base(this, "Copy", o),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(o instanceof box2d.b2EdgeShape),
            this.m_vertex1.Copy(o.m_vertex1),
            this.m_vertex2.Copy(o.m_vertex2),
            this.m_vertex0.Copy(o.m_vertex0),
            this.m_vertex3.Copy(o.m_vertex3),
            this.m_hasVertex0 = o.m_hasVertex0,
            this.m_hasVertex3 = o.m_hasVertex3,
            this
    }
    ,
    ...
    ,
    box2d.b2EdgeShape.prototype.RayCast = function (o, t, e, i) {
        var n = box2d.b2MulTXV(e, t.p1, box2d.b2EdgeShape.prototype.RayCast.s_p1)
            , s = box2d.b2MulTXV(e, t.p2, box2d.b2EdgeShape.prototype.RayCast.s_p2)
            , r = box2d.b2SubVV(s, n, box2d.b2EdgeShape.prototype.RayCast.s_d)
            , b = this.m_vertex1
            , a = this.m_vertex2
            , d = box2d.b2SubVV(a, b, box2d.b2EdgeShape.prototype.RayCast.s_e)
            , l = o.normal.SetXY(d.y, -d.x).SelfNormalize()
            , x = box2d.b2DotVV(l, box2d.b2SubVV(b, n, box2d.b2Vec2.s_t0))
            , p = box2d.b2DotVV(l, r);
        if (0 === p)
            return !1;
        var m = x / p;
        if (m < 0 || t.maxFraction < m)
            return !1;
        var h = box2d.b2AddVMulSV(n, m, r, box2d.b2EdgeShape.prototype.RayCast.s_q)
            , _ = box2d.b2SubVV(a, b, box2d.b2EdgeShape.prototype.RayCast.s_r)
            , c = box2d.b2DotVV(_, _);
        if (0 === c)
            return !1;
        var y = box2d.b2DotVV(box2d.b2SubVV(h, b, box2d.b2Vec2.s_t0), _) / c;
        return !(y < 0 || 1 < y) && (o.fraction = m,
            box2d.b2MulRV(e.q, o.normal, o.normal),
            x > 0 && o.normal.SelfNeg(),
            !0)
    }
    ,
    ...
    box2d.b2EdgeShape.prototype.ComputeAABB = function (o, t, e) {
        var i = box2d.b2MulXV(t, this.m_vertex1, box2d.b2EdgeShape.prototype.ComputeAABB.s_v1)
            , n = box2d.b2MulXV(t, this.m_vertex2, box2d.b2EdgeShape.prototype.ComputeAABB.s_v2);
        box2d.b2MinV(i, n, o.lowerBound),
            box2d.b2MaxV(i, n, o.upperBound);
        var s = this.m_radius;
        o.lowerBound.SelfSubXY(s, s),
            o.upperBound.SelfAddXY(s, s)
    }
    ,
    ...
    box2d.b2EdgeShape.prototype.ComputeMass = function (o, t) {
        o.mass = 0,
            box2d.b2MidVV(this.m_vertex1, this.m_vertex2, o.center),
            o.I = 0
    }
    ,
    box2d.b2EdgeShape.prototype.SetupDistanceProxy = function (o, t) {
        o.m_vertices = new Array(2),
            o.m_vertices[0] = this.m_vertex1,
            o.m_vertices[1] = this.m_vertex2,
            o.m_count = 2,
            o.m_radius = this.m_radius
    }
    ,
    box2d.b2EdgeShape.prototype.ComputeSubmergedArea = function (o, t, e, i) {
        return i.SetZero(),
            0
    }
    ,
    ...
    box2d.b2ChainShape = function () {
        goog.base(this, box2d.b2ShapeType.e_chainShape, box2d.b2_polygonRadius),
    ...
    box2d.b2ChainShape.prototype.CreateLoop = function (o, t) {
        if (t = t || o.length,
            ...
            for (var e = 1; e < t; ++e) {
                var i = o[e - 1]
                    , n = o[e];
                box2d.b2Assert(box2d.b2DistanceSquaredVV(i, n) > box2d.b2_linearSlop * box2d.b2_linearSlop)
            }
        this.m_count = t + 1,
            this.m_vertices = box2d.b2Vec2.MakeArray(this.m_count);
        for (e = 0; e < t; ++e)
            this.m_vertices[e].Copy(o[e]);
        return this.m_vertices[t].Copy(this.m_vertices[0]),
    ...
    box2d.b2ChainShape.prototype.CreateChain = function (o, t) {
        if (t = t || o.length,
            box2d.ENABLE_ASSERTS && box2d.b2Assert(null === this.m_vertices && 0 === this.m_count),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(t >= 2),
            box2d.ENABLE_ASSERTS)
            for (var e = 1; e < t; ++e) {
                var i = o[e - 1]
                    , n = o[e];
        ...
        this.m_count = t,
            this.m_vertices = box2d.b2Vec2.MakeArray(t);
        for (e = 0; e < t; ++e)
            this.m_vertices[e].Copy(o[e]);
    ...
    box2d.b2ChainShape.prototype.SetPrevVertex = function (o) {
        return this.m_prevVertex.Copy(o),
            this.m_hasPrevVertex = !0,
            this
    }
    ,
    box2d.b2ChainShape.prototype.SetNextVertex = function (o) {
        return this.m_nextVertex.Copy(o),
            this.m_hasNextVertex = !0,
            this
    }
    ,
    ...
    box2d.b2ChainShape.prototype.Copy = function (o) {
        return goog.base(this, "Copy", o),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(o instanceof box2d.b2ChainShape),
            this.CreateChain(o.m_vertices, o.m_count),
            this.m_prevVertex.Copy(o.m_prevVertex),
            this.m_nextVertex.Copy(o.m_nextVertex),
            this.m_hasPrevVertex = o.m_hasPrevVertex,
            this.m_hasNextVertex = o.m_hasNextVertex,
            this
    }
    ,
    ...
    box2d.b2ChainShape.prototype.GetChildEdge = function (o, t) {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= t && t < this.m_count - 1),
            o.m_type = box2d.b2ShapeType.e_edgeShape,
            o.m_radius = this.m_radius,
            o.m_vertex1.Copy(this.m_vertices[t]),
            o.m_vertex2.Copy(this.m_vertices[t + 1]),
            t > 0 ? (o.m_vertex0.Copy(this.m_vertices[t - 1]),
                o.m_hasVertex0 = !0) : (o.m_vertex0.Copy(this.m_prevVertex),
                    o.m_hasVertex0 = this.m_hasPrevVertex),
            t < this.m_count - 2 ? (o.m_vertex3.Copy(this.m_vertices[t + 2]),
                o.m_hasVertex3 = !0) : (o.m_vertex3.Copy(this.m_nextVertex),
                    o.m_hasVertex3 = this.m_hasNextVertex)
    }
    ,
    ...
    ,
    box2d.b2ChainShape.prototype.RayCast = function (o, t, e, i) {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(i < this.m_count);
        var n = box2d.b2ChainShape.s_edgeShape;
        return n.m_vertex1.Copy(this.m_vertices[i]),
            n.m_vertex2.Copy(this.m_vertices[(i + 1) % this.m_count]),
            n.RayCast(o, t, e, 0)
    }
    ,
    box2d.b2ChainShape.s_edgeShape = new box2d.b2EdgeShape,
    box2d.b2ChainShape.prototype.ComputeAABB = function (o, t, e) {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(e < this.m_count);
        var i = this.m_vertices[e]
            , n = this.m_vertices[(e + 1) % this.m_count]
            , s = box2d.b2MulXV(t, i, box2d.b2ChainShape.prototype.ComputeAABB.s_v1)
            , r = box2d.b2MulXV(t, n, box2d.b2ChainShape.prototype.ComputeAABB.s_v2);
        box2d.b2MinV(s, r, o.lowerBound),
            box2d.b2MaxV(s, r, o.upperBound)
    }
    ,
    ...
    box2d.b2ChainShape.prototype.SetupDistanceProxy = function (o, t) {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= t && t < this.m_count),
            o.m_buffer[0].Copy(this.m_vertices[t]),
            t + 1 < this.m_count ? o.m_buffer[1].Copy(this.m_vertices[t + 1]) : o.m_buffer[1].Copy(this.m_vertices[0]),
            o.m_vertices = o.m_buffer,
            o.m_count = 2,
            o.m_radius = this.m_radius
    }
    ,
    box2d.b2ChainShape.prototype.ComputeSubmergedArea = function (o, t, e, i) {
        return i.SetZero(),
            0
    }
    ,
    ...
    ,
    box2d.b2ChainAndPolygonContact.Destroy = function (o, t) { }
    ,
    box2d.b2ChainAndPolygonContact.prototype.Reset = function (o, t, e, i) {
        goog.base(this, "Reset", o, t, e, i),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(o.GetType() === box2d.b2ShapeType.e_chainShape),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(e.GetType() === box2d.b2ShapeType.e_polygonShape)
    }
    ,
    box2d.b2ChainAndPolygonContact.prototype.Evaluate = function (o, t, e) {
        var i = this.m_fixtureA.GetShape()
            , n = this.m_fixtureB.GetShape();
        box2d.ENABLE_ASSERTS && box2d.b2Assert(i instanceof box2d.b2ChainShape),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(n instanceof box2d.b2PolygonShape);
        var s = i instanceof box2d.b2ChainShape ? i : null
            , r = box2d.b2ChainAndPolygonContact.prototype.Evaluate.s_edge;
        s.GetChildEdge(r, this.m_indexA),
            box2d.b2CollideEdgeAndPolygon(o, r, t, n instanceof box2d.b2PolygonShape ? n : null, e)
    }
    ,
    box2d.b2ChainAndPolygonContact.prototype.Evaluate.s_edge = new box2d.b2EdgeShape,
    goog.provide("box2d.b2CollidePolygon"),
    goog.require("box2d.b2Collision"),
    box2d.b2FindMaxSeparation = function (o, t, e, i, n) {
        for (var s = t.m_count, r = i.m_count, b = t.m_normals, a = t.m_vertices, d = i.m_vertices, l = box2d.b2MulTXX(n, e, box2d.b2FindMaxSeparation.s_xf), x = 0, p = -box2d.b2_maxFloat, m = 0; m < s; ++m) {
            for (var h = box2d.b2MulRV(l.q, b[m], box2d.b2FindMaxSeparation.s_n), _ = box2d.b2MulXV(l, a[m], box2d.b2FindMaxSeparation.s_v1), c = box2d.b2_maxFloat, y = 0; y < r; ++y) {
                var u = box2d.b2DotVV(h, box2d.b2SubVV(d[y], _, box2d.b2Vec2.s_t0));
                u < c && (c = u)
            }
            c > p && (p = c,
                x = m)
    ...
    box2d.b2FindIncidentEdge = function (o, t, e, i, n, s) {
        var r = t.m_count
            , b = t.m_normals
            , a = n.m_count
            , d = n.m_vertices
            , l = n.m_normals;
        box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= i && i < r);
        for (var x = box2d.b2MulTRV(s.q, box2d.b2MulRV(e.q, b[i], box2d.b2Vec2.s_t0), box2d.b2FindIncidentEdge.s_normal1), p = 0, m = box2d.b2_maxFloat, h = 0; h < a; ++h) {
            var _ = box2d.b2DotVV(x, l[h]);
            _ < m && (m = _,
                p = h)
        }
        var c = p
            , y = (c + 1) % a
            , u = o[0];
        box2d.b2MulXV(s, d[c], u.v);
        var g = u.id.cf;
        g.indexA = i,
            g.indexB = c,
            g.typeA = box2d.b2ContactFeatureType.e_face,
            g.typeB = box2d.b2ContactFeatureType.e_vertex;
        var f = o[1];
        box2d.b2MulXV(s, d[y], f.v);
        var S = f.id.cf;
        S.indexA = i,
            S.indexB = y,
            S.typeA = box2d.b2ContactFeatureType.e_face,
            S.typeB = box2d.b2ContactFeatureType.e_vertex
    }
    ,
    box2d.b2FindIncidentEdge.s_normal1 = new box2d.b2Vec2,
    box2d.b2CollidePolygons = function (o, t, e, i, n) {
        o.pointCount = 0;
        var s = t.m_radius + i.m_radius
            , r = box2d.b2CollidePolygons.s_edgeA;
        r[0] = 0;
        var b = box2d.b2FindMaxSeparation(r, t, e, i, n);
        if (!(b > s)) {
            var a = box2d.b2CollidePolygons.s_edgeB;
            a[0] = 0;
            var d = box2d.b2FindMaxSeparation(a, i, n, t, e);
            if (!(d > s)) {
                var l, x, p, m, h = 0, _ = 0;
                d > .98 * b + .001 ? (l = i,
                    x = t,
                    ...
                    _ = 1) : (l = t,
                        ...
                        o.type = box2d.b2ManifoldType.e_faceA,
                        _ = 0);
                var c = box2d.b2CollidePolygons.s_incidentEdge;
                box2d.b2FindIncidentEdge(c, l, p, h, x, m);
                var y = l.m_count
                    , u = l.m_vertices
                    , g = h
                    , f = (h + 1) % y
                    , S = u[g]
                    , A = u[f]
                    , C = box2d.b2SubVV(A, S, box2d.b2CollidePolygons.s_localTangent);
                C.Normalize();
                var v = box2d.b2CrossVOne(C, box2d.b2CollidePolygons.s_localNormal)
                    , V = box2d.b2MidVV(S, A, box2d.b2CollidePolygons.s_planePoint)
                    , B = box2d.b2MulRV(p.q, C, box2d.b2CollidePolygons.s_tangent)
                    , w = box2d.b2CrossVOne(B, box2d.b2CollidePolygons.s_normal)
                    , P = box2d.b2MulXV(p, S, box2d.b2CollidePolygons.s_v11)
                    , M = box2d.b2MulXV(p, A, box2d.b2CollidePolygons.s_v12)
                    , D = box2d.b2DotVV(w, P)
                    , J = -box2d.b2DotVV(B, P) + s
                    , T = box2d.b2DotVV(B, M) + s
                    , R = box2d.b2CollidePolygons.s_clipPoints1
                    , I = box2d.b2CollidePolygons.s_clipPoints2
                    , L = box2d.b2NegV(B, box2d.b2CollidePolygons.s_ntangent);
                if (!(box2d.b2ClipSegmentToLine(R, c, L, J, g) < 2 || box2d.b2ClipSegmentToLine(I, R, B, T, f) < 2)) {
                    o.localNormal.Copy(v),
                        o.localPoint.Copy(V);
                    for (var E = 0, F = 0; F < box2d.b2_maxManifoldPoints; ++F) {
                        var G = I[F];
                        if (box2d.b2DotVV(w, G.v) - D <= s) {
                            var k = o.points[E];
                            if (box2d.b2MulTXV(m, G.v, k.localPoint),
                                k.id.Copy(G.id),
                                _) {
                                var q = k.id.cf;
                                k.id.cf.indexA = q.indexB,
                                    k.id.cf.indexB = q.indexA,
                                    k.id.cf.typeA = q.typeB,
                                    k.id.cf.typeB = q.typeA
                            }
                            ++E
                        }
                    }
    ...
    ,
    box2d.b2PolygonContact.Destroy = function (o, t) { }
    ,
    box2d.b2PolygonContact.prototype.Reset = function (o, t, e, i) {
        goog.base(this, "Reset", o, t, e, i)
    }
    ,
    box2d.b2PolygonContact.prototype.Evaluate = function (o, t, e) {
        ...
        box2d.ENABLE_ASSERTS && box2d.b2Assert(i instanceof box2d.b2PolygonShape),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(n instanceof box2d.b2PolygonShape),
            box2d.b2CollidePolygons(o, i instanceof box2d.b2PolygonShape ? i : null, t, n instanceof box2d.b2PolygonShape ? n : null, e)
    }
    ,
    goog.provide("box2d.b2CollideCircle"),
    goog.require("box2d.b2Collision"),
    box2d.b2CollideCircles = function (o, t, e, i, n) {
        o.pointCount = 0;
        var s = box2d.b2MulXV(e, t.m_p, box2d.b2CollideCircles.s_pA)
            , r = box2d.b2MulXV(n, i.m_p, box2d.b2CollideCircles.s_pB)
            , b = box2d.b2DistanceSquaredVV(s, r)
            , a = t.m_radius + i.m_radius;
        b > a * a || (o.type = box2d.b2ManifoldType.e_circles,
            o.localPoint.Copy(t.m_p),
            o.localNormal.SetZero(),
            o.pointCount = 1,
            o.points[0].localPoint.Copy(i.m_p),
            o.points[0].id.key = 0)
    ...
    box2d.b2CollidePolygonAndCircle = function (o, t, e, i, n) {
        o.pointCount = 0;
        for (var s = box2d.b2MulXV(n, i.m_p, box2d.b2CollidePolygonAndCircle.s_c), r = box2d.b2MulTXV(e, s, box2d.b2CollidePolygonAndCircle.s_cLocal), b = 0, a = -box2d.b2_maxFloat, d = t.m_radius + i.m_radius, l = t.m_count, x = t.m_vertices, p = t.m_normals, m = 0; m < l; ++m) {
            var h = box2d.b2DotVV(p[m], box2d.b2SubVV(r, x[m], box2d.b2Vec2.s_t0));
            if (h > d)
                return;
            h > a && (a = h,
                b = m)
        ...
        var _ = b
            ...
            , u = x[c];
        if (a < box2d.b2_epsilon)
            return o.pointCount = 1,
                o.type = box2d.b2ManifoldType.e_faceA,
                o.localNormal.Copy(p[b]),
                box2d.b2MidVV(y, u, o.localPoint),
                o.points[0].localPoint.Copy(i.m_p),
                void (o.points[0].id.key = 0);
        var g = box2d.b2DotVV(box2d.b2SubVV(r, y, box2d.b2Vec2.s_t0), box2d.b2SubVV(u, y, box2d.b2Vec2.s_t1))
            , f = box2d.b2DotVV(box2d.b2SubVV(r, u, box2d.b2Vec2.s_t0), box2d.b2SubVV(y, u, box2d.b2Vec2.s_t1));
        if (g <= 0) {
            if (box2d.b2DistanceSquaredVV(r, y) > d * d)
                return;
            o.pointCount = 1,
                o.type = box2d.b2ManifoldType.e_faceA,
                box2d.b2SubVV(r, y, o.localNormal).SelfNormalize(),
                o.localPoint.Copy(y),
                o.points[0].localPoint.Copy(i.m_p),
                o.points[0].id.key = 0
        } else if (f <= 0) {
            if (box2d.b2DistanceSquaredVV(r, u) > d * d)
                return;
            o.pointCount = 1,
                o.type = box2d.b2ManifoldType.e_faceA,
                box2d.b2SubVV(r, u, o.localNormal).SelfNormalize(),
                o.localPoint.Copy(u),
                o.points[0].localPoint.Copy(i.m_p),
                o.points[0].id.key = 0
        } else {
            var S = box2d.b2MidVV(y, u, box2d.b2CollidePolygonAndCircle.s_faceCenter);
            if ((a = box2d.b2DotVV(box2d.b2SubVV(r, S, box2d.b2Vec2.s_t1), p[_])) > d)
                return;
            o.pointCount = 1,
                o.type = box2d.b2ManifoldType.e_faceA,
                o.localNormal.Copy(p[_]).SelfNormalize(),
                o.localPoint.Copy(S),
                o.points[0].localPoint.Copy(i.m_p),
                o.points[0].id.key = 0
        }
    ...
    ,
    box2d.b2CircleContact.Destroy = function (o, t) { }
    ,
    box2d.b2CircleContact.prototype.Reset = function (o, t, e, i) {
        goog.base(this, "Reset", o, t, e, i)
    }
    ,
    box2d.b2CircleContact.prototype.Evaluate = function (o, t, e) {
        var i = this.m_fixtureA.GetShape()
            , n = this.m_fixtureB.GetShape();
        box2d.ENABLE_ASSERTS && box2d.b2Assert(i instanceof box2d.b2CircleShape),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(n instanceof box2d.b2CircleShape),
            box2d.b2CollideCircles(o, i instanceof box2d.b2CircleShape ? i : null, t, n instanceof box2d.b2CircleShape ? n : null, e)
    }
    ,
    ...
    ,
    box2d.b2ChainAndCircleContact.Destroy = function (o, t) { }
    ,
    box2d.b2ChainAndCircleContact.prototype.Reset = function (o, t, e, i) {
        goog.base(this, "Reset", o, t, e, i),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(o.GetType() === box2d.b2ShapeType.e_chainShape),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(e.GetType() === box2d.b2ShapeType.e_circleShape)
    }
    ...
    box2d.b2ChainAndCircleContact.prototype.Evaluate = function (o, t, e) {
        ...
        s.GetChildEdge(r, this.m_indexA),
            box2d.b2CollideEdgeAndCircle(o, r, t, n instanceof box2d.b2CircleShape ? n : null, e)
    }
    ,
    ...
    ,
    box2d.b2EdgeAndCircleContact.Destroy = function (o, t) { }
    ,
    box2d.b2EdgeAndCircleContact.prototype.Reset = function (o, t, e, i) {
        goog.base(this, "Reset", o, t, e, i),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(o.GetType() === box2d.b2ShapeType.e_edgeShape),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(e.GetType() === box2d.b2ShapeType.e_circleShape)
    }
    ...
    box2d.b2EdgeAndCircleContact.prototype.Evaluate = function (o, t, e) {
        ...
        box2d.ENABLE_ASSERTS && box2d.b2Assert(i instanceof box2d.b2EdgeShape),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(n instanceof box2d.b2CircleShape),
            box2d.b2CollideEdgeAndCircle(o, i instanceof box2d.b2EdgeShape ? i : null, t, n instanceof box2d.b2CircleShape ? n : null, e)
    }
    ,
    ...
    box2d.b2ContactSolver.prototype.Initialize = function (o) {
        if (this.m_step.Copy(o.step),
            this.m_allocator = o.allocator,
            this.m_count = o.count,
            this.m_positionConstraints.length < this.m_count) {
            var t = box2d.b2Max(2 * this.m_positionConstraints.length, this.m_count);
            for (box2d.DEBUG && window.console.log("box2d.b2ContactSolver.m_positionConstraints: " + t); this.m_positionConstraints.length < t;)
                this.m_positionConstraints[this.m_positionConstraints.length] = new box2d.b2ContactPositionConstraint
        }
        if (this.m_velocityConstraints.length < this.m_count) {
            t = box2d.b2Max(2 * this.m_velocityConstraints.length, this.m_count);
            for (box2d.DEBUG && window.console.log("box2d.b2ContactSolver.m_velocityConstraints: " + t); this.m_velocityConstraints.length < t;)
                this.m_velocityConstraints[this.m_velocityConstraints.length] = new box2d.b2ContactVelocityConstraint
        }
        var e, i, n, s, r, b, a, d, l, x, p, m, h, _, c, y, u, g, f;
        for (this.m_positions = o.positions,
            this.m_velocities = o.velocities,
            this.m_contacts = o.contacts,
            e = 0,
            i = this.m_count; e < i; ++e)
            for (b = (r = this.m_contacts[e]).m_fixtureA,
                a = r.m_fixtureB,
                d = b.GetShape(),
                l = a.GetShape(),
                x = d.m_radius,
                ...
                m = b.GetBody(),
                h = a.GetBody(),
                c = (_ = r.GetManifold()).pointCount,
                box2d.ENABLE_ASSERTS && box2d.b2Assert(c > 0),
                (y = this.m_velocityConstraints[e]).friction = r.m_friction,
                y.restitution = r.m_restitution,
                y.tangentSpeed = r.m_tangentSpeed,
                y.indexA = m.m_islandIndex,
                y.indexB = h.m_islandIndex,
                y.invMassA = m.m_invMass,
                y.invMassB = h.m_invMass,
                y.invIA = m.m_invI,
                y.invIB = h.m_invI,
                y.contactIndex = e,
                y.pointCount = c,
                y.K.SetZero(),
                y.normalMass.SetZero(),
                (u = this.m_positionConstraints[e]).indexA = m.m_islandIndex,
                u.indexB = h.m_islandIndex,
                u.invMassA = m.m_invMass,
                u.invMassB = h.m_invMass,
                u.localCenterA.Copy(m.m_sweep.localCenter),
                u.localCenterB.Copy(h.m_sweep.localCenter),
                u.invIA = m.m_invI,
                u.invIB = h.m_invI,
                u.localNormal.Copy(_.localNormal),
                u.localPoint.Copy(_.localPoint),
                u.pointCount = c,
                u.radiusA = x,
                u.radiusB = p,
                u.type = _.type,
                ...
                g = _.points[n],
                    f = y.points[n],
                    this.m_step.warmStarting ? (f.normalImpulse = this.m_step.dtRatio * g.normalImpulse,
                        f.tangentImpulse = this.m_step.dtRatio * g.tangentImpulse) : (f.normalImpulse = 0,
                            f.tangentImpulse = 0),
                    f.rA.SetZero(),
                    f.rB.SetZero(),
                    f.normalMass = 0,
                    f.tangentMass = 0,
                    f.velocityBias = 0,
                    u.localPoints[n].Copy(g.localPoint);
        return this
    }
    ,
    box2d.b2ContactSolver.prototype.InitializeVelocityConstraints = function () {
        var o, t, e, i, n, s, r, b, a, d, l, x, p, m, h, _, c, y, u, g, f, S, A, C, v, V, B, w, P, M, D, J, T, R, I, L, E, F, G, k, q, N, O, W = box2d.b2ContactSolver.prototype.InitializeVelocityConstraints.s_xfA, z = box2d.b2ContactSolver.prototype.InitializeVelocityConstraints.s_xfB, j = box2d.b2ContactSolver.prototype.InitializeVelocityConstraints.s_worldManifold;
        for (o = 0,
            t = this.m_count; o < t; ++o) {
            for (n = this.m_velocityConstraints[o],
                r = (s = this.m_positionConstraints[o]).radiusA,
                b = s.radiusB,
                a = this.m_contacts[n.contactIndex].GetManifold(),
                d = n.indexA,
                l = n.indexB,
                x = n.invMassA,
                p = n.invMassB,
                ...
                _ = s.localCenterA,
                c = s.localCenterB,
                y = this.m_positions[d].c,
                u = this.m_positions[d].a,
                g = this.m_velocities[d].v,
                f = this.m_velocities[d].w,
                S = this.m_positions[l].c,
                A = this.m_positions[l].a,
                C = this.m_velocities[l].v,
                v = this.m_velocities[l].w,
                box2d.ENABLE_ASSERTS && box2d.b2Assert(a.pointCount > 0),
                W.q.SetAngleRadians(u),
                z.q.SetAngleRadians(A),
                box2d.b2SubVV(y, box2d.b2MulRV(W.q, _, box2d.b2Vec2.s_t0), W.p),
                box2d.b2SubVV(S, box2d.b2MulRV(z.q, c, box2d.b2Vec2.s_t0), z.p),
                j.Initialize(a, W, r, z, b),
                n.normal.Copy(j.normal),
                box2d.b2CrossVOne(n.normal, n.tangent),
                e = 0,
                i = n.pointCount; e < i; ++e)
                V = n.points[e],
                    box2d.b2SubVV(j.points[e], y, V.rA),
                    box2d.b2SubVV(j.points[e], S, V.rB),
                    P = x + p + m * (B = box2d.b2CrossVV(V.rA, n.normal)) * B + h * (w = box2d.b2CrossVV(V.rB, n.normal)) * w,
                    V.normalMass = P > 0 ? 1 / P : 0,
                    M = n.tangent,
                    T = x + p + m * (D = box2d.b2CrossVV(V.rA, M)) * D + h * (J = box2d.b2CrossVV(V.rB, M)) * J,
                    V.tangentMass = T > 0 ? 1 / T : 0,
                    V.velocityBias = 0,
                    (R = box2d.b2DotVV(n.normal, box2d.b2SubVV(box2d.b2AddVCrossSV(C, v, V.rB, box2d.b2Vec2.s_t0), box2d.b2AddVCrossSV(g, f, V.rA, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0))) < -box2d.b2_velocityThreshold && (V.velocityBias += -n.restitution * R);
            2 === n.pointCount && (I = n.points[0],
                L = n.points[1],
                (q = x + p + m * (E = box2d.b2CrossVV(I.rA, n.normal)) * E + h * (F = box2d.b2CrossVV(I.rB, n.normal)) * F) * q < 1e3 * (q * (N = x + p + m * (G = box2d.b2CrossVV(L.rA, n.normal)) * G + h * (k = box2d.b2CrossVV(L.rB, n.normal)) * k) - (O = x + p + m * E * G + h * F * k) * O) ? (n.K.ex.SetXY(q, O),
                    n.K.ey.SetXY(O, N),
                    n.K.GetInverse(n.normalMass)) : n.pointCount = 1)
        }
    }
    ,
    ...
    box2d.b2ContactSolver.prototype.WarmStart = function () {
        var o, t, e, i, n, s, r, b, a, d, l, x, p, m, h, _, c, y, u, g = box2d.b2ContactSolver.prototype.WarmStart.s_P;
        for (o = 0,
            t = this.m_count; o < t; ++o) {
            for (s = (n = this.m_velocityConstraints[o]).indexA,
                r = n.indexB,
                b = n.invMassA,
                a = n.invIA,
                d = n.invMassB,
                l = n.invIB,
                x = n.pointCount,
                p = this.m_velocities[s].v,
                m = this.m_velocities[s].w,
                h = this.m_velocities[r].v,
                ...
                i = x; e < i; ++e)
                u = n.points[e],
                    box2d.b2AddVV(box2d.b2MulSV(u.normalImpulse, c, box2d.b2Vec2.s_t0), box2d.b2MulSV(u.tangentImpulse, y, box2d.b2Vec2.s_t1), g),
                    m -= a * box2d.b2CrossVV(u.rA, g),
                    p.SelfMulSub(b, g),
                    _ += l * box2d.b2CrossVV(u.rB, g),
                    h.SelfMulAdd(d, g);
    ...
    box2d.b2ContactSolver.prototype.SolveVelocityConstraints = function () {
        var o, t, e, i, n, s, r, b, a, d, l, x, p, m, h, _, c, y, u, g, f, S, A, C, v, V, B, w, P, M = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv, D = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv1, J = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv2, T = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P, R = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_a, I = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_b, L = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_x, E = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_d, F = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P1, G = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P2, k = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P1P2;
        for (o = 0,
            t = this.m_count; o < t; ++o) {
            for (s = (n = this.m_velocityConstraints[o]).indexA,
                r = n.indexB,
                ...
                y = n.tangent,
                u = n.friction,
                box2d.ENABLE_ASSERTS && box2d.b2Assert(1 === x || 2 === x),
                e = 0,
                i = x; e < i; ++e)
                g = n.points[e],
                    box2d.b2SubVV(box2d.b2AddVCrossSV(h, _, g.rB, box2d.b2Vec2.s_t0), box2d.b2AddVCrossSV(p, m, g.rA, box2d.b2Vec2.s_t1), M),
                    f = box2d.b2DotVV(M, y) - n.tangentSpeed,
                    A = g.tangentMass * -f,
                    C = u * g.normalImpulse,
                    A = (v = box2d.b2Clamp(g.tangentImpulse + A, -C, C)) - g.tangentImpulse,
                    g.tangentImpulse = v,
                    box2d.b2MulSV(A, y, T),
                    p.SelfMulSub(b, T),
                    m -= a * box2d.b2CrossVV(g.rA, T),
                    h.SelfMulAdd(d, T),
                    _ += l * box2d.b2CrossVV(g.rB, T);
            if (1 === n.pointCount)
                g = n.points[0],
                    box2d.b2SubVV(box2d.b2AddVCrossSV(h, _, g.rB, box2d.b2Vec2.s_t0), box2d.b2AddVCrossSV(p, m, g.rA, box2d.b2Vec2.s_t1), M),
                    S = box2d.b2DotVV(M, c),
                    A = -g.normalMass * (S - g.velocityBias),
                    A = (v = box2d.b2Max(g.normalImpulse + A, 0)) - g.normalImpulse,
                    g.normalImpulse = v,
                    box2d.b2MulSV(A, c, T),
                    p.SelfMulSub(b, T),
                    m -= a * box2d.b2CrossVV(g.rA, T),
                ...
                for (V = n.points[0],
                    B = n.points[1],
                    R.SetXY(V.normalImpulse, B.normalImpulse),
                    box2d.ENABLE_ASSERTS && box2d.b2Assert(R.x >= 0 && R.y >= 0),
                    box2d.b2SubVV(box2d.b2AddVCrossSV(h, _, V.rB, box2d.b2Vec2.s_t0), box2d.b2AddVCrossSV(p, m, V.rA, box2d.b2Vec2.s_t1), D),
                    box2d.b2SubVV(box2d.b2AddVCrossSV(h, _, B.rB, box2d.b2Vec2.s_t0), box2d.b2AddVCrossSV(p, m, B.rA, box2d.b2Vec2.s_t1), J),
                    w = box2d.b2DotVV(D, c),
                    P = box2d.b2DotVV(J, c),
                    I.x = w - V.velocityBias,
                    I.y = P - B.velocityBias,
                    I.SelfSub(box2d.b2MulMV(n.K, R, box2d.b2Vec2.s_t0)); ;) {
                    if (box2d.b2MulMV(n.normalMass, I, L).SelfNeg(),
                        L.x >= 0 && L.y >= 0) {
                        box2d.b2SubVV(L, R, E),
                            box2d.b2MulSV(E.x, c, F),
                            box2d.b2MulSV(E.y, c, G),
                            box2d.b2AddVV(F, G, k),
                            p.SelfMulSub(b, k),
                            m -= a * (box2d.b2CrossVV(V.rA, F) + box2d.b2CrossVV(B.rA, G)),
                            h.SelfMulAdd(d, k),
                            _ += l * (box2d.b2CrossVV(V.rB, F) + box2d.b2CrossVV(B.rB, G)),
                            V.normalImpulse = L.x,
                            B.normalImpulse = L.y;
                        break
                    }
                    if (L.x = -V.normalMass * I.x,
                        L.y = 0,
                        w = 0,
                        P = n.K.ex.y * L.x + I.y,
                        L.x >= 0 && P >= 0) {
    ...
    box2d.b2ContactSolver.prototype.StoreImpulses = function () {
        ...
        for (o = 0,
            t = this.m_count; o < t; ++o)
            for (n = this.m_velocityConstraints[o],
                s = this.m_contacts[n.contactIndex].GetManifold(),
                e = 0,
                i = n.pointCount; e < i; ++e)
                s.points[e].normalImpulse = n.points[e].normalImpulse,
                    s.points[e].tangentImpulse = n.points[e].tangentImpulse
    }
    ,
    ...
    box2d.b2PositionSolverManifold.prototype.Initialize = function (o, t, e, i) {
        var n = box2d.b2PositionSolverManifold.prototype.Initialize.s_pointA
            ...
            , b = box2d.b2PositionSolverManifold.prototype.Initialize.s_clipPoint;
        switch (box2d.ENABLE_ASSERTS && box2d.b2Assert(o.pointCount > 0),
        o.type) {
            case box2d.b2ManifoldType.e_circles:
                box2d.b2MulXV(t, o.localPoint, n),
                    box2d.b2MulXV(e, o.localPoints[0], s),
                    box2d.b2SubVV(s, n, this.normal).SelfNormalize(),
                    box2d.b2MidVV(n, s, this.point),
                    this.separation = box2d.b2DotVV(box2d.b2SubVV(s, n, box2d.b2Vec2.s_t0), this.normal) - o.radiusA - o.radiusB;
                break;
            case box2d.b2ManifoldType.e_faceA:
                box2d.b2MulRV(t.q, o.localNormal, this.normal),
                    box2d.b2MulXV(t, o.localPoint, r),
                    box2d.b2MulXV(e, o.localPoints[i], b),
                    this.separation = box2d.b2DotVV(box2d.b2SubVV(b, r, box2d.b2Vec2.s_t0), this.normal) - o.radiusA - o.radiusB,
                    this.point.Copy(b);
                break;
            case box2d.b2ManifoldType.e_faceB:
                box2d.b2MulRV(e.q, o.localNormal, this.normal),
                    box2d.b2MulXV(e, o.localPoint, r),
                    box2d.b2MulXV(t, o.localPoints[i], b),
                    this.separation = box2d.b2DotVV(box2d.b2SubVV(b, r, box2d.b2Vec2.s_t0), this.normal) - o.radiusA - o.radiusB,
                    this.point.Copy(b),
                    this.normal.SelfNeg()
        }
    ...
    box2d.b2ContactSolver.prototype.SolvePositionConstraints = function () {
        var o, t, e, i, n, s, r, b, a, d, l, x, p, m, h, _, c, y, u, g, f, S, A, C, v, V, B = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_xfA, w = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_xfB, P = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_psm, M = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_rA, D = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_rB, J = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_P, T = 0;
        for (o = 0,
            t = this.m_count; o < t; ++o) {
            for (s = (n = this.m_positionConstraints[o]).indexA,
                r = n.indexB,
                b = n.localCenterA,
                a = n.invMassA,
                d = n.invIA,
                ...
                p = n.invIB,
                m = n.pointCount,
                h = this.m_positions[s].c,
                _ = this.m_positions[s].a,
                c = this.m_positions[r].c,
                y = this.m_positions[r].a,
                e = 0,
                i = m; e < i; ++e)
                B.q.SetAngleRadians(_),
                    w.q.SetAngleRadians(y),
                    box2d.b2SubVV(h, box2d.b2MulRV(B.q, b, box2d.b2Vec2.s_t0), B.p),
                    box2d.b2SubVV(c, box2d.b2MulRV(w.q, l, box2d.b2Vec2.s_t0), w.p),
                    P.Initialize(n, B, w, e),
                    u = P.normal,
                    g = P.point,
                    f = P.separation,
                    box2d.b2SubVV(g, h, M),
                    box2d.b2SubVV(g, c, D),
                    T = box2d.b2Min(T, f),
                    S = box2d.b2Clamp(box2d.b2_baumgarte * (f + box2d.b2_linearSlop), -box2d.b2_maxLinearCorrection, 0),
                    V = (v = a + x + d * (A = box2d.b2CrossVV(M, u)) * A + p * (C = box2d.b2CrossVV(D, u)) * C) > 0 ? -S / v : 0,
                    box2d.b2MulSV(V, u, J),
                    h.SelfMulSub(a, J),
                    _ -= d * box2d.b2CrossVV(M, J),
                    c.SelfMulAdd(x, J),
                    y += p * box2d.b2CrossVV(D, J);
            this.m_positions[s].a = _,
                this.m_positions[r].a = y
        }
        return T > -3 * box2d.b2_linearSlop
    }
    ,
    ...
    box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints = function (o, t) {
        ...
        for (e = 0,
            ...
            for (b = (r = this.m_positionConstraints[e]).indexA,
                ...
                p = 0,
                m = 0,
                b !== o && b !== t || (p = r.invMassA,
                    m = r.invIA),
                h = 0,
                _ = 0,
                a !== o && a !== t || (h = r.invMassB,
                    _ = r.invIB),
                c = this.m_positions[b].c,
                y = this.m_positions[b].a,
                u = this.m_positions[a].c,
                g = this.m_positions[a].a,
                n = 0,
                s = x; n < s; ++n)
                P.q.SetAngleRadians(y),
                    M.q.SetAngleRadians(g),
                    box2d.b2SubVV(c, box2d.b2MulRV(P.q, d, box2d.b2Vec2.s_t0), P.p),
                    box2d.b2SubVV(u, box2d.b2MulRV(M.q, l, box2d.b2Vec2.s_t0), M.p),
                    D.Initialize(r, P, M, n),
                    f = D.normal,
                    S = D.point,
                    A = D.separation,
                    box2d.b2SubVV(S, c, J),
                    box2d.b2SubVV(S, u, T),
                    I = box2d.b2Min(I, A),
                    C = box2d.b2Clamp(box2d.b2_toiBaumgarte * (A + box2d.b2_linearSlop), -box2d.b2_maxLinearCorrection, 0),
                    w = (B = p + h + m * (v = box2d.b2CrossVV(J, f)) * v + _ * (V = box2d.b2CrossVV(T, f)) * V) > 0 ? -C / B : 0,
                    box2d.b2MulSV(w, f, R),
                    c.SelfMulSub(p, R),
                    y -= m * box2d.b2CrossVV(J, R),
                    u.SelfMulAdd(h, R),
                    g += _ * box2d.b2CrossVV(T, R);
            this.m_positions[b].a = y,
                this.m_positions[a].a = g
        }
    ...
    ,
    box2d.b2DestructionListener.prototype.SayGoodbyeJoint = function (o) { }
    ,
    box2d.b2DestructionListener.prototype.SayGoodbyeFixture = function (o) { }
    ,
    box2d.b2ContactFilter = function () { }
    ,
    box2d.b2ContactFilter.prototype.ShouldCollide = function (o, t) {
        var e = o.GetFilterData()
            , i = t.GetFilterData();
        return e.groupIndex === i.groupIndex && 0 !== e.groupIndex ? e.groupIndex > 0 : 0 != (e.maskBits & i.categoryBits) && 0 != (e.categoryBits & i.maskBits)
    }
    ,
    ...
    ;
box2d.b2ContactListener.prototype.BeginContact = function (o) { }
    ,
    box2d.b2ContactListener.prototype.EndContact = function (o) { }
    ,
    box2d.b2ContactListener.prototype.PreSolve = function (o, t) { }
    ,
    box2d.b2ContactListener.prototype.PostSolve = function (o, t) { }
    ,
    ...
    ,
    box2d.b2RayCastCallback.prototype.ReportFixture = function (o, t, e, i) {
        return i
    }
    ,
    ...
    box2d.b2Island = function () {
        this.m_bodies = new Array(1024),
            this.m_contacts = new Array(1024),
            this.m_joints = new Array(1024),
    ...
    box2d.b2Island.prototype.Initialize = function (o, t, e, i, n) {
        for (this.m_bodyCapacity = o,
            ...
            this.m_jointCount = 0,
            this.m_allocator = i,
            this.m_listener = n; this.m_bodies.length < o;)
            this.m_bodies[this.m_bodies.length] = null;
        for (; this.m_contacts.length < t;)
            this.m_contacts[this.m_contacts.length] = null;
        for (; this.m_joints.length < e;)
            this.m_joints[this.m_joints.length] = null;
        if (this.m_positions.length < o) {
            var s = box2d.b2Max(2 * this.m_positions.length, o);
            for (box2d.DEBUG && window.console.log("box2d.b2Island.m_positions: " + s); this.m_positions.length < s;)
                this.m_positions[this.m_positions.length] = new box2d.b2Position
        }
        if (this.m_velocities.length < o) {
            s = box2d.b2Max(2 * this.m_velocities.length, o);
            for (box2d.DEBUG && window.console.log("box2d.b2Island.m_velocities: " + s); this.m_velocities.length < s;)
    ...
    box2d.b2Island.prototype.AddBody = function (o) {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(this.m_bodyCount < this.m_bodyCapacity),
            o.m_islandIndex = this.m_bodyCount,
            this.m_bodies[this.m_bodyCount++] = o
    }
    ,
    ...
    ,
    box2d.b2Island.prototype.Solve = function (o, t, e, i) {
        for (var n = box2d.b2Island.s_timer.Reset(), s = t.dt, r = 0; r < this.m_bodyCount; ++r) {
            var b = this.m_bodies[r]
                , a = this.m_positions[r].c.Copy(b.m_sweep.c)
                , d = b.m_sweep.a
                , l = this.m_velocities[r].v.Copy(b.m_linearVelocity)
                , x = b.m_angularVelocity;
            b.m_sweep.c0.Copy(b.m_sweep.c),
                b.m_sweep.a0 = b.m_sweep.a,
                b.m_type === box2d.b2BodyType.b2_dynamicBody && (l.x += s * (b.m_gravityScale * e.x + b.m_invMass * b.m_force.x),
                    l.y += s * (b.m_gravityScale * e.y + b.m_invMass * b.m_force.y),
                    x += s * b.m_invI * b.m_torque,
                    l.SelfMul(1 / (1 + s * b.m_linearDamping)),
                    x *= 1 / (1 + s * b.m_angularDamping)),
                this.m_positions[r].a = d,
                this.m_velocities[r].w = x
        }
        n.Reset();
        var p = box2d.b2Island.s_solverData;
        p.step.Copy(t),
            p.positions = this.m_positions,
            p.velocities = this.m_velocities;
        var m = box2d.b2Island.s_contactSolverDef;
        m.step.Copy(t),
        ...
        var h = box2d.b2Island.s_contactSolver.Initialize(m);
        h.InitializeVelocityConstraints(),
            t.warmStarting && h.WarmStart();
        for (r = 0; r < this.m_jointCount; ++r)
            this.m_joints[r].InitVelocityConstraints(p);
        o.solveInit = n.GetMilliseconds(),
            n.Reset();
        for (r = 0; r < t.velocityIterations; ++r) {
            for (var _ = 0; _ < this.m_jointCount; ++_)
                this.m_joints[_].SolveVelocityConstraints(p);
            h.SolveVelocityConstraints()
        }
        h.StoreImpulses(),
            o.solveVelocity = n.GetMilliseconds();
        for (r = 0; r < this.m_bodyCount; ++r) {
            a = this.m_positions[r].c,
                d = this.m_positions[r].a,
                l = this.m_velocities[r].v,
                x = this.m_velocities[r].w;
            var c = box2d.b2MulSV(s, l, box2d.b2Island.s_translation);
            if (box2d.b2DotVV(c, c) > box2d.b2_maxTranslationSquared) {
                var y = box2d.b2_maxTranslation / c.GetLength();
                l.SelfMul(y)
            }
            var u = s * x;
            if (u * u > box2d.b2_maxRotationSquared)
                x *= y = box2d.b2_maxRotation / box2d.b2Abs(u);
            a.x += s * l.x,
                a.y += s * l.y,
                d += s * x,
                this.m_positions[r].a = d,
        ...
        for (r = 0; r < t.positionIterations; ++r) {
            var f = h.SolvePositionConstraints()
                , S = !0;
            for (_ = 0; _ < this.m_jointCount; ++_) {
                var A = this.m_joints[_].SolvePositionConstraints(p);
                S = S && A
            }
            if (f && S) {
                g = !0;
        ...
        for (r = 0; r < this.m_bodyCount; ++r) {
            ...
            C.m_sweep.c.Copy(this.m_positions[r].c),
                C.m_sweep.a = this.m_positions[r].a,
                C.m_linearVelocity.Copy(this.m_velocities[r].v),
                C.m_angularVelocity = this.m_velocities[r].w,
                C.SynchronizeTransform()
        }
        if (o.solvePosition = n.GetMilliseconds(),
            this.Report(h.m_velocityConstraints),
            i) {
            var v = box2d.b2_maxFloat
                , V = box2d.b2_linearSleepTolerance * box2d.b2_linearSleepTolerance
                , B = box2d.b2_angularSleepTolerance * box2d.b2_angularSleepTolerance;
            for (r = 0; r < this.m_bodyCount; ++r) {
                (b = this.m_bodies[r]).GetType() !== box2d.b2BodyType.b2_staticBody && (0 == (b.m_flags & box2d.b2BodyFlag.e_autoSleepFlag) || b.m_angularVelocity * b.m_angularVelocity > B || box2d.b2DotVV(b.m_linearVelocity, b.m_linearVelocity) > V ? (b.m_sleepTime = 0,
                    v = 0) : (b.m_sleepTime += s,
                        v = box2d.b2Min(v, b.m_sleepTime)))
            }
            if (v >= box2d.b2_timeToSleep && g)
                for (r = 0; r < this.m_bodyCount; ++r) {
                    (b = this.m_bodies[r]).SetAwake(!1)
                }
        }
    }
    ,
    box2d.b2Island.prototype.SolveTOI = function (o, t, e) {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(t < this.m_bodyCount),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(e < this.m_bodyCount);
        for (var i = 0; i < this.m_bodyCount; ++i) {
            var n = this.m_bodies[i];
            this.m_positions[i].c.Copy(n.m_sweep.c),
                this.m_positions[i].a = n.m_sweep.a,
                this.m_velocities[i].v.Copy(n.m_linearVelocity),
                this.m_velocities[i].w = n.m_angularVelocity
        }
        var s = box2d.b2Island.s_contactSolverDef;
        ...
        var r = box2d.b2Island.s_contactSolver.Initialize(s);
        for (i = 0; i < o.positionIterations; ++i) {
            if (r.SolveTOIPositionConstraints(t, e))
                break
        }
        this.m_bodies[t].m_sweep.c0.Copy(this.m_positions[t].c),
            this.m_bodies[t].m_sweep.a0 = this.m_positions[t].a,
        ...
        for (i = 0; i < o.velocityIterations; ++i)
            r.SolveVelocityConstraints();
        var b = o.dt;
        for (i = 0; i < this.m_bodyCount; ++i) {
            var a = this.m_positions[i].c
                , d = this.m_positions[i].a
                , l = this.m_velocities[i].v
                , x = this.m_velocities[i].w
                , p = box2d.b2MulSV(b, l, box2d.b2Island.s_translation);
            if (box2d.b2DotVV(p, p) > box2d.b2_maxTranslationSquared) {
                var m = box2d.b2_maxTranslation / p.GetLength();
                l.SelfMul(m)
            }
            var h = b * x;
            if (h * h > box2d.b2_maxRotationSquared)
                x *= m = box2d.b2_maxRotation / box2d.b2Abs(h);
            a.SelfMulAdd(b, l),
                d += b * x,
                this.m_positions[i].a = d,
                this.m_velocities[i].w = x;
            var _ = this.m_bodies[i];
            _.m_sweep.c.Copy(a),
                _.m_sweep.a = d,
                _.m_linearVelocity.Copy(l),
                _.m_angularVelocity = x,
                _.SynchronizeTransform()
        }
        ...
        if (null !== this.m_listener)
            for (var t = 0; t < this.m_contactCount; ++t) {
                ...
                if (e) {
                    ...
                    n.count = i.pointCount;
                    for (var s = 0; s < i.pointCount; ++s)
                        n.normalImpulses[s] = i.points[s].normalImpulse,
                            n.tangentImpulses[s] = i.points[s].tangentImpulse;
                    this.m_listener.PostSolve(e, n)
                }
            }
    }
    ,
    ...
    box2d.b2ContactFactory = function (o) {
        this.m_allocator = o,
            this.InitializeRegisters()
    }
    ,
    box2d.b2ContactFactory.prototype.m_allocator = null,
    box2d.b2ContactFactory.prototype.AddType = function (o, t, e, i) {
        var n = box2d.b2MakeArray(256, function (t) {
            return o()
        })
            , s = function (t) {
                return n.length > 0 ? n.pop() : o(t)
            }
            , r = function (o, t) {
                n.push(o)
            };
        this.m_registers[e][i].pool = n,
            this.m_registers[e][i].createFcn = s,
            this.m_registers[e][i].destroyFcn = r,
            this.m_registers[e][i].primary = !0,
            e !== i && (this.m_registers[i][e].pool = n,
                this.m_registers[i][e].createFcn = s,
                this.m_registers[i][e].destroyFcn = r,
                this.m_registers[i][e].primary = !1)
    }
    ,
    box2d.b2ContactFactory.prototype.InitializeRegisters = function () {
        ...
        for (var o = 0; o < box2d.b2ShapeType.e_shapeTypeCount; o++) {
            this.m_registers[o] = new Array(box2d.b2ShapeType.e_shapeTypeCount);
            for (var t = 0; t < box2d.b2ShapeType.e_shapeTypeCount; t++)
                this.m_registers[o][t] = new box2d.b2ContactRegister
        }
    ...
    ,
    box2d.b2ContactFactory.prototype.Create = function (o, t, e, i) {
        var n = o.GetType()
            , s = e.GetType();
        box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= n && n < box2d.b2ShapeType.e_shapeTypeCount),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= s && s < box2d.b2ShapeType.e_shapeTypeCount);
        var r, b = this.m_registers[n][s], a = b.createFcn;
        return null !== a ? b.primary ? ((r = a(this.m_allocator)).Reset(o, t, e, i),
            r) : ((r = a(this.m_allocator)).Reset(e, i, o, t),
                r) : null
    }
    ,
    box2d.b2ContactFactory.prototype.Destroy = function (o) {
        var t = o.m_fixtureA
            , e = o.m_fixtureB;
        o.m_manifold.pointCount > 0 && !1 === t.IsSensor() && !1 === e.IsSensor() && (t.GetBody().SetAwake(!0),
            e.GetBody().SetAwake(!0));
        var i = t.GetType()
            , n = e.GetType();
        box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= i && n < box2d.b2ShapeType.e_shapeTypeCount),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= i && n < box2d.b2ShapeType.e_shapeTypeCount),
            (0,
                this.m_registers[i][n].destroyFcn)(o, this.m_allocator)
    }
    ,
    goog.provide("box2d.b2GrowableStack"),
    goog.require("box2d.b2Settings"),
    box2d.b2GrowableStack = function (o) {
        this.m_stack = new Array(o)
    }
    ,
    ...
    box2d.b2GrowableStack.prototype.Push = function (o) {
        this.m_stack[this.m_count] = o,
            ++this.m_count
    }
    ,
    box2d.b2GrowableStack.prototype.Pop = function () {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(this.m_count > 0),
            --this.m_count;
        var o = this.m_stack[this.m_count];
        return this.m_stack[this.m_count] = null,
            o
    }
    ,
    ...
    box2d.b2DynamicTree.prototype.GetUserData = function (o) {
        return box2d.ENABLE_ASSERTS && box2d.b2Assert(null !== o),
            o.userData
    }
    ,
    ...
    box2d.b2DynamicTree.prototype.Query = function (o, t) {
        if (null !== this.m_root) {
            ...
            for (e.Push(this.m_root); e.GetCount() > 0;) {
                var i = e.Pop();
                if (null !== i)
    ...
    box2d.b2DynamicTree.prototype.RayCast = function (o, t) {
        if (null !== this.m_root) {
            var e = t.p1
                , i = t.p2
                , n = box2d.b2SubVV(i, e, box2d.b2DynamicTree.s_r);
            box2d.ENABLE_ASSERTS && box2d.b2Assert(n.GetLengthSquared() > 0),
                n.Normalize();
            var s = box2d.b2CrossOneV(n, box2d.b2DynamicTree.s_v)
                , r = box2d.b2AbsV(s, box2d.b2DynamicTree.s_abs_v)
                , b = t.maxFraction
                , a = box2d.b2DynamicTree.s_segmentAABB
                , d = e.x + b * (i.x - e.x)
                , l = e.y + b * (i.y - e.y);
            a.lowerBound.x = box2d.b2Min(e.x, d),
                a.lowerBound.y = box2d.b2Min(e.y, l),
                a.upperBound.x = box2d.b2Max(e.x, d),
                a.upperBound.y = box2d.b2Max(e.y, l);
            var x = box2d.b2DynamicTree.s_stack.Reset();
            for (x.Push(this.m_root); x.GetCount() > 0;) {
                var p = x.Pop();
                if (null !== p && !1 !== box2d.b2TestOverlapAABB(p.aabb, a)) {
                    var m = p.aabb.GetCenter()
                        , h = p.aabb.GetExtents();
                    if (!(box2d.b2Abs(box2d.b2DotVV(s, box2d.b2SubVV(e, m, box2d.b2Vec2.s_t0))) - box2d.b2DotVV(r, h) > 0))
                        if (p.IsLeaf()) {
                            var _ = box2d.b2DynamicTree.s_subInput;
                            _.p1.Copy(t.p1),
                                _.p2.Copy(t.p2),
                                _.maxFraction = b;
                            var c = o(_, p);
    ...
    box2d.b2DynamicTree.prototype.AllocateNode = function () {
        if (this.m_freeList) {
            ...
            return this.m_freeList = o.parent,
                o.parent = null,
                o.child1 = null,
                o.child2 = null,
                o.height = 0,
    ...
    box2d.b2DynamicTree.prototype.FreeNode = function (o) {
        o.parent = this.m_freeList,
            o.height = -1,
            this.m_freeList = o
    }
    ,
    box2d.b2DynamicTree.prototype.CreateProxy = function (o, t) {
        ...
        return e.aabb.lowerBound.x = o.lowerBound.x - i,
            e.aabb.lowerBound.y = o.lowerBound.y - n,
            e.aabb.upperBound.x = o.upperBound.x + i,
            e.aabb.upperBound.y = o.upperBound.y + n,
            e.userData = t,
            e.height = 0,
            this.InsertLeaf(e),
            e
    ...
    box2d.b2DynamicTree.prototype.MoveProxy = function (o, t, e) {
        if (box2d.ENABLE_ASSERTS && box2d.b2Assert(o.IsLeaf()),
            o.aabb.Contains(t))
            return !1;
        this.RemoveLeaf(o);
        var i = box2d.b2_aabbExtension + box2d.b2_aabbMultiplier * (e.x > 0 ? e.x : -e.x)
            , n = box2d.b2_aabbExtension + box2d.b2_aabbMultiplier * (e.y > 0 ? e.y : -e.y);
        return o.aabb.lowerBound.x = t.lowerBound.x - i,
            o.aabb.lowerBound.y = t.lowerBound.y - n,
            o.aabb.upperBound.x = t.upperBound.x + i,
            o.aabb.upperBound.y = t.upperBound.y + n,
            this.InsertLeaf(o),
            !0
    }
    ,
    box2d.b2DynamicTree.prototype.InsertLeaf = function (o) {
        if (++this.m_insertionCount,
            null === this.m_root)
            return this.m_root = o,
                void (this.m_root.parent = null);
        for (var t, e, i = o.aabb, n = (i.GetCenter(),
            this.m_root); !1 === n.IsLeaf();) {
            t = n.child1,
                e = n.child2;
            var s = n.aabb.GetPerimeter()
                , r = box2d.b2DynamicTree.s_combinedAABB;
            r.Combine2(n.aabb, i);
            var b, a, d, l = r.GetPerimeter(), x = 2 * l, p = 2 * (l - s), m = box2d.b2DynamicTree.s_aabb;
            if (t.IsLeaf() ? (m.Combine2(i, t.aabb),
                b = m.GetPerimeter() + p) : (m.Combine2(i, t.aabb),
                    a = t.aabb.GetPerimeter(),
                    b = m.GetPerimeter() - a + p),
                e.IsLeaf() ? (m.Combine2(i, e.aabb),
                    d = m.GetPerimeter() + p) : (m.Combine2(i, e.aabb),
                        a = e.aabb.GetPerimeter(),
                        d = m.GetPerimeter() - a + p),
                x < b && x < d)
                break;
            n = b < d ? t : e
        }
        ...
        for (c.parent = _,
            c.userData = null,
            c.aabb.Combine2(i, h.aabb),
            c.height = h.height + 1,
            _ ? (_.child1 === h ? _.child1 = c : _.child2 = c,
                c.child1 = h,
                c.child2 = o,
                h.parent = c,
                o.parent = c) : (c.child1 = h,
                    c.child2 = o,
                    h.parent = c,
                    o.parent = c,
                    this.m_root = c),
            n = o.parent; null !== n;)
            t = (n = this.Balance(n)).child1,
                e = n.child2,
                box2d.ENABLE_ASSERTS && box2d.b2Assert(null !== t),
                box2d.ENABLE_ASSERTS && box2d.b2Assert(null !== e),
                n.height = 1 + box2d.b2Max(t.height, e.height),
                n.aabb.Combine2(t.aabb, e.aabb),
                n = n.parent
    }
    ,
    box2d.b2DynamicTree.prototype.RemoveLeaf = function (o) {
        if (o !== this.m_root) {
            var t, e = o.parent, i = e.parent;
            if (t = e.child1 === o ? e.child2 : e.child1,
                i) {
                i.child1 === e ? i.child1 = t : i.child2 = t,
                    t.parent = i,
                    this.FreeNode(e);
                for (var n = i; n;) {
                    var s = (n = this.Balance(n)).child1
                        , r = n.child2;
                    n.aabb.Combine2(s.aabb, r.aabb),
                        n.height = 1 + box2d.b2Max(s.height, r.height),
                        n = n.parent
                }
            } else
                this.m_root = t,
    ...
    box2d.b2DynamicTree.prototype.Balance = function (o) {
        if (box2d.ENABLE_ASSERTS && box2d.b2Assert(null !== o),
            o.IsLeaf() || o.height < 2)
            return o;
        var t = o.child1
            , e = o.child2
        ...
        if (i > 1) {
            ...
            return e.child1 = o,
                e.parent = o.parent,
                o.parent = e,
                null !== e.parent ? e.parent.child1 === o ? e.parent.child1 = e : (box2d.ENABLE_ASSERTS && box2d.b2Assert(e.parent.child2 === o),
                    e.parent.child2 = e) : this.m_root = e,
                n.height > s.height ? (e.child2 = n,
                    o.child2 = s,
                    s.parent = o,
                    o.aabb.Combine2(t.aabb, s.aabb),
                    e.aabb.Combine2(o.aabb, n.aabb),
                    o.height = 1 + box2d.b2Max(t.height, s.height),
                    e.height = 1 + box2d.b2Max(o.height, n.height)) : (e.child2 = s,
                        o.child2 = n,
                        n.parent = o,
                        o.aabb.Combine2(t.aabb, n.aabb),
                        e.aabb.Combine2(o.aabb, s.aabb),
                        o.height = 1 + box2d.b2Max(t.height, n.height),
                        e.height = 1 + box2d.b2Max(o.height, s.height)),
                e
        }
        if (i < -1) {
            var r = t.child1
            ...
            return t.child1 = o,
                t.parent = o.parent,
                o.parent = t,
                null !== t.parent ? t.parent.child1 === o ? t.parent.child1 = t : (box2d.ENABLE_ASSERTS && box2d.b2Assert(t.parent.child2 === o),
                    t.parent.child2 = t) : this.m_root = t,
                r.height > b.height ? (t.child2 = r,
                    o.child1 = b,
                    b.parent = o,
                    o.aabb.Combine2(e.aabb, b.aabb),
                    t.aabb.Combine2(o.aabb, r.aabb),
                    o.height = 1 + box2d.b2Max(e.height, b.height),
                    t.height = 1 + box2d.b2Max(o.height, r.height)) : (t.child2 = b,
                        o.child1 = r,
                        r.parent = o,
                        o.aabb.Combine2(e.aabb, r.aabb),
                        t.aabb.Combine2(o.aabb, b.aabb),
                        o.height = 1 + box2d.b2Max(e.height, r.height),
                        t.height = 1 + box2d.b2Max(o.height, b.height)),
                t
        }
        return o
    }
    ...
    box2d.b2DynamicTree.prototype.ComputeHeightNode = function (o) {
        ...
        var t = this.ComputeHeightNode(o.child1)
            , e = this.ComputeHeightNode(o.child2);
        return 1 + box2d.b2Max(t, e)
    }
    ,
    ...
    box2d.b2DynamicTree.prototype.ValidateStructure = function (o) {
        if (null !== o) {
            ...
            var t = o
                ...
                , i = t.child2;
            if (t.IsLeaf())
                return box2d.ENABLE_ASSERTS && box2d.b2Assert(null === e),
                    box2d.ENABLE_ASSERTS && box2d.b2Assert(null === i),
                    void (box2d.ENABLE_ASSERTS && box2d.b2Assert(0 === t.height));
            box2d.ENABLE_ASSERTS && box2d.b2Assert(e.parent === o),
                box2d.ENABLE_ASSERTS && box2d.b2Assert(i.parent === o),
        ...
        if (null !== o) {
            ...
            if (t.IsLeaf())
                return box2d.ENABLE_ASSERTS && box2d.b2Assert(null === e),
                    box2d.ENABLE_ASSERTS && box2d.b2Assert(null === i),
                    void (box2d.ENABLE_ASSERTS && box2d.b2Assert(0 === t.height));
            var n, s = e.height, r = i.height;
            n = 1 + box2d.b2Max(s, r),
                box2d.ENABLE_ASSERTS && box2d.b2Assert(t.height === n);
            var b = box2d.b2DynamicTree.s_aabb;
            b.Combine2(e.aabb, i.aabb),
                box2d.ENABLE_ASSERTS && box2d.b2Assert(b.lowerBound === t.aabb.lowerBound),
                box2d.ENABLE_ASSERTS && box2d.b2Assert(b.upperBound === t.aabb.upperBound),
    ...
    box2d.b2DynamicTree.prototype.Validate = function () {
        ...
        for (var o = this.m_freeList; null !== o;)
            o = o.parent,
                0;
    ...
    box2d.b2DynamicTree.prototype.GetMaxBalance = function () {
        return function (o, t) {
            ...
            if (o.height <= 1)
                return t;
            box2d.ENABLE_ASSERTS && box2d.b2Assert(!1 === o.IsLeaf());
            var e = o.child1
                , i = o.child2
                , n = box2d.b2Abs(i.height - e.height);
            return box2d.b2Max(t, n)
        }(this.m_root, 0)
    }
    ,
    ...
    box2d.b2DynamicTree.prototype.ShiftOrigin = function (o) {
        var t = function (o, e) {
            if (null !== o && !(o.height <= 1)) {
                box2d.ENABLE_ASSERTS && box2d.b2Assert(!1 === o.IsLeaf());
                var i = o.child1
                    , n = o.child2;
                t(i, e),
                    t(n, e),
                    o.aabb.lowerBound.SelfSub(e),
                    o.aabb.upperBound.SelfSub(e)
            }
        };
        t(this.m_root, o)
    }
    ...
    box2d.b2BroadPhase.prototype.TestOverlap = function (o, t) {
        var e = this.m_tree.GetFatAABB(o)
            , i = this.m_tree.GetFatAABB(t);
        return box2d.b2TestOverlapAABB(e, i)
    }
    ,
    ...
    box2d.b2BroadPhase.prototype.UpdatePairs = function (o) {
        this.m_pairCount = 0;
        for (var t = 0; t < this.m_moveCount; ++t) {
            ...
            if (null !== e) {
                ...
                this.m_tree.Query(function (o) {
                    if (o.m_id === e.m_id)
                        return !0;
                    i.m_pairCount === i.m_pairBuffer.length && (i.m_pairBuffer[i.m_pairCount] = new box2d.b2Pair);
                    var t = i.m_pairBuffer[i.m_pairCount];
                    return o.m_id < e.m_id ? (t.proxyA = o,
                        t.proxyB = e) : (t.proxyA = e,
                            t.proxyB = o),
                        ++i.m_pairCount,
                        !0
                }, n)
        ...
        for (t = 0; t < this.m_pairCount;) {
            var s = this.m_pairBuffer[t]
                , r = this.m_tree.GetUserData(s.proxyA)
                , b = this.m_tree.GetUserData(s.proxyB);
            for (o.AddPair(r, b),
                ++t; t < this.m_pairCount;) {
                var a = this.m_pairBuffer[t];
                if (a.proxyA.m_id !== s.proxyA.m_id || a.proxyB.m_id !== s.proxyB.m_id)
                    break;
                ++t
            }
        }
    ...
    box2d.b2BroadPhase.prototype.BufferMove = function (o) {
        this.m_moveBuffer[this.m_moveCount] = o,
            ++this.m_moveCount
    }
    ,
    box2d.b2BroadPhase.prototype.UnBufferMove = function (o) {
        var t = this.m_moveBuffer.indexOf(o);
    ...
    box2d.b2ContactManager.prototype.Destroy = function (o) {
        ...
        this.m_contactListener && o.IsTouching() && this.m_contactListener.EndContact(o),
            o.m_prev && (o.m_prev.m_next = o.m_next),
            o.m_next && (o.m_next.m_prev = o.m_prev),
            o === this.m_contactList && (this.m_contactList = o.m_next),
            o.m_nodeA.prev && (o.m_nodeA.prev.next = o.m_nodeA.next),
            o.m_nodeA.next && (o.m_nodeA.next.prev = o.m_nodeA.prev),
            o.m_nodeA === i.m_contactList && (i.m_contactList = o.m_nodeA.next),
            o.m_nodeB.prev && (o.m_nodeB.prev.next = o.m_nodeB.next),
            o.m_nodeB.next && (o.m_nodeB.next.prev = o.m_nodeB.prev),
            o.m_nodeB === n.m_contactList && (n.m_contactList = o.m_nodeB.next),
            this.m_contactFactory.Destroy(o),
            --this.m_contactCount
    }
    ,
    box2d.b2ContactManager.prototype.Collide = function () {
        for (var o = this.m_contactList; o;) {
            var t = o.GetFixtureA()
                ...
                , s = t.GetBody()
                , r = e.GetBody();
            if (o.m_flags & box2d.b2ContactFlag.e_filterFlag) {
                if (!1 === r.ShouldCollide(s)) {
                    var b = o;
                    o = b.m_next,
                        this.Destroy(b);
                    continue
                }
                if (this.m_contactFilter && !1 === this.m_contactFilter.ShouldCollide(t, e)) {
                    o = (b = o).m_next,
                        this.Destroy(b);
                    continue
                }
            ...
            var a = s.IsAwake() && s.m_type !== box2d.b2BodyType.b2_staticBody
                , d = r.IsAwake() && r.m_type !== box2d.b2BodyType.b2_staticBody;
            if (!1 !== a || !1 !== d) {
                var l = t.m_proxies[i].proxy
                    , x = e.m_proxies[n].proxy;
                !1 !== this.m_broadPhase.TestOverlap(l, x) ? (o.Update(this.m_contactListener),
                    o = o.m_next) : (o = (b = o).m_next,
                        this.Destroy(b))
            } else
                o = o.m_next
        }
    ...
    box2d.b2ContactManager.prototype.AddPair = function (o, t) {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(o instanceof box2d.b2FixtureProxy),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(t instanceof box2d.b2FixtureProxy);
        var e = o
            , i = t
            , n = e.fixture
            , s = i.fixture
            ...
            , d = s.GetBody();
        if (a !== d) {
            for (var l = d.GetContactList(); l;) {
                if (l.other === a) {
                    var x = l.contact.GetFixtureA()
                        , p = l.contact.GetFixtureB()
                        , m = l.contact.GetChildIndexA()
                        , h = l.contact.GetChildIndexB();
                    if (x === n && p === s && m === r && h === b)
                        return;
                    if (x === s && p === n && m === b && h === r)
                        return
            ...
            if (!1 !== d.ShouldCollide(a) && (!this.m_contactFilter || !1 !== this.m_contactFilter.ShouldCollide(n, s))) {
                var _ = this.m_contactFactory.Create(n, r, s, b);
                null !== _ && (n = _.GetFixtureA(),
                    s = _.GetFixtureB(),
                    r = _.GetChildIndexA(),
                    b = _.GetChildIndexB(),
                    a = n.m_body,
                    ...
                    _.m_nodeA.other = d,
                    _.m_nodeA.prev = null,
                    _.m_nodeA.next = a.m_contactList,
                    null !== a.m_contactList && (a.m_contactList.prev = _.m_nodeA),
                    a.m_contactList = _.m_nodeA,
                    _.m_nodeB.contact = _,
                    _.m_nodeB.other = a,
                    _.m_nodeB.prev = null,
                    _.m_nodeB.next = d.m_contactList,
                    null !== d.m_contactList && (d.m_contactList.prev = _.m_nodeB),
                    d.m_contactList = _.m_nodeB,
                    !1 === n.IsSensor() && !1 === s.IsSensor() && (a.SetAwake(!0),
                        d.SetAwake(!0)),
                    ++this.m_contactCount)
            }
        }
    ...
    goog.require("box2d.b2Math"),
    goog.require("box2d.b2Joint"),
    box2d.b2JointFactory.Create = function (o, t) {
        var e = null;
        switch (o.type) {
    ...
    ,
    box2d.b2JointFactory.Destroy = function (o, t) { }
    ,
    goog.provide("box2d.b2Draw"),
    goog.require("box2d.b2Settings"),
    box2d.b2Color = function (o, t, e) {
        this.r = o,
            this.g = t,
            this.b = e
    }
    ,
    box2d.b2Color.prototype.r = .5,
    box2d.b2Color.prototype.g = .5,
    box2d.b2Color.prototype.b = .5,
    box2d.b2Color.prototype.SetRGB = function (o, t, e) {
        return this.r = o,
            this.g = t,
            this.b = e,
            this
    ...
    box2d.b2Color.prototype.MakeStyleString = function (o) {
        var t = Math.round(Math.max(0, Math.min(255, 255 * this.r)))
            , e = Math.round(Math.max(0, Math.min(255, 255 * this.g)))
            , i = Math.round(Math.max(0, Math.min(255, 255 * this.b)))
            , n = void 0 === o ? 1 : Math.max(0, Math.min(1, o));
        return box2d.b2Color.MakeStyleString(t, e, i, n)
    }
    ,
    box2d.b2Color.MakeStyleString = function (o, t, e, i) {
        return i < 1 ? "rgba(" + o + "," + t + "," + e + "," + i + ")" : "rgb(" + o + "," + t + "," + e + ")"
    }
    ,
    ...
    ,
    box2d.b2Draw.prototype.PushTransform = function (o) { }
    ,
    box2d.b2Draw.prototype.PopTransform = function (o) { }
    ,
    box2d.b2Draw.prototype.DrawPolygon = function (o, t, e) { }
    ,
    box2d.b2Draw.prototype.DrawSolidPolygon = function (o, t, e) { }
    ,
    box2d.b2Draw.prototype.DrawCircle = function (o, t, e) { }
    ,
    box2d.b2Draw.prototype.DrawSolidCircle = function (o, t, e, i) { }
    ,
    box2d.b2Draw.prototype.DrawSegment = function (o, t, e) { }
    ,
    box2d.b2Draw.prototype.DrawTransform = function (o) { }
    ,
    ...
    box2d.b2Filter.prototype.Copy = function (o) {
        return box2d.ENABLE_ASSERTS && box2d.b2Assert(this !== o),
    ...
    box2d.b2FixtureDef.prototype.friction = .2,
    ...
    box2d.b2Fixture.prototype.GetMassData = function (o) {
        return o = o || new box2d.b2MassData,
            this.m_shape.ComputeMass(o, this.m_density),
            o
    }
    ,
    ...
    box2d.b2Fixture.prototype.CreateProxies = function (o, t) {
        ...
        for (var e = 0; e < this.m_proxyCount; ++e) {
            ...
            this.m_shape.ComputeAABB(i.aabb, t, e),
                i.proxy = o.CreateProxy(i.aabb, i),
                i.fixture = this,
                i.childIndex = e
        }
    }
    ...
    box2d.b2Fixture.prototype.Synchronize = function (o, t, e) {
        if (0 !== this.m_proxyCount)
            for (var i = 0; i < this.m_proxyCount; ++i) {
                ...
                this.m_shape.ComputeAABB(s, t, i),
                    this.m_shape.ComputeAABB(r, e, i),
                    n.aabb.Combine2(s, r);
                var b = box2d.b2SubVV(e.p, t.p, box2d.b2Fixture.prototype.Synchronize.s_displacement);
                o.MoveProxy(n.proxy, n.aabb, b)
            }
    }
    ,
    ...
    box2d.b2Fixture.prototype.SetFilterData = function (o) {
        this.m_filter.Copy(o),
            this.Refilter()
    }
    ,
        ...
        if (!this.m_body) {
            for (var o = this.m_body.GetContactList(); o;) {
                var t = o.contact
                    , e = t.GetFixtureA()
                    , i = t.GetFixtureB();
                e !== this && i !== this || t.FlagForFiltering(),
                    o = o.next
            }
            var n = this.m_body.GetWorld();
            if (null !== n)
                for (var s = n.m_contactManager.m_broadPhase, r = 0; r < this.m_proxyCount; ++r)
                    s.TouchProxy(this.m_proxies[r].proxy)
        }
    }
    ,
    box2d.b2Fixture.prototype.SetSensor = function (o) {
        o !== this.m_isSensor && (this.m_body.SetAwake(!0),
            this.m_isSensor = o)
    }
    ,
    ...
    box2d.b2Body = function (o, t) {
        this.m_xf = new box2d.b2Transform,
            ...
            box2d.ENABLE_ASSERTS && box2d.b2Assert(o.position.IsValid()),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(o.linearVelocity.IsValid()),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(box2d.b2IsValid(o.angle)),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(box2d.b2IsValid(o.angularVelocity)),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(box2d.b2IsValid(o.gravityScale) && o.gravityScale >= 0),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(box2d.b2IsValid(o.angularDamping) && o.angularDamping >= 0),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(box2d.b2IsValid(o.linearDamping) && o.linearDamping >= 0),
            this.m_flags = box2d.b2BodyFlag.e_none,
            o.bullet && (this.m_flags |= box2d.b2BodyFlag.e_bulletFlag),
            o.fixedRotation && (this.m_flags |= box2d.b2BodyFlag.e_fixedRotationFlag),
            o.allowSleep && (this.m_flags |= box2d.b2BodyFlag.e_autoSleepFlag),
            o.awake && (this.m_flags |= box2d.b2BodyFlag.e_awakeFlag),
            o.active && (this.m_flags |= box2d.b2BodyFlag.e_activeFlag),
            this.m_world = t,
            this.m_xf.p.Copy(o.position),
            this.m_xf.q.SetAngleRadians(o.angle),
            this.m_sweep.localCenter.SetZero(),
            this.m_sweep.c0.Copy(this.m_xf.p),
            this.m_sweep.c.Copy(this.m_xf.p),
            this.m_sweep.a0 = o.angle,
            this.m_sweep.a = o.angle,
            this.m_sweep.alpha0 = 0,
            this.m_linearVelocity.Copy(o.linearVelocity),
            this.m_angularVelocity = o.angularVelocity,
            this.m_linearDamping = o.linearDamping,
            this.m_angularDamping = o.angularDamping,
            this.m_gravityScale = o.gravityScale,
            this.m_force.SetZero(),
            this.m_torque = 0,
            this.m_sleepTime = 0,
            this.m_type = o.type,
            o.type === box2d.b2BodyType.b2_dynamicBody ? (this.m_mass = 1,
    ...
    box2d.b2Body.prototype.CreateFixture = function (o) {
        if (box2d.ENABLE_ASSERTS && box2d.b2Assert(!1 === this.m_world.IsLocked()),
            !0 === this.m_world.IsLocked())
            return null;
    ...
    ,
    box2d.b2Body.prototype.CreateFixture2 = function (o, t) {
        void 0 === t && (t = 0);
        var e = box2d.b2Body.prototype.CreateFixture2.s_def;
        return e.shape = o,
            e.density = t,
    ...
    box2d.b2Body.prototype.DestroyFixture = function (o) {
        if (box2d.ENABLE_ASSERTS && box2d.b2Assert(!1 === this.m_world.IsLocked()),
            !0 !== this.m_world.IsLocked()) {
            box2d.ENABLE_ASSERTS && box2d.b2Assert(o.m_body === this),
                box2d.ENABLE_ASSERTS && box2d.b2Assert(this.m_fixtureCount > 0);
            for (var t = this.m_fixtureList, e = null, i = !1; null !== t;) {
                if (t === o) {
                    e ? e.m_next = o.m_next : this.m_fixtureList = o.m_next,
                        i = !0;
                    break
                }
                e = t,
            ...
            box2d.ENABLE_ASSERTS && box2d.b2Assert(i);
            for (var n = this.m_contactList; n;) {
                var s = n.contact;
                n = n.next;
                var r = s.GetFixtureA()
                    , b = s.GetFixtureB();
                o !== r && o !== b || this.m_world.m_contactManager.Destroy(s)
            }
    ...
    ,
    box2d.b2Body.prototype.SetTransformVecRadians = function (o, t) {
        this.SetTransformXYRadians(o.x, o.y, t)
    }
    ,
    box2d.b2Body.prototype.SetTransformXYRadians = function (o, t, e) {
        if (box2d.ENABLE_ASSERTS && box2d.b2Assert(!1 === this.m_world.IsLocked()),
            !0 !== this.m_world.IsLocked() && (this.m_xf.p.x !== o || this.m_xf.p.y !== t || this.m_xf.q.GetAngleRadians() !== e)) {
            this.m_xf.q.SetAngleRadians(e),
                this.m_xf.p.SetXY(o, t),
                box2d.b2MulXV(this.m_xf, this.m_sweep.localCenter, this.m_sweep.c),
                this.m_sweep.a = e,
                this.m_sweep.c0.Copy(this.m_sweep.c),
                this.m_sweep.a0 = e;
            for (var i = this.m_world.m_contactManager.m_broadPhase, n = this.m_fixtureList; n; n = n.m_next)
                n.Synchronize(i, this.m_xf, this.m_xf)
        }
    }
    ,
    box2d.b2Body.prototype.SetTransform = function (o) {
        this.SetTransformVecRadians(o.p, o.GetAngleRadians())
    }
    ,
    ...
    box2d.b2Body.prototype.SetPosition = function (o) {
        this.SetTransformVecRadians(o, this.GetAngleRadians())
    }
    ,
    box2d.b2Body.prototype.SetPositionXY = function (o, t) {
        this.SetTransformXYRadians(o, t, this.GetAngleRadians())
    }
    ,
    ...
    box2d.b2Body.prototype.SetAngle = function (o) {
        this.SetTransformVecRadians(this.GetPosition(), o)
    }
    ,
    box2d.b2Body.prototype.SetAngleRadians = box2d.b2Body.prototype.SetAngle,
    box2d.b2Body.prototype.SetAngleDegrees = function (o) {
        this.SetAngle(box2d.b2DegToRad(o))
    }
    ,
    ...
    box2d.b2Body.prototype.SetLinearVelocity = function (o) {
        this.m_type !== box2d.b2BodyType.b2_staticBody && (box2d.b2DotVV(o, o) > 0 && this.SetAwake(!0),
    ...
    box2d.b2Body.prototype.SetAngularVelocity = function (o) {
        this.m_type !== box2d.b2BodyType.b2_staticBody && (o * o > 0 && this.SetAwake(!0),
    ...
    box2d.b2Body.prototype.GetDefinition = function (o) {
        return o.type = this.GetType(),
            o.allowSleep = (this.m_flags & box2d.b2BodyFlag.e_autoSleepFlag) === box2d.b2BodyFlag.e_autoSleepFlag,
            o.angle = this.GetAngleRadians(),
            o.angularDamping = this.m_angularDamping,
            o.gravityScale = this.m_gravityScale,
            o.angularVelocity = this.m_angularVelocity,
            o.fixedRotation = (this.m_flags & box2d.b2BodyFlag.e_fixedRotationFlag) === box2d.b2BodyFlag.e_fixedRotationFlag,
            o.bullet = (this.m_flags & box2d.b2BodyFlag.e_bulletFlag) === box2d.b2BodyFlag.e_bulletFlag,
            o.awake = (this.m_flags & box2d.b2BodyFlag.e_awakeFlag) === box2d.b2BodyFlag.e_awakeFlag,
            o.linearDamping = this.m_linearDamping,
            o.linearVelocity.Copy(this.GetLinearVelocity()),
            o.position.Copy(this.GetPosition()),
            o.userData = this.GetUserData(),
            o
    }
    ,
    box2d.b2Body.prototype.ApplyForce = function (o, t, e) {
        e = e || !0,
            this.m_type === box2d.b2BodyType.b2_dynamicBody && (e && 0 == (this.m_flags & box2d.b2BodyFlag.e_awakeFlag) && this.SetAwake(!0),
                this.m_flags & box2d.b2BodyFlag.e_awakeFlag && (this.m_force.x += o.x,
                    this.m_force.y += o.y,
                    this.m_torque += (t.x - this.m_sweep.c.x) * o.y - (t.y - this.m_sweep.c.y) * o.x))
    }
    ,
    box2d.b2Body.prototype.ApplyForceToCenter = function (o, t) {
        t = t || !0,
            this.m_type === box2d.b2BodyType.b2_dynamicBody && (t && 0 == (this.m_flags & box2d.b2BodyFlag.e_awakeFlag) && this.SetAwake(!0),
                this.m_flags & box2d.b2BodyFlag.e_awakeFlag && (this.m_force.x += o.x,
                    this.m_force.y += o.y))
    }
    ,
    box2d.b2Body.prototype.ApplyTorque = function (o, t) {
        t = t || !0,
            this.m_type === box2d.b2BodyType.b2_dynamicBody && (t && 0 == (this.m_flags & box2d.b2BodyFlag.e_awakeFlag) && this.SetAwake(!0),
                this.m_flags & box2d.b2BodyFlag.e_awakeFlag && (this.m_torque += o))
    }
    ,
    box2d.b2Body.prototype.ApplyLinearImpulse = function (o, t, e) {
        e = e || !0,
            this.m_type === box2d.b2BodyType.b2_dynamicBody && (e && 0 == (this.m_flags & box2d.b2BodyFlag.e_awakeFlag) && this.SetAwake(!0),
                this.m_flags & box2d.b2BodyFlag.e_awakeFlag && (this.m_linearVelocity.x += this.m_invMass * o.x,
                    this.m_linearVelocity.y += this.m_invMass * o.y,
    ...
    box2d.b2Body.prototype.ApplyAngularImpulse = function (o, t) {
        t = t || !0,
            this.m_type === box2d.b2BodyType.b2_dynamicBody && (t && 0 == (this.m_flags & box2d.b2BodyFlag.e_awakeFlag) && this.SetAwake(!0),
                this.m_flags & box2d.b2BodyFlag.e_awakeFlag && (this.m_angularVelocity += this.m_invI * o))
    }
    ,
    ...
    box2d.b2Body.prototype.GetMassData = function (o) {
        return o.mass = this.m_mass,
            o.I = this.m_I + this.m_mass * box2d.b2DotVV(this.m_sweep.localCenter, this.m_sweep.localCenter),
            o.center.Copy(this.m_sweep.localCenter),
            o
    }
    ,
    box2d.b2Body.prototype.SetMassData = function (o) {
        if (box2d.ENABLE_ASSERTS && box2d.b2Assert(!1 === this.m_world.IsLocked()),
            !0 !== this.m_world.IsLocked() && this.m_type === box2d.b2BodyType.b2_dynamicBody) {
            this.m_invMass = 0,
                this.m_I = 0,
                this.m_invI = 0,
                this.m_mass = o.mass,
                ...
                o.I > 0 && 0 == (this.m_flags & box2d.b2BodyFlag.e_fixedRotationFlag) && (this.m_I = o.I - this.m_mass * box2d.b2DotVV(o.center, o.center),
                    box2d.ENABLE_ASSERTS && box2d.b2Assert(this.m_I > 0),
                    this.m_invI = 1 / this.m_I);
            var t = box2d.b2Body.prototype.SetMassData.s_oldCenter.Copy(this.m_sweep.c);
            this.m_sweep.localCenter.Copy(o.center),
                box2d.b2MulXV(this.m_xf, this.m_sweep.localCenter, this.m_sweep.c),
                this.m_sweep.c0.Copy(this.m_sweep.c),
                box2d.b2AddVCrossSV(this.m_linearVelocity, this.m_angularVelocity, box2d.b2SubVV(this.m_sweep.c, t, box2d.b2Vec2.s_t0), this.m_linearVelocity)
        }
    }
    ,
    ...
    box2d.b2Body.prototype.ResetMassData = function () {
        if (this.m_mass = 0,
            ...
            this.m_invI = 0,
            this.m_sweep.localCenter.SetZero(),
            this.m_type === box2d.b2BodyType.b2_staticBody || this.m_type === box2d.b2BodyType.b2_kinematicBody)
            return this.m_sweep.c0.Copy(this.m_xf.p),
                this.m_sweep.c.Copy(this.m_xf.p),
        ...
        for (var o = box2d.b2Body.prototype.ResetMassData.s_localCenter.SetZero(), t = this.m_fixtureList; t; t = t.m_next)
            if (0 !== t.m_density) {
                ...
                this.m_mass += e.mass,
                    o.x += e.center.x * e.mass,
                    o.y += e.center.y * e.mass,
                    this.m_I += e.I
            }
        this.m_mass > 0 ? (this.m_invMass = 1 / this.m_mass,
            o.x *= this.m_invMass,
            o.y *= this.m_invMass) : (this.m_mass = 1,
                this.m_invMass = 1),
            this.m_I > 0 && 0 == (this.m_flags & box2d.b2BodyFlag.e_fixedRotationFlag) ? (this.m_I -= this.m_mass * box2d.b2DotVV(o, o),
                box2d.ENABLE_ASSERTS && box2d.b2Assert(this.m_I > 0),
                this.m_invI = 1 / this.m_I) : (this.m_I = 0,
                    this.m_invI = 0);
        var i = box2d.b2Body.prototype.ResetMassData.s_oldCenter.Copy(this.m_sweep.c);
        this.m_sweep.localCenter.Copy(o),
            box2d.b2MulXV(this.m_xf, this.m_sweep.localCenter, this.m_sweep.c),
            this.m_sweep.c0.Copy(this.m_sweep.c),
            box2d.b2AddVCrossSV(this.m_linearVelocity, this.m_angularVelocity, box2d.b2SubVV(this.m_sweep.c, i, box2d.b2Vec2.s_t0), this.m_linearVelocity)
    }
    ,
    ...
    box2d.b2Body.prototype.GetWorldPoint = function (o, t) {
        return box2d.b2MulXV(this.m_xf, o, t)
    }
    ,
    box2d.b2Body.prototype.GetWorldVector = function (o, t) {
        return box2d.b2MulRV(this.m_xf.q, o, t)
    }
    ,
    box2d.b2Body.prototype.GetLocalPoint = function (o, t) {
        return box2d.b2MulTXV(this.m_xf, o, t)
    }
    ,
    box2d.b2Body.prototype.GetLocalVector = function (o, t) {
        return box2d.b2MulTRV(this.m_xf.q, o, t)
    }
    ,
    box2d.b2Body.prototype.GetLinearVelocityFromWorldPoint = function (o, t) {
        return box2d.b2AddVCrossSV(this.m_linearVelocity, this.m_angularVelocity, box2d.b2SubVV(o, this.m_sweep.c, box2d.b2Vec2.s_t0), t)
    }
    ,
    ...
    box2d.b2Body.prototype.SetType = function (o) {
        if (box2d.ENABLE_ASSERTS && box2d.b2Assert(!1 === this.m_world.IsLocked()),
            !0 !== this.m_world.IsLocked() && this.m_type !== o) {
            this.m_type = o,
                this.ResetMassData(),
                this.m_type === box2d.b2BodyType.b2_staticBody && (this.m_linearVelocity.SetZero(),
            ...
            for (var i = this.m_world.m_contactManager.m_broadPhase, n = this.m_fixtureList; n; n = n.m_next)
                for (var s = n.m_proxyCount, r = 0; r < s; ++r)
                    i.TouchProxy(n.m_proxies[r].proxy)
        }
    }
    ,
    ...
    box2d.b2Body.prototype.SetBullet = function (o) {
        o ? this.m_flags |= box2d.b2BodyFlag.e_bulletFlag : this.m_flags &= ~box2d.b2BodyFlag.e_bulletFlag
    }
    ,
    ...
    box2d.b2Body.prototype.SetSleepingAllowed = function (o) {
        o ? this.m_flags |= box2d.b2BodyFlag.e_autoSleepFlag : (this.m_flags &= ~box2d.b2BodyFlag.e_autoSleepFlag,
            this.SetAwake(!0))
    }
    ,
    ...
    box2d.b2Body.prototype.SetAwake = function (o) {
        o ? 0 == (this.m_flags & box2d.b2BodyFlag.e_awakeFlag) && (this.m_flags |= box2d.b2BodyFlag.e_awakeFlag,
            this.m_sleepTime = 0) : (this.m_flags &= ~box2d.b2BodyFlag.e_awakeFlag,
                this.m_sleepTime = 0,
    ...
    box2d.b2Body.prototype.SetActive = function (o) {
        if (box2d.ENABLE_ASSERTS && box2d.b2Assert(!1 === this.m_world.IsLocked()),
            ...
            if (o) {
                this.m_flags |= box2d.b2BodyFlag.e_activeFlag;
                for (var t = this.m_world.m_contactManager.m_broadPhase, e = this.m_fixtureList; e; e = e.m_next)
                    e.CreateProxies(t, this.m_xf)
            } else {
                this.m_flags &= ~box2d.b2BodyFlag.e_activeFlag;
                for (t = this.m_world.m_contactManager.m_broadPhase,
    ...
    box2d.b2Body.prototype.SetFixedRotation = function (o) {
        (this.m_flags & box2d.b2BodyFlag.e_fixedRotationFlag) === box2d.b2BodyFlag.e_fixedRotationFlag !== o && (o ? this.m_flags |= box2d.b2BodyFlag.e_fixedRotationFlag : this.m_flags &= ~box2d.b2BodyFlag.e_fixedRotationFlag,
            this.m_angularVelocity = 0,
            this.ResetMassData())
    }
    ,
    ...
    box2d.b2Body.prototype.SynchronizeFixtures = function () {
        ...
        o.q.SetAngleRadians(this.m_sweep.a0),
            box2d.b2MulRV(o.q, this.m_sweep.localCenter, o.p),
            box2d.b2SubVV(this.m_sweep.c0, o.p, o.p);
        for (var t = this.m_world.m_contactManager.m_broadPhase, e = this.m_fixtureList; e; e = e.m_next)
            e.Synchronize(t, o, this.m_xf)
    }
    ,
    ...
    box2d.b2Body.prototype.ShouldCollide = function (o) {
        if (this.m_type !== box2d.b2BodyType.b2_dynamicBody && o.m_type !== box2d.b2BodyType.b2_dynamicBody)
            return !1;
        for (var t = this.m_jointList; t; t = t.next)
            if (t.other === o && !1 === t.joint.m_collideConnected)
                return !1;
        return !0
    }
    ,
    box2d.b2Body.prototype.Advance = function (o) {
        this.m_sweep.Advance(o),
    ...
    box2d.b2World.prototype.SetAllowSleeping = function (o) {
        if (o !== this.m_allowSleep && (this.m_allowSleep = o,
            !1 === this.m_allowSleep))
    ...
    box2d.b2World.prototype.SetGravity = function (o, t) {
        if (t = t || !0,
            (this.m_gravity.x !== o.x || this.m_gravity.y !== o.y) && (this.m_gravity.Copy(o),
                t))
    ...
    box2d.b2World.prototype.SetAutoClearForces = function (o) {
        o ? this.m_flags |= box2d.b2WorldFlag.e_clearForces : this.m_flags &= ~box2d.b2WorldFlag.e_clearForces
    }
    ,
    ...
    box2d.b2World.prototype.CreateBody = function (o) {
        if (box2d.ENABLE_ASSERTS && box2d.b2Assert(!1 === this.IsLocked()),
            this.IsLocked())
            return null;
        var t = new box2d.b2Body(o, this);
    ...
    box2d.b2World.prototype.DestroyBody = function (o) {
        if (box2d.ENABLE_ASSERTS && box2d.b2Assert(this.m_bodyCount > 0),
            ...
            o.m_jointList = null;
            for (var i = o.m_controllerList; i;) {
                var n = i;
                i = i.nextController,
                    n.controller.RemoveBody(o)
            }
            for (var s = o.m_contactList; s;) {
                var r = s;
                s = s.next,
                    this.m_contactManager.Destroy(r.contact)
            }
            o.m_contactList = null;
            for (var b = o.m_fixtureList; b;) {
                var a = b;
                b = b.m_next,
                    this.m_destructionListener && this.m_destructionListener.SayGoodbyeFixture(a),
                    a.DestroyProxies(this.m_contactManager.m_broadPhase),
                    a.Destroy(),
                    o.m_fixtureList = b,
                    o.m_fixtureCount -= 1
            }
            o.m_fixtureList = null,
                o.m_fixtureCount = 0,
                o.m_prev && (o.m_prev.m_next = o.m_next),
                o.m_next && (o.m_next.m_prev = o.m_prev),
                o === this.m_bodyList && (this.m_bodyList = o.m_next),
                --this.m_bodyCount
        }
    }
    ,
    ...
    box2d.b2World.prototype.DestroyJoint = function (o) {
        if (box2d.ENABLE_ASSERTS && box2d.b2Assert(!1 === this.IsLocked()),
            ...
            if (e.SetAwake(!0),
                i.SetAwake(!0),
                o.m_edgeA.prev && (o.m_edgeA.prev.next = o.m_edgeA.next),
                o.m_edgeA.next && (o.m_edgeA.next.prev = o.m_edgeA.prev),
                o.m_edgeA === e.m_jointList && (e.m_jointList = o.m_edgeA.next),
                o.m_edgeA.prev = null,
                o.m_edgeA.next = null,
                o.m_edgeB.prev && (o.m_edgeB.prev.next = o.m_edgeB.next),
                o.m_edgeB.next && (o.m_edgeB.next.prev = o.m_edgeB.prev),
                o.m_edgeB === i.m_jointList && (i.m_jointList = o.m_edgeB.next),
                o.m_edgeB.prev = null,
                o.m_edgeB.next = null,
                box2d.b2JointFactory.Destroy(o, null),
                box2d.ENABLE_ASSERTS && box2d.b2Assert(this.m_jointCount > 0),
                --this.m_jointCount,
                !1 === t)
                for (var n = i.GetContactList(); n;)
                    n.other === e && n.contact.FlagForFiltering(),
    ...
    box2d.b2World.prototype.Solve = function (o) {
        for (var t = this.m_controllerList; t; t = t.m_next)
            t.Step(o);
        this.m_profile.solveInit = 0,
            this.m_profile.solveVelocity = 0,
            this.m_profile.solvePosition = 0;
        var e = this.m_island;
        e.Initialize(this.m_bodyCount, this.m_contactManager.m_contactCount, this.m_jointCount, null, this.m_contactManager.m_contactListener);
        for (var i = this.m_bodyList; i; i = i.m_next)
            i.m_flags &= ~box2d.b2BodyFlag.e_islandFlag;
        for (var n = this.m_contactManager.m_contactList; n; n = n.m_next)
            n.m_flags &= ~box2d.b2ContactFlag.e_islandFlag;
        for (var s = this.m_jointList; s; s = s.m_next)
            s.m_islandFlag = !1;
        for (var r = this.m_bodyCount, b = this.s_stack, a = this.m_bodyList; a; a = a.m_next)
            if (!(a.m_flags & box2d.b2BodyFlag.e_islandFlag) && !1 !== a.IsAwake() && !1 !== a.IsActive() && a.GetType() !== box2d.b2BodyType.b2_staticBody) {
                e.Clear();
                var d = 0;
                for (b[d++] = a,
                    a.m_flags |= box2d.b2BodyFlag.e_islandFlag; d > 0;) {
                    i = b[--d];
                    if (box2d.ENABLE_ASSERTS && box2d.b2Assert(!0 === i.IsActive()),
                        e.AddBody(i),
                        i.SetAwake(!0),
                        i.GetType() !== box2d.b2BodyType.b2_staticBody) {
                        for (var l = i.m_contactList; l; l = l.next) {
                            var x = l.contact;
                            if (!(x.m_flags & box2d.b2ContactFlag.e_islandFlag) && (!1 !== x.IsEnabled() && !1 !== x.IsTouching())) {
                                var p = x.m_fixtureA.m_isSensor
                                    , m = x.m_fixtureB.m_isSensor;
                                if (!p && !m)
                                    e.AddContact(x),
                                        x.m_flags |= box2d.b2ContactFlag.e_islandFlag,
                                        (_ = l.other).m_flags & box2d.b2BodyFlag.e_islandFlag || (box2d.ENABLE_ASSERTS && box2d.b2Assert(d < r),
                                            b[d++] = _,
                                            _.m_flags |= box2d.b2BodyFlag.e_islandFlag)
                            }
                        }
                        for (var h = i.m_jointList; h; h = h.next) {
                            var _;
                            if (!0 !== h.joint.m_islandFlag)
                                !1 !== (_ = h.other).IsActive() && (e.AddJoint(h.joint),
                                    h.joint.m_islandFlag = !0,
                                    _.m_flags & box2d.b2BodyFlag.e_islandFlag || (box2d.ENABLE_ASSERTS && box2d.b2Assert(d < r),
                                        b[d++] = _,
                                        _.m_flags |= box2d.b2BodyFlag.e_islandFlag))
                        }
                    }
                }
                var c = new box2d.b2Profile;
                e.Solve(c, o, this.m_gravity, this.m_allowSleep),
                ...
                for (var y = 0; y < e.m_bodyCount; ++y) {
                    (i = e.m_bodies[y]).GetType() === box2d.b2BodyType.b2_staticBody && (i.m_flags &= ~box2d.b2BodyFlag.e_islandFlag)
                }
            }
        for (y = 0; y < b.length && b[y]; ++y)
            b[y] = null;
        var u = new box2d.b2Timer;
        for (i = this.m_bodyList; i; i = i.m_next)
            0 != (i.m_flags & box2d.b2BodyFlag.e_islandFlag) && i.GetType() !== box2d.b2BodyType.b2_staticBody && i.SynchronizeFixtures();
        this.m_contactManager.FindNewContacts(),
            this.m_profile.broadphase = u.GetMilliseconds()
    }
    ,
    box2d.b2World.prototype.SolveTOI = function (o) {
        ...
        if (t.Initialize(2 * box2d.b2_maxTOIContacts, box2d.b2_maxTOIContacts, 0, null, this.m_contactManager.m_contactListener),
            this.m_stepComplete) {
            for (var e = this.m_bodyList; e; e = e.m_next)
                e.m_flags &= ~box2d.b2BodyFlag.e_islandFlag,
                    e.m_sweep.alpha0 = 0;
            for (var i = this.m_contactManager.m_contactList; i; i = i.m_next)
                i.m_flags &= ~(box2d.b2ContactFlag.e_toiFlag | box2d.b2ContactFlag.e_islandFlag),
                    i.m_toiCount = 0,
                    i.m_toi = 1
        }
        for (; ;) {
            var n = null
                , s = 1;
            for (i = this.m_contactManager.m_contactList; i; i = i.m_next)
                if (!1 !== i.IsEnabled() && !(i.m_toiCount > box2d.b2_maxSubSteps)) {
                    var r = 1;
                    if (i.m_flags & box2d.b2ContactFlag.e_toiFlag)
                        r = i.m_toi;
                    else {
                        var b = i.GetFixtureA()
                            , a = i.GetFixtureB();
                        ...
                        var d = b.GetBody()
                            ...
                            , x = d.m_type
                            , p = l.m_type;
                        box2d.ENABLE_ASSERTS && box2d.b2Assert(x === box2d.b2BodyType.b2_dynamicBody || p === box2d.b2BodyType.b2_dynamicBody);
                        var m = d.IsAwake() && x !== box2d.b2BodyType.b2_staticBody
                            , h = l.IsAwake() && p !== box2d.b2BodyType.b2_staticBody;
                        if (!1 === m && !1 === h)
                            continue;
                        var _ = d.IsBullet() || x !== box2d.b2BodyType.b2_dynamicBody
                            , c = l.IsBullet() || p !== box2d.b2BodyType.b2_dynamicBody;
                        if (!1 === _ && !1 === c)
                            continue;
                        var y = d.m_sweep.alpha0;
                        d.m_sweep.alpha0 < l.m_sweep.alpha0 ? (y = l.m_sweep.alpha0,
                            d.m_sweep.Advance(y)) : l.m_sweep.alpha0 < d.m_sweep.alpha0 && (y = d.m_sweep.alpha0,
                                l.m_sweep.Advance(y)),
                            box2d.ENABLE_ASSERTS && box2d.b2Assert(y < 1);
                        var u = i.GetChildIndexA()
                            , g = i.GetChildIndexB()
                            , f = box2d.b2World.prototype.SolveTOI.s_toi_input;
                        f.proxyA.SetShape(b.GetShape(), u),
                            f.proxyB.SetShape(a.GetShape(), g),
                            f.sweepA.Copy(d.m_sweep),
                            f.sweepB.Copy(l.m_sweep),
                            f.tMax = 1;
                        var S = box2d.b2World.prototype.SolveTOI.s_toi_output;
                        box2d.b2TimeOfImpact(S, f);
                        var A = S.t;
                        r = S.state === box2d.b2TOIOutputState.e_touching ? box2d.b2Min(y + (1 - y) * A, 1) : 1,
                            i.m_toi = r,
                            i.m_flags |= box2d.b2ContactFlag.e_toiFlag
                    }
                    r < s && (n = i,
                        s = r)
                }
            if (null === n || 1 - 10 * box2d.b2_epsilon < s) {
                this.m_stepComplete = !0;
                break
            }
            b = n.GetFixtureA(),
                ...
                d = b.GetBody(),
                l = a.GetBody();
            var C = box2d.b2World.prototype.SolveTOI.s_backup1.Copy(d.m_sweep)
                , v = box2d.b2World.prototype.SolveTOI.s_backup2.Copy(l.m_sweep);
            if (d.Advance(s),
                l.Advance(s),
                n.Update(this.m_contactManager.m_contactListener),
                n.m_flags &= ~box2d.b2ContactFlag.e_toiFlag,
                ++n.m_toiCount,
                !1 !== n.IsEnabled() && !1 !== n.IsTouching()) {
                d.SetAwake(!0),
                    l.SetAwake(!0),
                    t.Clear(),
                    t.AddBody(d),
                    t.AddBody(l),
                    t.AddContact(n),
                    d.m_flags |= box2d.b2BodyFlag.e_islandFlag,
                    l.m_flags |= box2d.b2BodyFlag.e_islandFlag,
                    n.m_flags |= box2d.b2ContactFlag.e_islandFlag;
                for (var V = 0; V < 2; ++V) {
                    if ((R = 0 === V ? d : l).m_type === box2d.b2BodyType.b2_dynamicBody)
                        for (var B = R.m_contactList; B && t.m_bodyCount !== t.m_bodyCapacity && t.m_contactCount !== t.m_contactCapacity; B = B.next) {
                            var w = B.contact;
                            if (!(w.m_flags & box2d.b2ContactFlag.e_islandFlag)) {
                                var P = B.other;
                                if (P.m_type !== box2d.b2BodyType.b2_dynamicBody || !1 !== R.IsBullet() || !1 !== P.IsBullet()) {
                                    var M = w.m_fixtureA.m_isSensor
                                        , D = w.m_fixtureB.m_isSensor;
                                    if (!M && !D) {
                                        var J = box2d.b2World.prototype.SolveTOI.s_backup.Copy(P.m_sweep);
                                        0 == (P.m_flags & box2d.b2BodyFlag.e_islandFlag) && P.Advance(s),
                                            w.Update(this.m_contactManager.m_contactListener),
                                            !1 !== w.IsEnabled() && !1 !== w.IsTouching() ? (w.m_flags |= box2d.b2ContactFlag.e_islandFlag,
                                                t.AddContact(w),
                                                P.m_flags & box2d.b2BodyFlag.e_islandFlag || (P.m_flags |= box2d.b2BodyFlag.e_islandFlag,
                                                    P.m_type !== box2d.b2BodyType.b2_staticBody && P.SetAwake(!0),
                                                    t.AddBody(P))) : (P.m_sweep.Copy(J),
                ...
                var T = box2d.b2World.prototype.SolveTOI.s_subStep;
                T.dt = (1 - s) * o.dt,
                    T.inv_dt = 1 / T.dt,
                    T.dtRatio = 1,
                    T.positionIterations = 20,
                    T.velocityIterations = o.velocityIterations,
                    T.warmStarting = !1,
                    t.SolveTOI(T, d.m_islandIndex, l.m_islandIndex);
                for (V = 0; V < t.m_bodyCount; ++V) {
                    var R;
                    if ((R = t.m_bodies[V]).m_flags &= ~box2d.b2BodyFlag.e_islandFlag,
                        R.m_type === box2d.b2BodyType.b2_dynamicBody) {
                        R.SynchronizeFixtures();
                        for (B = R.m_contactList; B; B = B.next)
                            B.contact.m_flags &= ~(box2d.b2ContactFlag.e_toiFlag | box2d.b2ContactFlag.e_islandFlag)
                    }
                }
                if (this.m_contactManager.FindNewContacts(),
                    this.m_subStepping) {
    ...
    box2d.b2World.prototype.Step = function (o, t, e) {
        var i = new box2d.b2Timer;
        this.m_flags & box2d.b2WorldFlag.e_newFixture && (this.m_contactManager.FindNewContacts(),
            this.m_flags &= ~box2d.b2WorldFlag.e_newFixture),
            this.m_flags |= box2d.b2WorldFlag.e_locked;
        var n = box2d.b2World.prototype.Step.s_step;
        n.dt = o,
            n.velocityIterations = t,
            n.positionIterations = e,
            n.inv_dt = o > 0 ? 1 / o : 0,
            n.dtRatio = this.m_inv_dt0 * o,
            n.warmStarting = this.m_warmStarting;
        var s = new box2d.b2Timer;
        if (this.m_contactManager.Collide(),
            this.m_profile.collide = s.GetMilliseconds(),
            this.m_stepComplete && n.dt > 0) {
            s = new box2d.b2Timer;
            this.Solve(n),
                this.m_profile.solve = s.GetMilliseconds()
        }
        if (this.m_continuousPhysics && n.dt > 0) {
            s = new box2d.b2Timer;
            this.SolveTOI(n),
                this.m_profile.solveTOI = s.GetMilliseconds()
        }
        n.dt > 0 && (this.m_inv_dt0 = n.inv_dt),
            this.m_flags & box2d.b2WorldFlag.e_clearForces && this.ClearForces(),
            this.m_flags &= ~box2d.b2WorldFlag.e_locked,
            this.m_profile.step = i.GetMilliseconds()
    }
    ,
    ...
    box2d.b2World.prototype.QueryAABB = function (o, t) {
        ...
        e.Query(function (t) {
            var i = e.GetUserData(t);
            box2d.ENABLE_ASSERTS && box2d.b2Assert(i instanceof box2d.b2FixtureProxy);
            var n = i.fixture;
            i.childIndex;
            return o instanceof box2d.b2QueryCallback ? o.ReportFixture(n) : o(n)
        }, t)
    }
    ,
    box2d.b2World.prototype.QueryShape = function (o, t, e) {
        var i = this.m_contactManager.m_broadPhase
            , n = box2d.b2World.prototype.QueryShape.s_aabb;
        t.ComputeAABB(n, e, 0),
            i.Query(function (n) {
                var s = i.GetUserData(n);
                box2d.ENABLE_ASSERTS && box2d.b2Assert(s instanceof box2d.b2FixtureProxy);
                var r = s.fixture;
                s.childIndex;
                return !box2d.b2TestOverlapShape(t, 0, r.GetShape(), 0, e, r.GetBody().GetTransform()) || (o instanceof box2d.b2QueryCallback ? o.ReportFixture(r) : o(r))
            }, n)
    }
    ,
    box2d.b2World.prototype.QueryShape.s_aabb = new box2d.b2AABB,
    box2d.b2World.prototype.QueryPoint = function (o, t) {
        var e = this.m_contactManager.m_broadPhase
            , i = box2d.b2World.prototype.QueryPoint.s_aabb;
        i.lowerBound.SetXY(t.x - box2d.b2_linearSlop, t.y - box2d.b2_linearSlop),
            i.upperBound.SetXY(t.x + box2d.b2_linearSlop, t.y + box2d.b2_linearSlop),
            e.Query(function (i) {
                var n = e.GetUserData(i);
                box2d.ENABLE_ASSERTS && box2d.b2Assert(n instanceof box2d.b2FixtureProxy);
                var s = n.fixture;
                n.childIndex;
                return !s.TestPoint(t) || (o instanceof box2d.b2QueryCallback ? o.ReportFixture(s) : o(s))
            }, i)
    }
    ,
    box2d.b2World.prototype.QueryPoint.s_aabb = new box2d.b2AABB,
    box2d.b2World.prototype.RayCast = function (o, t, e) {
        var i = this.m_contactManager.m_broadPhase
            , n = box2d.b2World.prototype.RayCast.s_input;
        n.maxFraction = 1,
            n.p1.Copy(t),
            n.p2.Copy(e),
            i.RayCast(function (n, s) {
                var r = i.GetUserData(s);
                box2d.ENABLE_ASSERTS && box2d.b2Assert(r instanceof box2d.b2FixtureProxy);
                var b = r.fixture
                    , a = r.childIndex
                    , d = box2d.b2World.prototype.RayCast.s_output;
                if (b.RayCast(d, n, a)) {
                    var l = d.fraction
                        , x = box2d.b2World.prototype.RayCast.s_point;
                    return x.SetXY((1 - l) * t.x + l * e.x, (1 - l) * t.y + l * e.y),
                        o instanceof box2d.b2RayCastCallback ? o.ReportFixture(b, x, d.normal, l) : o(b, x, d.normal, l)
                }
    ...
    box2d.b2World.prototype.RayCastOne = function (o, t) {
        var e = null
            , i = 1;
        return this.RayCast(function (o, t, n, s) {
            return s < i && (i = s,
                e = o),
                i
        }, o, t),
    ...
    box2d.b2World.prototype.DrawShape = function (o, t) {
        ...
        switch (e.m_type) {
            case box2d.b2ShapeType.e_circleShape:
                var i = e instanceof box2d.b2CircleShape ? e : null
                    , n = i.m_p
                    , s = i.m_radius
                    , r = box2d.b2Vec2.UNITX;
                this.m_debugDraw.DrawSolidCircle(n, s, r, t);
                break;
            case box2d.b2ShapeType.e_edgeShape:
                var b = e instanceof box2d.b2EdgeShape ? e : null
                    , a = b.m_vertex1
                    , d = b.m_vertex2;
                this.m_debugDraw.DrawSegment(a, d, t);
                break;
            case box2d.b2ShapeType.e_chainShape:
                for (var l = e instanceof box2d.b2ChainShape ? e : null, x = l.m_count, p = (a = (_ = l.m_vertices)[0],
                    0); p < x; ++p) {
                    d = _[p];
                    this.m_debugDraw.DrawSegment(a, d, t),
                        this.m_debugDraw.DrawCircle(d, .05, t),
                        a = d
                }
                break;
            case box2d.b2ShapeType.e_polygonShape:
                var m = e instanceof box2d.b2PolygonShape ? e : null
                    , h = m.m_count
                    , _ = m.m_vertices;
                this.m_debugDraw.DrawSolidPolygon(_, h, t)
        }
    }
    ,
    box2d.b2World.prototype.DrawJoint = function (o) {
        var t = o.GetBodyA()
            ...
            , s = i.p
            , r = n.p
            , b = o.GetAnchorA(box2d.b2World.prototype.DrawJoint.s_p1)
            , a = o.GetAnchorB(box2d.b2World.prototype.DrawJoint.s_p2)
            , d = box2d.b2World.prototype.DrawJoint.s_color.SetRGB(.5, .8, .8);
        switch (o.m_type) {
            case box2d.b2JointType.e_distanceJoint:
                this.m_debugDraw.DrawSegment(b, a, d);
                break;
            case box2d.b2JointType.e_pulleyJoint:
                var l = o instanceof box2d.b2PulleyJoint ? o : null
                    , x = l.GetGroundAnchorA(box2d.b2World.prototype.DrawJoint.s_s1)
                    , p = l.GetGroundAnchorB(box2d.b2World.prototype.DrawJoint.s_s2);
                this.m_debugDraw.DrawSegment(x, b, d),
                    this.m_debugDraw.DrawSegment(p, a, d),
                    this.m_debugDraw.DrawSegment(x, p, d);
                break;
            case box2d.b2JointType.e_mouseJoint:
                this.m_debugDraw.DrawSegment(b, a, d);
                break;
            default:
                this.m_debugDraw.DrawSegment(s, b, d),
                    this.m_debugDraw.DrawSegment(b, a, d),
                    this.m_debugDraw.DrawSegment(r, a, d)
        }
    }
    ,
    box2d.b2World.prototype.DrawJoint.s_p1 = new box2d.b2Vec2,
    box2d.b2World.prototype.DrawJoint.s_p2 = new box2d.b2Vec2,
    box2d.b2World.prototype.DrawJoint.s_color = new box2d.b2Color(.5, .8, .8),
    ...
    box2d.b2World.prototype.DrawDebugData = function () {
        if (null !== this.m_debugDraw) {
            ...
            if (o & box2d.b2DrawFlags.e_shapeBit)
                for (var e = this.m_bodyList; e; e = e.m_next) {
                    var i = e.m_xf;
                    this.m_debugDraw.PushTransform(i);
                    for (var n = e.GetFixtureList(); n; n = n.m_next)
                        !1 === e.IsActive() ? (t.SetRGB(.5, .5, .3),
                            this.DrawShape(n, t)) : e.GetType() === box2d.b2BodyType.b2_staticBody ? (t.SetRGB(.5, .9, .5),
                                this.DrawShape(n, t)) : e.GetType() === box2d.b2BodyType.b2_kinematicBody ? (t.SetRGB(.5, .5, .9),
                                    this.DrawShape(n, t)) : !1 === e.IsAwake() ? (t.SetRGB(.6, .6, .6),
                                        this.DrawShape(n, t)) : (t.SetRGB(.9, .7, .7),
                                            this.DrawShape(n, t));
            ...
            if (o & box2d.b2DrawFlags.e_aabbBit) {
                ...
                for (e = this.m_bodyList; e; e = e.m_next)
                    if (!1 !== e.IsActive())
                        for (n = e.GetFixtureList(); n; n = n.m_next)
                            for (var a = 0; a < n.m_proxyCount; ++a) {
                                var d = n.m_proxies[a]
                                    , l = r.GetFatAABB(d.proxy);
                                b[0].SetXY(l.lowerBound.x, l.lowerBound.y),
                                    b[1].SetXY(l.upperBound.x, l.lowerBound.y),
                                    b[2].SetXY(l.upperBound.x, l.upperBound.y),
                                    b[3].SetXY(l.lowerBound.x, l.upperBound.y),
                                    this.m_debugDraw.DrawPolygon(b, 4, t)
                            }
            }
            if (o & box2d.b2DrawFlags.e_centerOfMassBit)
                for (e = this.m_bodyList; e; e = e.m_next) {
                    (i = box2d.b2World.prototype.DrawDebugData.s_xf).q.Copy(e.m_xf.q),
                        i.p.Copy(e.GetWorldCenter()),
                        this.m_debugDraw.DrawTransform(i)
                }
            if (o & box2d.b2DrawFlags.e_controllerBit)
                for (var x = this.m_controllerList; x; x = x.m_next)
                    x.Draw(this.m_debugDraw)
        }
    }
    ,
    ...
    box2d.b2World.prototype.SetBroadPhase = function (o) {
        var t = this.m_contactManager.m_broadPhase;
        this.m_contactManager.m_broadPhase = o;
        for (var e = this.m_bodyList; e; e = e.m_next)
            for (var i = e.m_fixtureList; i; i = i.m_next)
                i.m_proxy = o.CreateProxy(t.GetFatAABB(i.m_proxy), i)
    }
    ,
    ...
    box2d.b2World.prototype.ShiftOrigin = function (o) {
        if (box2d.ENABLE_ASSERTS && box2d.b2Assert(!1 === this.IsLocked()),
            ...
            for (var t = this.m_bodyList; t; t = t.m_next)
                t.m_xf.p.SelfSub(o),
                    t.m_sweep.c0.SelfSub(o),
                    t.m_sweep.c.SelfSub(o);
            for (var e = this.m_jointList; e; e = e.m_next)
                e.ShiftOrigin(o);
    ...
    box2d.b2World.prototype.Dump = function () {
        if (box2d.DEBUG) {
            ...
            for (var o = 0, t = this.m_bodyList; t; t = t.m_next)
                t.m_islandIndex = o,
                    t.Dump(),
                    ++o;
            o = 0;
            ...
            for (e = this.m_jointList; e; e = e.m_next)
                e.m_type !== box2d.b2JointType.e_gearJoint && (box2d.b2Log("if (true)\n"),
                    box2d.b2Log("{\n"),
                    e.Dump(),
                    box2d.b2Log("}\n"));
            for (e = this.m_jointList; e; e = e.m_next)
    ...
    box2d.b2World.prototype.AddController = function (o) {
        return box2d.ENABLE_ASSERTS && box2d.b2Assert(null === o.m_world, "Controller can only be a member of one world"),
            o.m_world = this,
            o.m_next = this.m_controllerList,
            o.m_prev = null,
            this.m_controllerList && (this.m_controllerList.m_prev = o),
            this.m_controllerList = o,
    ...
    box2d.b2World.prototype.RemoveController = function (o) {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(o.m_world === this, "Controller is not a member of this world"),
            o.m_prev && (o.m_prev.m_next = o.m_next),
            o.m_next && (o.m_next.m_prev = o.m_prev),
            this.m_controllerList === o && (this.m_controllerList = o.m_next),
            --this.m_controllerCount,
            o.m_prev = null,
            o.m_next = null,
            o.m_world = null
    ...
    box2d.b2AreaJointDef = function () {
        goog.base(this, box2d.b2JointType.e_areaJoint),
    ...
    box2d.b2AreaJointDef.prototype.AddBody = function (o) {
        this.bodies.push(o),
            1 === this.bodies.length ? this.bodyA = o : 2 === this.bodies.length && (this.bodyB = o)
    }
    ,
    box2d.b2AreaJoint = function (o) {
        goog.base(this, o),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(o.bodies.length >= 3, "You cannot create an area joint with less than three bodies."),
            this.m_bodies = o.bodies,
            this.m_frequencyHz = o.frequencyHz,
            this.m_dampingRatio = o.dampingRatio,
            this.m_targetLengths = box2d.b2MakeNumberArray(o.bodies.length),
        ...
        t.frequencyHz = o.frequencyHz,
            t.dampingRatio = o.dampingRatio,
            this.m_targetArea = 0;
        for (var e = 0, i = this.m_bodies.length; e < i; ++e) {
            var n = this.m_bodies[e]
                ...
                , r = n.GetWorldCenter()
                , b = s.GetWorldCenter();
            this.m_targetLengths[e] = box2d.b2DistanceVV(r, b),
                this.m_targetArea += box2d.b2CrossVV(r, b),
                t.Initialize(n, s, r, b),
                this.m_joints[e] = o.world.CreateJoint(t)
        }
        this.m_targetArea *= .5
    }
    ,
    ...
    box2d.b2AreaJoint.prototype.SetFrequency = function (o) {
        this.m_frequencyHz = o;
        for (var t = 0, e = this.m_joints.length; t < e; ++t)
            this.m_joints[t].SetFrequency(o)
    }
    ,
    ...
    box2d.b2AreaJoint.prototype.SetDampingRatio = function (o) {
        this.m_dampingRatio = o;
        for (var t = 0, e = this.m_joints.length; t < e; ++t)
            this.m_joints[t].SetDampingRatio(o)
    }
    ,
    ...
    box2d.b2AreaJoint.prototype.InitVelocityConstraints = function (o) {
        for (var t = 0, e = this.m_bodies.length; t < e; ++t) {
            var i = this.m_bodies[(t + e - 1) % e]
                , n = this.m_bodies[(t + 1) % e]
                , s = o.positions[i.m_islandIndex].c
                , r = o.positions[n.m_islandIndex].c
                , b = this.m_deltas[t];
            box2d.b2SubVV(r, s, b)
        }
        if (o.step.warmStarting) {
            this.m_impulse *= o.step.dtRatio;
            for (t = 0,
                e = this.m_bodies.length; t < e; ++t) {
                var a = this.m_bodies[t]
                    , d = o.velocities[a.m_islandIndex].v;
                b = this.m_deltas[t];
                d.x += a.m_invMass * b.y * .5 * this.m_impulse,
                    d.y += a.m_invMass * -b.x * .5 * this.m_impulse
            }
        } else
            this.m_impulse = 0
    }
    ...
    box2d.b2AreaJoint.prototype.SolveVelocityConstraints = function (o) {
        for (var t = 0, e = 0, i = 0, n = this.m_bodies.length; i < n; ++i) {
            var s = this.m_bodies[i]
                , r = o.velocities[s.m_islandIndex].v;
            t += (a = this.m_deltas[i]).GetLengthSquared() / s.GetMass(),
                e += box2d.b2CrossVV(r, a)
        }
        var b = -2 * e / t;
        this.m_impulse += b;
        for (i = 0,
            n = this.m_bodies.length; i < n; ++i) {
            s = this.m_bodies[i],
                r = o.velocities[s.m_islandIndex].v;
            var a = this.m_deltas[i];
            r.x += s.m_invMass * a.y * .5 * b,
                r.y += s.m_invMass * -a.x * .5 * b
        }
    }
    ,
    box2d.b2AreaJoint.prototype.SolvePositionConstraints = function (o) {
        for (var t = 0, e = 0, i = 0, n = this.m_bodies.length; i < n; ++i) {
            var s = this.m_bodies[i]
                , r = this.m_bodies[(i + 1) % n]
                , b = o.positions[s.m_islandIndex].c
                , a = o.positions[r.m_islandIndex].c
                , d = (p = box2d.b2SubVV(a, b, this.m_delta)).GetLength();
            d < box2d.b2_epsilon && (d = 1),
                this.m_normals[i].x = p.y / d,
                this.m_normals[i].y = -p.x / d,
                t += d,
                e += box2d.b2CrossVV(b, a)
        }
        e *= .5;
        var l = .5 * (this.m_targetArea - e) / t
            , x = !0;
        for (i = 0,
            n = this.m_bodies.length; i < n; ++i) {
            s = this.m_bodies[i],
                b = o.positions[s.m_islandIndex].c;
            var p, m = (i + 1) % n;
            (p = box2d.b2AddVV(this.m_normals[i], this.m_normals[m], this.m_delta)).SelfMul(l);
            var h = p.GetLengthSquared();
            h > box2d.b2Sq(box2d.b2_maxLinearCorrection) && p.SelfMul(box2d.b2_maxLinearCorrection / box2d.b2Sqrt(h)),
                h > box2d.b2Sq(box2d.b2_linearSlop) && (x = !1),
                b.x += p.x,
                b.y += p.y
        }
        return x
    ...
    box2d.b2BuoyancyController.prototype.Step = function (o) {
        if (this.m_bodyList) {
            ...
            for (var t = this.m_bodyList; t; t = t.nextBody) {
                var e = t.body;
                if (!1 !== e.IsAwake()) {
                    for (var i = new box2d.b2Vec2, n = new box2d.b2Vec2, s = 0, r = 0, b = e.GetFixtureList(); b; b = b.m_next) {
                        var a = new box2d.b2Vec2
                            , d = b.GetShape().ComputeSubmergedArea(this.normal, this.offset, e.GetTransform(), a);
                        s += d,
                            i.x += d * a.x,
                            i.y += d * a.y;
                        var l = 0;
                        r += d * (l = this.useDensity ? b.GetDensity() : 1),
                            n.x += d * a.x * l,
                            n.y += d * a.y * l
                    }
                    if (i.x /= s,
                        ...
                        n.y /= r,
                        !(s < box2d.b2_epsilon)) {
                        var x = box2d.b2NegV(this.gravity, new box2d.b2Vec2);
                        x.SelfMul(this.density * s),
                            e.ApplyForce(x, n);
                        var p = e.GetLinearVelocityFromWorldPoint(i, new box2d.b2Vec2);
                        p.SelfSub(this.velocity),
                            p.SelfMul(-this.linearDrag * s),
                            e.ApplyForce(p, i),
    ...
    box2d.b2BuoyancyController.prototype.Draw = function (o) {
        var t = 100
            , e = new box2d.b2Vec2
            , i = new box2d.b2Vec2;
        e.x = this.normal.x * this.offset + this.normal.y * t,
            e.y = this.normal.y * this.offset - this.normal.x * t,
            i.x = this.normal.x * this.offset - this.normal.y * t,
            i.y = this.normal.y * this.offset + this.normal.x * t;
        var n = new box2d.b2Color(0, 0, .8);
        o.DrawSegment(e, i, n)
    }
    ,
    ...
    box2d.b2TensorDampingController.prototype.Step = function (o) {
        ...
        if (!(t <= box2d.b2_epsilon)) {
            ...
            for (var e = this.m_bodyList; e; e = e.nextBody) {
                var i = e.body;
                if (i.IsAwake()) {
                    var n = i.GetWorldVector(box2d.b2MulMV(this.T, i.GetLocalVector(i.GetLinearVelocity(), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t1), box2d.b2TensorDampingController.prototype.Step.s_damping);
                    i.SetLinearVelocity(box2d.b2AddVV(i.GetLinearVelocity(), box2d.b2MulSV(t, n, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t1))
                }
            }
        }
    }
    ...
    box2d.b2TensorDampingController.prototype.SetAxisAligned = function (o, t) {
        this.T.ex.x = -o,
            ...
            this.T.ey.x = 0,
            this.T.ey.y = -t,
            this.maxTimestep = o > 0 || t > 0 ? 1 / box2d.b2Max(o, t) : 0
    }
    ,
    ...
    box2d.b2DistanceJointDef = function () {
        goog.base(this, box2d.b2JointType.e_distanceJoint),
            this.localAnchorA = new box2d.b2Vec2,
            this.localAnchorB = new box2d.b2Vec2
    }
    ,
    ...
    box2d.b2DistanceJointDef.prototype.Initialize = function (o, t, e, i) {
        this.bodyA = o,
            this.bodyB = t,
            this.bodyA.GetLocalPoint(e, this.localAnchorA),
            this.bodyB.GetLocalPoint(i, this.localAnchorB),
            this.length = box2d.b2DistanceVV(e, i),
            this.frequencyHz = 0,
            this.dampingRatio = 0
    }
    ,
    ...
    box2d.b2DistanceJoint.prototype.GetReactionForce = function (o, t) {
        return t.SetXY(o * this.m_impulse * this.m_u.x, o * this.m_impulse * this.m_u.y)
    }
    ,
    ...
    box2d.b2DistanceJoint.prototype.InitVelocityConstraints = function (o) {
        ...
        box2d.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA),
            ...
            box2d.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB),
            box2d.b2MulRV(l, this.m_lalcB, this.m_rB),
            this.m_u.x = s.x + this.m_rB.x - t.x - this.m_rA.x,
            this.m_u.y = s.y + this.m_rB.y - t.y - this.m_rA.y;
        var x = this.m_u.GetLength();
        x > box2d.b2_linearSlop ? this.m_u.SelfMul(1 / x) : this.m_u.SetZero();
        var p = box2d.b2CrossVV(this.m_rA, this.m_u)
            , m = box2d.b2CrossVV(this.m_rB, this.m_u)
            , h = this.m_invMassA + this.m_invIA * p * p + this.m_invMassB + this.m_invIB * m * m;
        if (this.m_mass = 0 !== h ? 1 / h : 0,
            this.m_frequencyHz > 0) {
            var _ = x - this.m_length
                , c = 2 * box2d.b2_pi * this.m_frequencyHz
                , y = 2 * this.m_mass * this.m_dampingRatio * c
                , u = this.m_mass * c * c
                , g = o.step.dt;
            this.m_gamma = g * (y + g * u),
                this.m_gamma = 0 !== this.m_gamma ? 1 / this.m_gamma : 0,
                this.m_bias = _ * g * u * this.m_gamma,
                h += this.m_gamma,
        ...
        if (o.step.warmStarting) {
            this.m_impulse *= o.step.dtRatio;
            var f = box2d.b2MulSV(this.m_impulse, this.m_u, box2d.b2DistanceJoint.prototype.InitVelocityConstraints.s_P);
            i.SelfMulSub(this.m_invMassA, f),
                n -= this.m_invIA * box2d.b2CrossVV(this.m_rA, f),
                b.SelfMulAdd(this.m_invMassB, f),
                a += this.m_invIB * box2d.b2CrossVV(this.m_rB, f)
        } else
            this.m_impulse = 0;
        o.velocities[this.m_indexA].w = n,
            o.velocities[this.m_indexB].w = a
    ...
    box2d.b2DistanceJoint.prototype.SolveVelocityConstraints = function (o) {
        var t = o.velocities[this.m_indexA].v
            ...
            , i = o.velocities[this.m_indexB].v
            , n = o.velocities[this.m_indexB].w
            , s = box2d.b2AddVCrossSV(t, e, this.m_rA, box2d.b2DistanceJoint.prototype.SolveVelocityConstraints.s_vpA)
            , r = box2d.b2AddVCrossSV(i, n, this.m_rB, box2d.b2DistanceJoint.prototype.SolveVelocityConstraints.s_vpB)
            , b = box2d.b2DotVV(this.m_u, box2d.b2SubVV(r, s, box2d.b2Vec2.s_t0))
            , a = -this.m_mass * (b + this.m_bias + this.m_gamma * this.m_impulse);
        this.m_impulse += a;
        var d = box2d.b2MulSV(a, this.m_u, box2d.b2DistanceJoint.prototype.SolveVelocityConstraints.s_P);
        t.SelfMulSub(this.m_invMassA, d),
            e -= this.m_invIA * box2d.b2CrossVV(this.m_rA, d),
            i.SelfMulAdd(this.m_invMassB, d),
            n += this.m_invIB * box2d.b2CrossVV(this.m_rB, d),
            o.velocities[this.m_indexA].w = e,
            o.velocities[this.m_indexB].w = n
    }
    ,
    ...
    box2d.b2DistanceJoint.prototype.SolvePositionConstraints = function (o) {
        ...
        var t = o.positions[this.m_indexA].c
            ...
            , n = o.positions[this.m_indexB].a
            , s = (this.m_qA.SetAngleRadians(e),
                this.m_qB.SetAngleRadians(n),
                box2d.b2MulRV(this.m_qA, this.m_lalcA, this.m_rA))
            , r = box2d.b2MulRV(this.m_qB, this.m_lalcB, this.m_rB)
            , b = this.m_u;
        b.x = i.x + r.x - t.x - s.x,
            b.y = i.y + r.y - t.y - s.y;
        var a = this.m_u.Normalize() - this.m_length;
        a = box2d.b2Clamp(a, -box2d.b2_maxLinearCorrection, box2d.b2_maxLinearCorrection);
        var d = -this.m_mass * a
            , l = box2d.b2MulSV(d, b, box2d.b2DistanceJoint.prototype.SolvePositionConstraints.s_P);
        return t.SelfMulSub(this.m_invMassA, l),
            e -= this.m_invIA * box2d.b2CrossVV(s, l),
            i.SelfMulAdd(this.m_invMassB, l),
            n += this.m_invIB * box2d.b2CrossVV(r, l),
            o.positions[this.m_indexA].a = e,
            o.positions[this.m_indexB].a = n,
            box2d.b2Abs(a) < box2d.b2_linearSlop
    }
    ,
    ...
    box2d.b2FrictionJointDef = function () {
        goog.base(this, box2d.b2JointType.e_frictionJoint),
            this.localAnchorA = new box2d.b2Vec2,
            this.localAnchorB = new box2d.b2Vec2
    }
    ,
    ...
    box2d.b2FrictionJoint = function (o) {
        goog.base(this, o),
            ...
            this.m_maxForce = o.maxForce,
            this.m_maxTorque = o.maxTorque,
            this.m_rA = new box2d.b2Vec2,
            this.m_rB = new box2d.b2Vec2,
            this.m_localCenterA = new box2d.b2Vec2,
            this.m_localCenterB = new box2d.b2Vec2,
    ...
    box2d.b2FrictionJoint.prototype.InitVelocityConstraints = function (o) {
        ...
        var t = o.positions[this.m_indexA].a
            ...
            , a = this.m_qB.SetAngleRadians(n);
        box2d.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
        var d = box2d.b2MulRV(b, this.m_lalcA, this.m_rA);
        box2d.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
        var l = box2d.b2MulRV(a, this.m_lalcB, this.m_rB)
            , x = this.m_invMassA
            , p = this.m_invMassB
            , m = this.m_invIA
            , h = this.m_invIB
            , _ = this.m_K;
        if (_.ex.x = x + p + m * d.y * d.y + h * l.y * l.y,
            _.ex.y = -m * d.x * d.y - h * l.x * l.y,
            _.ey.x = _.ex.y,
            _.ey.y = x + p + m * d.x * d.x + h * l.x * l.x,
            _.GetInverse(this.m_linearMass),
            this.m_angularMass = m + h,
            this.m_angularMass > 0 && (this.m_angularMass = 1 / this.m_angularMass),
            o.step.warmStarting) {
            this.m_linearImpulse.SelfMul(o.step.dtRatio),
                this.m_angularImpulse *= o.step.dtRatio;
            var c = this.m_linearImpulse;
            e.SelfMulSub(x, c),
                i -= m * (box2d.b2CrossVV(this.m_rA, c) + this.m_angularImpulse),
                s.SelfMulAdd(p, c),
                r += h * (box2d.b2CrossVV(this.m_rB, c) + this.m_angularImpulse)
        } else
    ...
    box2d.b2FrictionJoint.prototype.SolveVelocityConstraints = function (o) {
        var t = o.velocities[this.m_indexA].v
            ...
            , d = o.step.dt
            , l = n - e
            , x = -this.m_angularMass * l
            , p = this.m_angularImpulse
            , m = d * this.m_maxTorque;
        this.m_angularImpulse = box2d.b2Clamp(this.m_angularImpulse + x, -m, m),
            e -= b * (x = this.m_angularImpulse - p),
            n += a * x;
        l = box2d.b2SubVV(box2d.b2AddVCrossSV(i, n, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddVCrossSV(t, e, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2FrictionJoint.prototype.SolveVelocityConstraints.s_Cdot);
        var h = box2d.b2MulMV(this.m_linearMass, l, box2d.b2FrictionJoint.prototype.SolveVelocityConstraints.s_impulseV).SelfNeg()
            , _ = box2d.b2FrictionJoint.prototype.SolveVelocityConstraints.s_oldImpulseV.Copy(this.m_linearImpulse);
        this.m_linearImpulse.SelfAdd(h);
        m = d * this.m_maxForce;
        this.m_linearImpulse.GetLengthSquared() > m * m && (this.m_linearImpulse.Normalize(),
            this.m_linearImpulse.SelfMul(m)),
            box2d.b2SubVV(this.m_linearImpulse, _, h),
            t.SelfMulSub(s, h),
            e -= b * box2d.b2CrossVV(this.m_rA, h),
            i.SelfMulAdd(r, h),
            n += a * box2d.b2CrossVV(this.m_rB, h),
            o.velocities[this.m_indexA].w = e,
            o.velocities[this.m_indexB].w = n
    }
    ,
    ...
    box2d.b2FrictionJoint.prototype.GetReactionForce = function (o, t) {
        return t.SetXY(o * this.m_linearImpulse.x, o * this.m_linearImpulse.y)
    }
    ,
    ...
    box2d.b2MouseJointDef = function () {
        goog.base(this, box2d.b2JointType.e_mouseJoint),
    ...
    box2d.b2MouseJointDef.prototype.dampingRatio = .7,
    box2d.b2MouseJoint = function (o) {
        goog.base(this, o),
            ...
            this.m_lalcB = new box2d.b2Vec2,
            this.m_K = new box2d.b2Mat22,
            box2d.ENABLE_ASSERTS && box2d.b2Assert(o.target.IsValid()),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(box2d.b2IsValid(o.maxForce) && o.maxForce >= 0),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(box2d.b2IsValid(o.frequencyHz) && o.frequencyHz >= 0),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(box2d.b2IsValid(o.dampingRatio) && o.dampingRatio >= 0),
            this.m_targetA.Copy(o.target),
    ...
    box2d.b2MouseJoint.prototype.InitVelocityConstraints = function (o) {
        ...
        var t = o.positions[this.m_indexB].c
            , e = o.positions[this.m_indexB].a
            , i = o.velocities[this.m_indexB].v
            , n = o.velocities[this.m_indexB].w
            , s = this.m_qB.SetAngleRadians(e)
            , r = this.m_bodyB.GetMass()
            , b = 2 * box2d.b2_pi * this.m_frequencyHz
            , a = 2 * r * this.m_dampingRatio * b
            , d = r * (b * b)
            , l = o.step.dt;
        box2d.ENABLE_ASSERTS && box2d.b2Assert(a + l * d > box2d.b2_epsilon),
            this.m_gamma = l * (a + l * d),
            0 !== this.m_gamma && (this.m_gamma = 1 / this.m_gamma),
            this.m_beta = l * d * this.m_gamma,
            box2d.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB),
            box2d.b2MulRV(s, this.m_lalcB, this.m_rB);
        var x = this.m_K;
        x.ex.x = this.m_invMassB + this.m_invIB * this.m_rB.y * this.m_rB.y + this.m_gamma,
            x.ex.y = -this.m_invIB * this.m_rB.x * this.m_rB.y,
            x.ey.x = x.ex.y,
            x.ey.y = this.m_invMassB + this.m_invIB * this.m_rB.x * this.m_rB.x + this.m_gamma,
            x.GetInverse(this.m_mass),
            this.m_C.x = t.x + this.m_rB.x - this.m_targetA.x,
            this.m_C.y = t.y + this.m_rB.y - this.m_targetA.y,
            this.m_C.SelfMul(this.m_beta),
            n *= .98,
            o.step.warmStarting ? (this.m_impulse.SelfMul(o.step.dtRatio),
                i.x += this.m_invMassB * this.m_impulse.x,
                i.y += this.m_invMassB * this.m_impulse.y,
                n += this.m_invIB * box2d.b2CrossVV(this.m_rB, this.m_impulse)) : this.m_impulse.SetZero(),
            o.velocities[this.m_indexB].w = n
    }
    ,
    box2d.b2MouseJoint.prototype.SolveVelocityConstraints = function (o) {
        var t = o.velocities[this.m_indexB].v
            ...
            , i = box2d.b2AddVCrossSV(t, e, this.m_rB, box2d.b2MouseJoint.prototype.SolveVelocityConstraints.s_Cdot)
            , n = box2d.b2MulMV(this.m_mass, box2d.b2AddVV(i, box2d.b2AddVV(this.m_C, box2d.b2MulSV(this.m_gamma, this.m_impulse, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0).SelfNeg(), box2d.b2MouseJoint.prototype.SolveVelocityConstraints.s_impulse)
            , s = box2d.b2MouseJoint.prototype.SolveVelocityConstraints.s_oldImpulse.Copy(this.m_impulse);
        this.m_impulse.SelfAdd(n);
        var r = o.step.dt * this.m_maxForce;
        this.m_impulse.GetLengthSquared() > r * r && this.m_impulse.SelfMul(r / this.m_impulse.GetLength()),
            box2d.b2SubVV(this.m_impulse, s, n),
            t.SelfMulAdd(this.m_invMassB, n),
            e += this.m_invIB * box2d.b2CrossVV(this.m_rB, n),
    ...
    box2d.b2MouseJoint.prototype.GetReactionForce = function (o, t) {
        return box2d.b2MulSV(o, this.m_impulse, t)
    }
    ,
    ...
    box2d.b2PulleyJointDef.prototype.Initialize = function (o, t, e, i, n, s, r) {
        this.bodyA = o,
            this.bodyB = t,
            this.groundAnchorA.Copy(e),
            this.groundAnchorB.Copy(i),
            this.bodyA.GetLocalPoint(n, this.localAnchorA),
            this.bodyB.GetLocalPoint(s, this.localAnchorB),
            this.lengthA = box2d.b2DistanceVV(n, e),
            this.lengthB = box2d.b2DistanceVV(s, i),
            this.ratio = r,
    ...
    box2d.b2PulleyJoint = function (o) {
        goog.base(this, o),
            ...
            this.m_lalcA = new box2d.b2Vec2,
            this.m_lalcB = new box2d.b2Vec2,
            this.m_groundAnchorA.Copy(o.groundAnchorA),
            this.m_groundAnchorB.Copy(o.groundAnchorB),
            this.m_localAnchorA.Copy(o.localAnchorA),
            this.m_localAnchorB.Copy(o.localAnchorB),
            this.m_lengthA = o.lengthA,
            this.m_lengthB = o.lengthB,
            box2d.ENABLE_ASSERTS && box2d.b2Assert(0 !== o.ratio),
            this.m_ratio = o.ratio,
            this.m_constant = o.lengthA + this.m_ratio * o.lengthB,
            this.m_impulse = 0
    }
    ,
...
box2d.b2PulleyJoint.prototype.InitVelocityConstraints = function (o) {
    ...
    box2d.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA),
        ...
        box2d.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB),
        box2d.b2MulRV(l, this.m_lalcB, this.m_rB),
        this.m_uA.Copy(t).SelfAdd(this.m_rA).SelfSub(this.m_groundAnchorA),
        this.m_uB.Copy(s).SelfAdd(this.m_rB).SelfSub(this.m_groundAnchorB);
    var x = this.m_uA.GetLength()
        , p = this.m_uB.GetLength();
    x > 10 * box2d.b2_linearSlop ? this.m_uA.SelfMul(1 / x) : this.m_uA.SetZero(),
        p > 10 * box2d.b2_linearSlop ? this.m_uB.SelfMul(1 / p) : this.m_uB.SetZero();
    var m = box2d.b2CrossVV(this.m_rA, this.m_uA)
        , h = box2d.b2CrossVV(this.m_rB, this.m_uB)
        , _ = this.m_invMassA + this.m_invIA * m * m
        , c = this.m_invMassB + this.m_invIB * h * h;
    if (this.m_mass = _ + this.m_ratio * this.m_ratio * c,
        this.m_mass > 0 && (this.m_mass = 1 / this.m_mass),
        o.step.warmStarting) {
        this.m_impulse *= o.step.dtRatio;
        var y = box2d.b2MulSV(-this.m_impulse, this.m_uA, box2d.b2PulleyJoint.prototype.InitVelocityConstraints.s_PA)
            , u = box2d.b2MulSV(-this.m_ratio * this.m_impulse, this.m_uB, box2d.b2PulleyJoint.prototype.InitVelocityConstraints.s_PB);
        i.SelfMulAdd(this.m_invMassA, y),
            n += this.m_invIA * box2d.b2CrossVV(this.m_rA, y),
            b.SelfMulAdd(this.m_invMassB, u),
            a += this.m_invIB * box2d.b2CrossVV(this.m_rB, u)
    } else
        this.m_impulse = 0;
    o.velocities[this.m_indexA].w = n,
        o.velocities[this.m_indexB].w = a
    ...
    box2d.b2PulleyJoint.prototype.SolveVelocityConstraints = function (o) {
        var t = o.velocities[this.m_indexA].v
            ...
            , i = o.velocities[this.m_indexB].v
            , n = o.velocities[this.m_indexB].w
            , s = box2d.b2AddVCrossSV(t, e, this.m_rA, box2d.b2PulleyJoint.prototype.SolveVelocityConstraints.s_vpA)
            , r = box2d.b2AddVCrossSV(i, n, this.m_rB, box2d.b2PulleyJoint.prototype.SolveVelocityConstraints.s_vpB)
            , b = -box2d.b2DotVV(this.m_uA, s) - this.m_ratio * box2d.b2DotVV(this.m_uB, r)
            , a = -this.m_mass * b;
        this.m_impulse += a;
        var d = box2d.b2MulSV(-a, this.m_uA, box2d.b2PulleyJoint.prototype.SolveVelocityConstraints.s_PA)
            , l = box2d.b2MulSV(-this.m_ratio * a, this.m_uB, box2d.b2PulleyJoint.prototype.SolveVelocityConstraints.s_PB);
        t.SelfMulAdd(this.m_invMassA, d),
            e += this.m_invIA * box2d.b2CrossVV(this.m_rA, d),
            i.SelfMulAdd(this.m_invMassB, l),
            n += this.m_invIB * box2d.b2CrossVV(this.m_rB, l),
            o.velocities[this.m_indexA].w = e,
            o.velocities[this.m_indexB].w = n
    }
    ,
    ...
    box2d.b2PulleyJoint.prototype.SolvePositionConstraints = function (o) {
        ...
        box2d.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
        var a = box2d.b2MulRV(r, this.m_lalcB, this.m_rB)
            , d = this.m_uA.Copy(t).SelfAdd(b).SelfSub(this.m_groundAnchorA)
            , l = this.m_uB.Copy(i).SelfAdd(a).SelfSub(this.m_groundAnchorB)
            , x = d.GetLength()
            , p = l.GetLength();
        x > 10 * box2d.b2_linearSlop ? d.SelfMul(1 / x) : d.SetZero(),
            p > 10 * box2d.b2_linearSlop ? l.SelfMul(1 / p) : l.SetZero();
        var m = box2d.b2CrossVV(b, d)
            , h = box2d.b2CrossVV(a, l)
            , _ = this.m_invMassA + this.m_invIA * m * m
            , c = this.m_invMassB + this.m_invIB * h * h
            , y = _ + this.m_ratio * this.m_ratio * c;
        y > 0 && (y = 1 / y);
        var u = this.m_constant - x - this.m_ratio * p
            , g = box2d.b2Abs(u)
            , f = -y * u
            , S = box2d.b2MulSV(-f, d, box2d.b2PulleyJoint.prototype.SolvePositionConstraints.s_PA)
            , A = box2d.b2MulSV(-this.m_ratio * f, l, box2d.b2PulleyJoint.prototype.SolvePositionConstraints.s_PB);
        return t.SelfMulAdd(this.m_invMassA, S),
            e += this.m_invIA * box2d.b2CrossVV(b, S),
            i.SelfMulAdd(this.m_invMassB, A),
            n += this.m_invIB * box2d.b2CrossVV(a, A),
            o.positions[this.m_indexA].a = e,
            o.positions[this.m_indexB].a = n,
            g < box2d.b2_linearSlop
    }
    ,
    ...
    box2d.b2PulleyJoint.prototype.GetReactionForce = function (o, t) {
        return t.SetXY(o * this.m_impulse * this.m_uB.x, o * this.m_impulse * this.m_uB.y)
    }
    ,
    ...
    box2d.b2PulleyJoint.prototype.GetCurrentLengthA = function () {
        var o = this.m_bodyA.GetWorldPoint(this.m_localAnchorA, box2d.b2PulleyJoint.prototype.GetCurrentLengthA.s_p)
            , t = this.m_groundAnchorA;
        return box2d.b2DistanceVV(o, t)
    }
    ,
    ...
    box2d.b2PulleyJoint.prototype.ShiftOrigin = function (o) {
        this.m_groundAnchorA.SelfSub(o),
            this.m_groundAnchorB.SelfSub(o)
    }
    ,
    goog.provide("box2d.b2CircleShape"),
    goog.require("box2d.b2Shape"),
    box2d.b2CircleShape = function (o) {
        goog.base(this, box2d.b2ShapeType.e_circleShape, o || 0),
    ...
    box2d.b2CircleShape.prototype.Copy = function (o) {
        return goog.base(this, "Copy", o),
            box2d.ENABLE_ASSERTS && box2d.b2Assert(o instanceof box2d.b2CircleShape),
            this.m_p.Copy(o.m_p),
            this
    }
    ,
    ...
    box2d.b2CircleShape.prototype.TestPoint = function (o, t) {
        var e = box2d.b2MulXV(o, this.m_p, box2d.b2CircleShape.prototype.TestPoint.s_center)
            , i = box2d.b2SubVV(t, e, box2d.b2CircleShape.prototype.TestPoint.s_d);
        return box2d.b2DotVV(i, i) <= box2d.b2Sq(this.m_radius)
    }
    ,
    ...
    box2d.b2CircleShape.prototype.RayCast = function (o, t, e, i) {
        var n = box2d.b2MulXV(e, this.m_p, box2d.b2CircleShape.prototype.RayCast.s_position)
            , s = box2d.b2SubVV(t.p1, n, box2d.b2CircleShape.prototype.RayCast.s_s)
            , r = box2d.b2DotVV(s, s) - box2d.b2Sq(this.m_radius)
            , b = box2d.b2SubVV(t.p2, t.p1, box2d.b2CircleShape.prototype.RayCast.s_r)
            , a = box2d.b2DotVV(s, b)
            , d = box2d.b2DotVV(b, b)
            , l = a * a - d * r;
        if (l < 0 || d < box2d.b2_epsilon)
            return !1;
        var x = -(a + box2d.b2Sqrt(l));
        return 0 <= x && x <= t.maxFraction * d && (x /= d,
            o.fraction = x,
            box2d.b2AddVMulSV(s, x, b, o.normal).SelfNormalize(),
            !0)
    }
    ,
    ...
    box2d.b2CircleShape.prototype.ComputeAABB = function (o, t, e) {
        var i = box2d.b2MulXV(t, this.m_p, box2d.b2CircleShape.prototype.ComputeAABB.s_p);
        o.lowerBound.SetXY(i.x - this.m_radius, i.y - this.m_radius),
            o.upperBound.SetXY(i.x + this.m_radius, i.y + this.m_radius)
    }
    ,
    box2d.b2CircleShape.prototype.ComputeAABB.s_p = new box2d.b2Vec2,
    box2d.b2CircleShape.prototype.ComputeMass = function (o, t) {
        var e = box2d.b2Sq(this.m_radius);
        o.mass = t * box2d.b2_pi * e,
            o.center.Copy(this.m_p),
            o.I = o.mass * (.5 * e + box2d.b2DotVV(this.m_p, this.m_p))
    }
    ,
    box2d.b2CircleShape.prototype.SetupDistanceProxy = function (o, t) {
        o.m_vertices = new Array(1, !0),
            o.m_vertices[0] = this.m_p,
            o.m_count = 1,
            o.m_radius = this.m_radius
    }
    ,
    box2d.b2CircleShape.prototype.ComputeSubmergedArea = function (o, t, e, i) {
        var n = box2d.b2MulXV(e, this.m_p, new box2d.b2Vec2)
            , s = -(box2d.b2DotVV(o, n) - t);
        if (s < -this.m_radius + box2d.b2_epsilon)
            return 0;
        if (s > this.m_radius)
            return i.Copy(n),
                box2d.b2_pi * this.m_radius * this.m_radius;
        var r = this.m_radius * this.m_radius
            , b = s * s
            , a = r * (box2d.b2Asin(s / this.m_radius) + box2d.b2_pi / 2) + s * box2d.b2Sqrt(r - b)
            , d = -2 / 3 * box2d.b2Pow(r - b, 1.5) / a;
        return i.x = n.x + o.x * d,
            i.y = n.y + o.y * d,
            a
    }
    ,
    ...
    box2d.b2RopeDef.prototype.damping = .1,
    box2d.b2RopeDef.prototype.k2 = .9,
    box2d.b2RopeDef.prototype.k3 = .1,
    ...
    box2d.b2Rope.prototype.Initialize = function (o) {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(o.count >= 3),
            this.m_count = o.count,
        ...
        for (var t = 0; t < this.m_count; ++t) {
            this.m_ps[t].Copy(o.vertices[t]),
                this.m_p0s[t].Copy(o.vertices[t]),
                this.m_vs[t].SetZero();
            var e = o.masses[t];
            this.m_ims[t] = e > 0 ? 1 / e : 0
        }
        var i = this.m_count - 1
            , n = this.m_count - 2;
        this.m_Ls = box2d.b2MakeNumberArray(i),
            this.m_as = box2d.b2MakeNumberArray(n);
        for (t = 0; t < i; ++t) {
            var s = this.m_ps[t]
                , r = this.m_ps[t + 1];
            this.m_Ls[t] = box2d.b2DistanceVV(s, r)
        }
        for (t = 0; t < n; ++t) {
            s = this.m_ps[t],
                r = this.m_ps[t + 1];
            var b = this.m_ps[t + 2]
                , a = box2d.b2SubVV(r, s, box2d.b2Vec2.s_t0)
                , d = box2d.b2SubVV(b, r, box2d.b2Vec2.s_t1)
                , l = box2d.b2CrossVV(a, d)
                , x = box2d.b2DotVV(a, d);
            this.m_as[t] = box2d.b2Atan2(l, x)
        }
        this.m_gravity.Copy(o.gravity),
            this.m_damping = o.damping,
            this.m_k2 = o.k2,
            this.m_k3 = o.k3
    }
    ,
    box2d.b2Rope.prototype.Step = function (o, t) {
        if (0 !== o) {
            for (var e = Math.exp(-o * this.m_damping), i = 0; i < this.m_count; ++i)
                this.m_p0s[i].Copy(this.m_ps[i]),
                    this.m_ims[i] > 0 && this.m_vs[i].SelfMulAdd(o, this.m_gravity),
                    this.m_vs[i].SelfMul(e),
                    this.m_ps[i].SelfMulAdd(o, this.m_vs[i]);
            for (i = 0; i < t; ++i)
                this.SolveC2(),
                    this.SolveC3(),
                    this.SolveC2();
            ...
            for (i = 0; i < this.m_count; ++i)
                box2d.b2MulSV(n, box2d.b2SubVV(this.m_ps[i], this.m_p0s[i], box2d.b2Vec2.s_t0), this.m_vs[i])
        }
    }
    ,
    box2d.b2Rope.prototype.SolveC2 = function () {
        for (var o = this.m_count - 1, t = 0; t < o; ++t) {
            var e = this.m_ps[t]
                , i = this.m_ps[t + 1]
                , n = box2d.b2SubVV(i, e, box2d.b2Rope.s_d)
                , s = n.Normalize()
                , r = this.m_ims[t]
                , b = this.m_ims[t + 1];
            if (r + b !== 0) {
                var a = r / (r + b)
                    , d = b / (r + b);
                e.SelfMulSub(this.m_k2 * a * (this.m_Ls[t] - s), n),
                    i.SelfMulAdd(this.m_k2 * d * (this.m_Ls[t] - s), n)
            }
        }
    }
    ,
    box2d.b2Rope.s_d = new box2d.b2Vec2,
    box2d.b2Rope.prototype.SetAngleRadians = function (o) {
    ...
    box2d.b2Rope.prototype.SolveC3 = function () {
        for (var o = this.m_count - 2, t = 0; t < o; ++t) {
            var e = this.m_ps[t]
                ...
                , r = this.m_ims[t + 1]
                , b = this.m_ims[t + 2]
                , a = box2d.b2SubVV(i, e, box2d.b2Rope.s_d1)
                , d = box2d.b2SubVV(n, i, box2d.b2Rope.s_d2)
                , l = a.GetLengthSquared()
                , x = d.GetLengthSquared();
            if (l * x != 0) {
                var p = box2d.b2CrossVV(a, d)
                    , m = box2d.b2DotVV(a, d)
                    , h = box2d.b2Atan2(p, m)
                    , _ = box2d.b2MulSV(-1 / l, a.SelfSkew(), box2d.b2Rope.s_Jd1)
                    , c = box2d.b2MulSV(1 / x, d.SelfSkew(), box2d.b2Rope.s_Jd2)
                    , y = box2d.b2NegV(_, box2d.b2Rope.s_J1)
                    , u = box2d.b2SubVV(_, c, box2d.b2Rope.s_J2)
                    , g = c
                    , f = s * box2d.b2DotVV(y, y) + r * box2d.b2DotVV(u, u) + b * box2d.b2DotVV(g, g);
                if (0 !== f) {
                    f = 1 / f;
                    for (var S = h - this.m_as[t]; S > box2d.b2_pi;)
                        S = (h -= 2 * box2d.b2_pi) - this.m_as[t];
                    for (; S < -box2d.b2_pi;)
                        S = (h += 2 * box2d.b2_pi) - this.m_as[t];
                    var A = -this.m_k3 * f * S;
                    e.SelfMulAdd(s * A, y),
    ...
    box2d.b2Rope.prototype.Draw = function (o) {
        for (var t = new box2d.b2Color(.4, .5, .7), e = 0; e < this.m_count - 1; ++e)
            o.DrawSegment(this.m_ps[e], this.m_ps[e + 1], t)
    }
    ,
    ...
    box2d.b2WheelJointDef = function () {
        goog.base(this, box2d.b2JointType.e_wheelJoint),
            this.localAnchorA = new box2d.b2Vec2(0, 0),
            this.localAnchorB = new box2d.b2Vec2(0, 0),
            this.localAxisA = new box2d.b2Vec2(1, 0)
    }
    ...
    box2d.b2WheelJointDef.prototype.dampingRatio = .7,
    box2d.b2WheelJointDef.prototype.Initialize = function (o, t, e, i) {
        this.bodyA = o,
            this.bodyB = t,
            this.bodyA.GetLocalPoint(e, this.localAnchorA),
            this.bodyB.GetLocalPoint(e, this.localAnchorB),
    ...
    box2d.b2WheelJoint = function (o) {
        goog.base(this, o),
            ...
            this.m_localAnchorA = o.localAnchorA.Clone(),
            this.m_localAnchorB = o.localAnchorB.Clone(),
            this.m_localXAxisA = o.localAxisA.Clone(),
            this.m_localYAxisA = box2d.b2CrossOneV(this.m_localXAxisA, new box2d.b2Vec2),
            this.m_maxMotorTorque = o.maxMotorTorque,
            this.m_motorSpeed = o.motorSpeed,
            this.m_enableMotor = o.enableMotor,
    ...
    box2d.b2WheelJoint.prototype.InitVelocityConstraints = function (o) {
        ...
        var t = this.m_invMassA
            ...
            , i = this.m_invIA
            , n = this.m_invIB
            , s = o.positions[this.m_indexA].c
            , r = o.positions[this.m_indexA].a
            , b = o.velocities[this.m_indexA].v
            , a = o.velocities[this.m_indexA].w
            , d = o.positions[this.m_indexB].c
            , l = o.positions[this.m_indexB].a
            , x = o.velocities[this.m_indexB].v
            , p = o.velocities[this.m_indexB].w
            , m = this.m_qA.SetAngleRadians(r)
            , h = this.m_qB.SetAngleRadians(l);
        box2d.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
        var _ = box2d.b2MulRV(m, this.m_lalcA, this.m_rA);
        box2d.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
        var c = box2d.b2MulRV(h, this.m_lalcB, this.m_rB)
            , y = box2d.b2SubVV(box2d.b2AddVV(d, c, box2d.b2Vec2.s_t0), box2d.b2AddVV(s, _, box2d.b2Vec2.s_t1), box2d.b2WheelJoint.prototype.InitVelocityConstraints.s_d);
        if (box2d.b2MulRV(m, this.m_localYAxisA, this.m_ay),
            this.m_sAy = box2d.b2CrossVV(box2d.b2AddVV(y, _, box2d.b2Vec2.s_t0), this.m_ay),
            this.m_sBy = box2d.b2CrossVV(c, this.m_ay),
            this.m_mass = t + e + i * this.m_sAy * this.m_sAy + n * this.m_sBy * this.m_sBy,
            this.m_mass > 0 && (this.m_mass = 1 / this.m_mass),
            this.m_springMass = 0,
            this.m_bias = 0,
            this.m_gamma = 0,
            this.m_frequencyHz > 0) {
            box2d.b2MulRV(m, this.m_localXAxisA, this.m_ax),
                this.m_sAx = box2d.b2CrossVV(box2d.b2AddVV(y, _, box2d.b2Vec2.s_t0), this.m_ax),
                this.m_sBx = box2d.b2CrossVV(c, this.m_ax);
            var u = t + e + i * this.m_sAx * this.m_sAx + n * this.m_sBx * this.m_sBx;
            if (u > 0) {
                this.m_springMass = 1 / u;
                var g = box2d.b2DotVV(y, this.m_ax)
                    , f = 2 * box2d.b2_pi * this.m_frequencyHz
                    , S = 2 * this.m_springMass * this.m_dampingRatio * f
                    , A = this.m_springMass * f * f
                    , C = o.step.dt;
                this.m_gamma = C * (S + C * A),
                    this.m_gamma > 0 && (this.m_gamma = 1 / this.m_gamma),
                    this.m_bias = g * C * A * this.m_gamma,
                    this.m_springMass = u + this.m_gamma,
                    this.m_springMass > 0 && (this.m_springMass = 1 / this.m_springMass)
            }
        } else
            this.m_springImpulse = 0;
        if (this.m_enableMotor ? (this.m_motorMass = i + n,
            this.m_motorMass > 0 && (this.m_motorMass = 1 / this.m_motorMass)) : (this.m_motorMass = 0,
                this.m_motorImpulse = 0),
            o.step.warmStarting) {
            this.m_impulse *= o.step.dtRatio,
                this.m_springImpulse *= o.step.dtRatio,
                this.m_motorImpulse *= o.step.dtRatio;
            var v = box2d.b2AddVV(box2d.b2MulSV(this.m_impulse, this.m_ay, box2d.b2Vec2.s_t0), box2d.b2MulSV(this.m_springImpulse, this.m_ax, box2d.b2Vec2.s_t1), box2d.b2WheelJoint.prototype.InitVelocityConstraints.s_P)
                , V = this.m_impulse * this.m_sAy + this.m_springImpulse * this.m_sAx + this.m_motorImpulse
                , B = this.m_impulse * this.m_sBy + this.m_springImpulse * this.m_sBx + this.m_motorImpulse;
            b.SelfMulSub(this.m_invMassA, v),
                a -= this.m_invIA * V,
                x.SelfMulAdd(this.m_invMassB, v),
                p += this.m_invIB * B
        } else
            this.m_impulse = 0,
                this.m_springImpulse = 0,
                this.m_motorImpulse = 0;
        o.velocities[this.m_indexA].w = a,
            o.velocities[this.m_indexB].w = p
    }
    ,
    ...
    box2d.b2WheelJoint.prototype.SolveVelocityConstraints = function (o) {
        var t = this.m_invMassA
            ...
            , i = this.m_invIA
            , n = this.m_invIB
            , s = o.velocities[this.m_indexA].v
            , r = o.velocities[this.m_indexA].w
            , b = o.velocities[this.m_indexB].v
            , a = o.velocities[this.m_indexB].w
            , d = box2d.b2DotVV(this.m_ax, box2d.b2SubVV(b, s, box2d.b2Vec2.s_t0)) + this.m_sBx * a - this.m_sAx * r
            , l = -this.m_springMass * (d + this.m_bias + this.m_gamma * this.m_springImpulse);
        this.m_springImpulse += l;
        var x = box2d.b2MulSV(l, this.m_ax, box2d.b2WheelJoint.prototype.SolveVelocityConstraints.s_P)
            , p = l * this.m_sAx
            , m = l * this.m_sBx;
        s.SelfMulSub(t, x),
            r -= i * p,
            b.SelfMulAdd(e, x);
        d = (a += n * m) - r - this.m_motorSpeed,
            l = -this.m_motorMass * d;
        var h = this.m_motorImpulse
            , _ = o.step.dt * this.m_maxMotorTorque;
        this.m_motorImpulse = box2d.b2Clamp(this.m_motorImpulse + l, -_, _),
            r -= i * (l = this.m_motorImpulse - h),
            a += n * l;
        d = box2d.b2DotVV(this.m_ay, box2d.b2SubVV(b, s, box2d.b2Vec2.s_t0)) + this.m_sBy * a - this.m_sAy * r,
            l = -this.m_mass * d;
        this.m_impulse += l;
        x = box2d.b2MulSV(l, this.m_ay, box2d.b2WheelJoint.prototype.SolveVelocityConstraints.s_P),
            p = l * this.m_sAy,
            m = l * this.m_sBy;
        s.SelfMulSub(t, x),
            r -= i * p,
            b.SelfMulAdd(e, x),
            a += n * m,
            o.velocities[this.m_indexA].w = r,
            o.velocities[this.m_indexB].w = a
    }
    ,
    ...
    box2d.b2WheelJoint.prototype.SolvePositionConstraints = function (o) {
        ...
        var b = box2d.b2MulRV(s, this.m_lalcA, this.m_rA);
        box2d.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
        var a, d = box2d.b2MulRV(r, this.m_lalcB, this.m_rB), l = box2d.b2AddVV(box2d.b2SubVV(i, t, box2d.b2Vec2.s_t0), box2d.b2SubVV(d, b, box2d.b2Vec2.s_t1), box2d.b2WheelJoint.prototype.SolvePositionConstraints.s_d), x = box2d.b2MulRV(s, this.m_localYAxisA, this.m_ay), p = box2d.b2CrossVV(box2d.b2AddVV(l, b, box2d.b2Vec2.s_t0), x), m = box2d.b2CrossVV(d, x), h = box2d.b2DotVV(l, this.m_ay), _ = this.m_invMassA + this.m_invMassB + this.m_invIA * this.m_sAy * this.m_sAy + this.m_invIB * this.m_sBy * this.m_sBy;
        a = 0 !== _ ? -h / _ : 0;
        var c = box2d.b2MulSV(a, x, box2d.b2WheelJoint.prototype.SolvePositionConstraints.s_P)
            , y = a * p
            , u = a * m;
        return t.SelfMulSub(this.m_invMassA, c),
            e -= this.m_invIA * y,
            i.SelfMulAdd(this.m_invMassB, c),
            n += this.m_invIB * u,
            o.positions[this.m_indexA].a = e,
            o.positions[this.m_indexB].a = n,
            box2d.b2Abs(h) <= box2d.b2_linearSlop
    }
    ,
    ...
    box2d.b2WheelJoint.prototype.GetReactionForce = function (o, t) {
        return t.x = o * (this.m_impulse * this.m_ay.x + this.m_springImpulse * this.m_ax.x),
            t.y = o * (this.m_impulse * this.m_ay.y + this.m_springImpulse * this.m_ax.y),
            t
    }
    ,
    ...
    box2d.b2WheelJoint.prototype.GetJointTranslation = function () {
        var o = this.m_bodyA
            ...
            , i = t.GetWorldPoint(this.m_localAnchorB, new box2d.b2Vec2)
            , n = box2d.b2SubVV(i, e, new box2d.b2Vec2)
            , s = o.GetWorldVector(this.m_localXAxisA, new box2d.b2Vec2);
        return box2d.b2DotVV(n, s)
    }
    ,
    box2d.b2WheelJoint.prototype.GetJointSpeed = function () {
        var o = this.m_bodyA.m_angularVelocity;
        return this.m_bodyB.m_angularVelocity - o
    }
    ,
    ...
    box2d.b2MotorJointDef = function () {
        goog.base(this, box2d.b2JointType.e_motorJoint),
    ...
    box2d.b2MotorJointDef.prototype.correctionFactor = .3,
    box2d.b2MotorJointDef.prototype.Initialize = function (o, t) {
        this.bodyA = o,
            this.bodyB = t,
            this.bodyA.GetLocalPoint(this.bodyB.GetPosition(), this.linearOffset);
        var e = this.bodyA.GetAngleRadians()
            , i = this.bodyB.GetAngleRadians();
        this.angularOffset = i - e
    }
    ,
    box2d.b2MotorJoint = function (o) {
        goog.base(this, o),
            this.m_linearOffset = o.linearOffset.Clone(),
            this.m_linearImpulse = new box2d.b2Vec2(0, 0),
            this.m_maxForce = o.maxForce,
            this.m_maxTorque = o.maxTorque,
            this.m_correctionFactor = o.correctionFactor,
    ...
    box2d.b2MotorJoint.prototype.m_correctionFactor = .3,
    ...
    box2d.b2MotorJoint.prototype.GetReactionForce = function (o, t) {
        return box2d.b2MulSV(o, this.m_linearImpulse, t)
    }
    ,
    ...
    box2d.b2MotorJoint.prototype.SetCorrectionFactor = function (o) {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(box2d.b2IsValid(o) && 0 <= o && o <= 1),
    ...
    box2d.b2MotorJoint.prototype.SetLinearOffset = function (o) {
        box2d.b2IsEqualToV(o, this.m_linearOffset) || (this.m_bodyA.SetAwake(!0),
            this.m_bodyB.SetAwake(!0),
            this.m_linearOffset.Copy(o))
    }
    ,
    ...
    box2d.b2MotorJoint.prototype.SetAngularOffset = function (o) {
        o !== this.m_angularOffset && (this.m_bodyA.SetAwake(!0),
            this.m_bodyB.SetAwake(!0),
    ...
    box2d.b2MotorJoint.prototype.SetMaxForce = function (o) {
        box2d.ENABLE_ASSERTS && box2d.b2Assert(box2d.b2IsValid(o) && o >= 0),
            this.m_maxForce = o
    }
    ,
    ...
    box2d.b2MotorJoint.prototype.InitVelocityConstraints = function (o) {
        ...
        var t = o.positions[this.m_indexA].c
            ...
            , d = this.m_qA.SetAngleRadians(e)
            , l = this.m_qB.SetAngleRadians(r)
            , x = box2d.b2MulRV(d, box2d.b2NegV(this.m_localCenterA, box2d.b2Vec2.s_t0), this.m_rA)
            , p = box2d.b2MulRV(l, box2d.b2NegV(this.m_localCenterB, box2d.b2Vec2.s_t0), this.m_rB)
            , m = this.m_invMassA
            , h = this.m_invMassB
            , _ = this.m_invIA
            , c = this.m_invIB
            , y = this.m_K;
        if (y.ex.x = m + h + _ * x.y * x.y + c * p.y * p.y,
            y.ex.y = -_ * x.x * x.y - c * p.x * p.y,
            y.ey.x = y.ex.y,
            y.ey.y = m + h + _ * x.x * x.x + c * p.x * p.x,
            y.GetInverse(this.m_linearMass),
            this.m_angularMass = _ + c,
            this.m_angularMass > 0 && (this.m_angularMass = 1 / this.m_angularMass),
            box2d.b2SubVV(box2d.b2SubVV(box2d.b2AddVV(s, p, box2d.b2Vec2.s_t0), box2d.b2AddVV(t, x, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t2), box2d.b2MulRV(d, this.m_linearOffset, box2d.b2Vec2.s_t3), this.m_linearError),
            this.m_angularError = r - e - this.m_angularOffset,
            o.step.warmStarting) {
            this.m_linearImpulse.SelfMul(o.step.dtRatio),
                this.m_angularImpulse *= o.step.dtRatio;
            var u = this.m_linearImpulse;
            i.SelfMulSub(m, u),
                n -= _ * (box2d.b2CrossVV(x, u) + this.m_angularImpulse),
                b.SelfMulAdd(h, u),
                a += c * (box2d.b2CrossVV(p, u) + this.m_angularImpulse)
        } else
            this.m_linearImpulse.SetZero(),
                this.m_angularImpulse = 0;
        o.velocities[this.m_indexA].w = n,
    ...
    box2d.b2MotorJoint.prototype.SolveVelocityConstraints = function (o) {
        var t = o.velocities[this.m_indexA].v
            ...
            , d = o.step.dt
            , l = o.step.inv_dt
            , x = n - e + l * this.m_correctionFactor * this.m_angularError
            , p = -this.m_angularMass * x
            , m = this.m_angularImpulse
            , h = d * this.m_maxTorque;
        this.m_angularImpulse = box2d.b2Clamp(this.m_angularImpulse + p, -h, h),
            e -= b * (p = this.m_angularImpulse - m),
            n += a * p;
        var _ = this.m_rA
            , c = this.m_rB;
        x = box2d.b2AddVV(box2d.b2SubVV(box2d.b2AddVV(i, box2d.b2CrossSV(n, c, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), box2d.b2AddVV(t, box2d.b2CrossSV(e, _, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t2), box2d.b2MulSV(l * this.m_correctionFactor, this.m_linearError, box2d.b2Vec2.s_t3), box2d.b2MotorJoint.prototype.SolveVelocityConstraints.s_Cdot),
            p = box2d.b2MulMV(this.m_linearMass, x, box2d.b2MotorJoint.prototype.SolveVelocityConstraints.s_impulse).SelfNeg(),
        ...
        h = d * this.m_maxForce;
        this.m_linearImpulse.GetLengthSquared() > h * h && (this.m_linearImpulse.Normalize(),
            this.m_linearImpulse.SelfMul(h)),
            box2d.b2SubVV(this.m_linearImpulse, m, p),
            t.SelfMulSub(s, p),
            e -= b * box2d.b2CrossVV(_, p),
            i.SelfMulAdd(r, p),
            n += a * box2d.b2CrossVV(c, p),
            o.velocities[this.m_indexA].w = e,
            o.velocities[this.m_indexB].w = n
    }
    ,
    ...
    Phaser.Physics.Box2D = function (o, t) {
        this.game = o,
            this.ptmRatio = 50,
        ...
        var e = new box2d.b2BodyDef;
        this.mouseJointBody = this.world.CreateBody(e),
            this.mouseJoint = null,
            t.hasOwnProperty("mpx") && t.hasOwnProperty("pxm") && (this.mpx = t.mpx,
                this.pxm = t.pxm),
            this.walls = {
                left: null,
                right: null,
    ...
    Phaser.Physics.Box2D.prototype = {
        getNextBodyId: function () {
            var o = this.nextBodyId;
            return this.nextBodyId += 1,
                o
        },
        getNextFixtureId: function () {
            var o = this.nextFixtureId;
            return this.nextFixtureId += 1,
                o
        },
        removeBodyNextStep: function (o) {
            this._toRemove.push(o)
        },
        preUpdate: function () {
            for (var o = this._toRemove.length; o--;)
                this.removeBody(this._toRemove[o]);
        ...
        enable: function (o, t) {
            ...
            if (Array.isArray(o))
                for (e = o.length; e--;)
                    o[e] instanceof Phaser.Group ? this.enable(o[e].children, t) : (this.enableBody(o[e]),
                        t && o[e].hasOwnProperty("children") && o[e].children.length > 0 && this.enable(o[e], !0));
            else
                o instanceof Phaser.Group ? this.enable(o.children, t) : (this.enableBody(o),
                    t && o.hasOwnProperty("children") && o.children.length > 0 && this.enable(o.children, !0))
        },
        enableBody: function (o) {
            o.hasOwnProperty("body") && null === o.body && (o.body = new Phaser.Physics.Box2D.Body(this.game, o, o.x, o.y, 2),
                o.anchor.set(.5))
        },
        setBoundsToWorld: function (o, t, e, i, n, s) {
            void 0 === o && (o = !0),
                void 0 === t && (t = !0),
                void 0 === e && (e = !0),
                void 0 === i && (i = !0),
                void 0 === n && (n = 1),
                void 0 === s && (n = 4294967295),
                this.setBounds(this.game.world.bounds.x, this.game.world.bounds.y, this.game.world.bounds.width, this.game.world.bounds.height, o, t, e, i, n, s)
        },
        setBounds: function (o, t, e, i, n, s, r, b, a, d) {
            void 0 === n && (n = !0),
                void 0 === s && (s = !0),
                void 0 === r && (r = !0),
                void 0 === b && (b = !0),
                void 0 === a && (a = 1),
                void 0 === d && (d = 4294967295),
            ...
            var l = new box2d.b2PolygonShape
                , x = new box2d.b2FixtureDef;
            x.shape = l,
                x.filter.categoryBits = Phaser.Physics.Box2D.worldBoundsFilterCategory,
                x.filter.maskBits = 65535;
            var p = this.pxm(100)
                , m = this.game.world.bounds;
            n && (this.walls.left = this.createBody(0, 0, 0),
                l.SetAsOrientedBox(p, this.pxm(m.height) + p, new box2d.b2Vec2(p, 0), 0),
                this.walls.left.data.CreateFixture(x).id = this.getNextFixtureId());
            s && (this.walls.right = this.createBody(0, 0, 0),
                l.SetAsOrientedBox(p, this.pxm(m.height) + p, new box2d.b2Vec2(this.pxm(-m.width) - p, 0), 0),
                this.walls.right.data.CreateFixture(x).id = this.getNextFixtureId());
            r && (this.walls.top = this.createBody(0, 0, 0),
                l.SetAsOrientedBox(this.pxm(m.width) + p, p, new box2d.b2Vec2(0, p), 0),
                this.walls.top.data.CreateFixture(x).id = this.getNextFixtureId());
            b && (this.walls.bottom = this.createBody(0, 0, 0),
                l.SetAsOrientedBox(this.pxm(m.width) + p, p, new box2d.b2Vec2(0, this.pxm(-m.height) - p), 0),
                this.walls.bottom.data.CreateFixture(x).id = this.getNextFixtureId())
        },
        pause: function () {
            this.paused = !0
        },
        ...
        clear: function () {
            this.world = new box2d.b2World(this.gravity.object.m_gravity),
                this.world.SetDebugDraw(this.debugDraw),
                this.world.SetContactListener(this.contactListener),
                this._toRemove = []
        },
        ...
        createBody: function (o, t, e) {
            return new Phaser.Physics.Box2D.Body(this.game, null, o, t, e, this)
        },
        createCircle: function (o, t, e, i, n) {
            return this.createBody(o, t, 2).setCircle(e, i, n)
        },
        createRectangle: function (o, t, e, i, n, s, r) {
            return this.createBody(o, t, 2).setRectangle(e, i, n, s, r)
        },
        createPolygon: function (o, t, e, i, n) {
            return this.createBody(o, t, 2).setPolygon(e, i, n)
        },
        addBody: function (o) {
            return !o.data.world && (o.data = this.world.CreateBody(o.bodyDef),
                o.data.world = this.world,
                o.data.parent = o,
                this.onBodyAdded.dispatch(o),
                !0)
        },
        removeBody: function (o) {
            return o.data.world == this.world && (this.world.DestroyBody(o.data),
                this.onBodyRemoved.dispatch(o)),
                o
        },
        getBodies: function () {
            for (var o = [], t = this.world.GetBodyList(); t; t = t.GetNext())
                o.push(t);
            return o
        },
        getBody: function (o) {
            return o instanceof box2d.b2Body ? o : o instanceof Phaser.Physics.Box2D.Body ? o.data : o.body && o.body.type === Phaser.Physics.BOX2D ? o.body.data : null
        },
        toJSON: function () {
            return this.world.toJSON()
        },
        mpx: function (o) {
            return o * this.ptmRatio
        },
        pxm: function (o) {
            return o / this.ptmRatio
        },
        renderDebugDraw: function (o) {
            if (this.game.physics.box2d) {
                var t = this.game.physics.box2d;
                t.debugDraw.start(o),
                    t.world.DrawDebugData(),
                    t.debugDraw.stop()
            }
        },
        renderBodyInfo: function (o, t) {
            o.line("Position: x: " + t.x.toFixed(3) + " y: " + t.y.toFixed(3)),
                o.line("Rotation: " + t.rotation.toFixed(3) + " degrees"),
                o.line("Velocity: x: " + t.velocity.x.toFixed(3) + " y: " + t.velocity.y.toFixed(3)),
                o.line("Angular velocity: " + t.angularVelocity.toFixed(3) + " degrees/sec")
        },
        getFixturesAtPoint: function (o, t, e, i) {
            void 0 === e && (e = !1),
                void 0 === i && (i = !1);
            var n = this.pxm(-o)
                , s = this.pxm(-t)
                ...
                , a = new box2d.b2Vec2;
            a.SetXY(.001, .001),
                box2d.b2SubVV(r, a, b.lowerBound),
                box2d.b2AddVV(r, a, b.upperBound);
            var d = [];
            return this.world.QueryAABB(function (o) {
                return !(!i || o.GetBody().GetType() === box2d.b2BodyType.b2_dynamicBody) || !o.TestPoint(r) || (d.push(o),
                    !e)
            }, b),
                d
        },
        getBodiesAtPoint: function (o, t, e, i) {
            void 0 === e && (e = !1),
                void 0 === i && (i = !1);
            var n = this.getFixturesAtPoint(o, t, e, i);
            if (n.length < 1)
                return n;
            for (var s = [], r = 0; r < n.length; r++)
                s.push(n[r].GetBody().parent);
            return s.filter(function (o, t) {
                return s.indexOf(o) === t
            }),
                s
        },
        mouseDragStart: function (o) {
            this.mouseDragEnd();
            var t = this.getFixturesAtPoint(o.x, o.y, !0, !0);
            if (!(t.length < 1)) {
                var e = this.pxm(-o.x)
                    , i = this.pxm(-o.y)
                    , n = new box2d.b2Vec2(e, i)
                    , s = new box2d.b2MouseJointDef;
                s.bodyA = this.mouseJointBody,
                    s.bodyB = t[0].GetBody(),
                    s.target.Copy(n),
                    s.maxForce = 1e3 * s.bodyB.GetMass(),
                    this.mouseJoint = this.world.CreateJoint(s),
                    s.bodyB.SetAwake(!0)
            }
        },
        mouseDragMove: function (o) {
            if (this.mouseJoint) {
                var t = this.pxm(-o.x)
                    , e = this.pxm(-o.y)
                    , i = new box2d.b2Vec2(t, e);
                this.mouseJoint.SetTarget(i)
            }
        },
        mouseDragEnd: function () {
            this.mouseJoint && (this.world.DestroyJoint(this.mouseJoint),
                this.mouseJoint = null)
        },
        distanceJoint: function (o, t, e, i, n, s, r, b, a) {
            void 0 === i && (i = 0),
                void 0 === n && (n = 0),
                void 0 === s && (s = 0),
                void 0 === r && (r = 0),
                ...
                o.body && (o = o.body),
                t.body && (t = t.body);
            var d = new box2d.b2DistanceJointDef;
            if (d.bodyA = o.data,
                d.bodyB = t.data,
                d.localAnchorA.SetXY(i, n),
                d.localAnchorB.SetXY(s, r),
                null == e) {
                var l = new box2d.b2Vec2
                    , x = new box2d.b2Vec2;
                d.bodyA.GetWorldPoint(d.localAnchorA, l),
                    d.bodyB.GetWorldPoint(d.localAnchorB, x),
                    l.SelfSub(x),
                    e = l.Length()
            } else
                e = this.pxm(e);
            return d.length = e,
                d.frequencyHz = b,
                d.dampingRatio = a,
                this.world.CreateJoint(d)
        },
        ropeJoint: function (o, t, e, i, n, s, r) {
            void 0 === i && (i = 0),
                void 0 === n && (n = 0),
                void 0 === s && (s = 0),
                void 0 === r && (r = 0),
                ...
                o.body && (o = o.body),
                t.body && (t = t.body);
            var b = new box2d.b2RopeJointDef;
            if (b.bodyA = o.data,
                b.bodyB = t.data,
                b.localAnchorA.SetXY(i, n),
                b.localAnchorB.SetXY(s, r),
                null == e) {
                var a = new box2d.b2Vec2
                    , d = new box2d.b2Vec2;
                b.bodyA.GetWorldPoint(b.localAnchorA, a),
                    b.bodyB.GetWorldPoint(b.localAnchorB, d),
                    a.SelfSub(d),
                    e = a.Length()
            } else
                e = this.pxm(e);
            return b.maxLength = e,
                this.world.CreateJoint(b)
        },
        revoluteJoint: function (o, t, e, i, n, s, r, b, a, d, l, x) {
            void 0 === e && (e = 0),
                void 0 === i && (i = 0),
                void 0 === n && (n = 0),
                void 0 === s && (s = 0),
            ...
            return p.bodyA = o.data,
                p.bodyB = t.data,
                p.localAnchorA.SetXY(e, i),
                p.localAnchorB.SetXY(n, s),
                p.motorSpeed = Phaser.Math.degToRad(-r),
                p.maxMotorTorque = b,
                p.enableMotor = a,
                p.lowerAngle = Phaser.Math.degToRad(d),
                p.upperAngle = Phaser.Math.degToRad(l),
                p.enableLimit = x,
                this.world.CreateJoint(p)
        },
        prismaticJoint: function (o, t, e, i, n, s, r, b, a, d, l, x, p, m, h) {
            void 0 === e && (e = 1),
                void 0 === i && (i = 0),
                void 0 === n && (n = 0),
                void 0 === s && (s = 0),
                ...
                o.body && (o = o.body),
                t.body && (t = t.body);
            var _ = new box2d.b2PrismaticJointDef;
            return _.bodyA = o.data,
                _.bodyB = t.data,
                _.localAxisA.SetXY(e, i),
                _.localAnchorA.SetXY(n, s),
                _.localAnchorB.SetXY(r, b),
                _.motorSpeed = a,
                _.maxMotorForce = d,
                _.enableMotor = l,
                _.lowerTranslation = x,
                _.upperTranslation = p,
                _.enableLimit = m,
                _.referenceAngle = Phaser.Math.degToRad(-h),
                this.world.CreateJoint(_)
        },
        frictionJoint: function (o, t, e, i, n, s, r, b) {
            void 0 === n && (n = 0),
                void 0 === s && (s = 0),
                void 0 === r && (r = 0),
                void 0 === b && (b = 0),
                ...
                o.body && (o = o.body),
                t.body && (t = t.body);
            var a = new box2d.b2FrictionJointDef;
            return a.bodyA = o.data,
                a.bodyB = t.data,
                a.localAnchorA.SetXY(n, s),
                a.localAnchorB.SetXY(r, b),
                a.maxForce = e,
                a.maxTorque = i,
                this.world.CreateJoint(a)
        },
        weldJoint: function (o, t, e, i, n, s, r, b) {
            void 0 === e && (e = 0),
                void 0 === i && (i = 0),
                void 0 === n && (n = 0),
                void 0 === s && (s = 0),
                ...
                o.body && (o = o.body),
                t.body && (t = t.body);
            var a = new box2d.b2WeldJointDef;
            return a.bodyA = o.data,
                a.bodyB = t.data,
                a.localAnchorA.SetXY(e, i),
                a.localAnchorB.SetXY(n, s),
                a.frequencyHz = r,
                a.dampingRatio = b,
                this.world.CreateJoint(a)
        },
        motorJoint: function (o, t, e, i, n, s, r, b) {
            void 0 === s && (s = 0),
                void 0 === r && (r = 0),
                void 0 === b && (b = 0),
                void 0 === e && (e = 0),
                ...
                o.body && (o = o.body),
                t.body && (t = t.body);
            var a = new box2d.b2MotorJointDef;
            return a.bodyA = o.data,
                a.bodyB = t.data,
                a.linearOffset.SetXY(s, r),
                a.maxForce = e,
                a.maxTorque = i,
                a.angularOffset = Phaser.Math.degToRad(-b),
                a.correctionFactor = n,
                this.world.CreateJoint(a)
        },
        wheelJoint: function (o, t, e, i, n, s, r, b, a, d, l, x, p) {
            void 0 === r && (r = 0),
                void 0 === b && (b = 1),
                void 0 === e && (e = 0),
                void 0 === i && (i = 0),
                ...
                o.body && (o = o.body),
                t.body && (t = t.body);
            var m = new box2d.b2WheelJointDef;
            return m.bodyA = o.data,
                m.bodyB = t.data,
                m.localAxisA.SetXY(r, b),
                m.localAnchorA.SetXY(e, i),
                m.localAnchorB.SetXY(n, s),
                m.motorSpeed = Phaser.Math.degToRad(-l),
                m.maxMotorTorque = x,
                m.enableMotor = p,
                m.frequencyHz = a,
                m.dampingRatio = d,
        ...
        pulleyJoint: function (o, t, e, i, n, s, r, b, a, d, l, x, p) {
            void 0 === e && (e = 0),
                void 0 === i && (i = 0),
                void 0 === n && (n = 0),
                void 0 === s && (s = 0),
                ...
                o.body && (o = o.body),
                t.body && (t = t.body);
            var m = new box2d.b2PulleyJointDef;
            return m.bodyA = o.data,
                m.bodyB = t.data,
                m.localAnchorA.SetXY(e, i),
                m.localAnchorB.SetXY(n, s),
                m.groundAnchorA.SetXY(r, b),
                m.groundAnchorB.SetXY(a, d),
                m.lengthA = x,
                m.lengthB = p,
                m.ratio = l,
                this.world.CreateJoint(m)
        },
        gearJoint: function (o, t, e) {
            void 0 === e && (e = 1);
            var i = new box2d.b2GearJointDef;
            return i.joint1 = o,
                i.joint2 = t,
                i.ratio = -e,
                i.bodyA = o.GetBodyA(),
                i.bodyB = t.GetBodyB(),
                this.world.CreateJoint(i)
        },
        clearTilemapLayerBodies: function (o, t) {
            t = o.getLayer(t);
            for (var e = o.layers[t].bodies.length; e--;)
                o.layers[t].bodies[e].destroy();
            o.layers[t].bodies.length = 0
        },
        convertTilemap: function (o, t, e, i) {
            t = o.getLayer(t),
                void 0 === e && (e = !0),
                void 0 === i && (i = !0),
                this.clearTilemapLayerBodies(o, t);
            for (var n = 0, s = 0, r = 0, b = 0, a = o.layers[t].height; b < a; b++) {
                n = 0;
                for (var d = 0, l = o.layers[t].width; d < l; d++) {
                    var x = o.layers[t].data[b][d];
                    if (x && x.index > -1 && x.collides)
                        if (i) {
                            var p = o.getTileRight(t, d, b);
                            if (0 === n && (s = x.x * x.width,
                                r = x.y * x.height,
                                n = x.width),
                                p && p.collides)
                                n += x.width;
                            else
                                (m = new Phaser.Physics.Box2D.Body(this.game, null, s, r, 0)).addRectangle(n, x.height, n / 2, x.height / 2, 0),
                                    e && this.addBody(m),
                                    o.layers[t].bodies.push(m),
                                    n = 0
                        } else {
                            var m;
                            (m = this.createBody(x.x * x.width, x.y * x.height, 0, !1)).addRectangle(x.width, x.height, x.width / 2, x.height / 2, 0),
                                e && this.addBody(m),
                                o.layers[t].bodies.push(m)
                        }
                }
            }
            return o.layers[t].bodies
        },
        raycast: function (o, t, e, i, n, s) {
            void 0 === n && (n = !0),
                void 0 === s && (s = null),
                o = this.pxm(-o),
                t = this.pxm(-t),
                e = this.pxm(-e),
                i = this.pxm(-i);
            var r = new box2d.b2Vec2(o, t)
                , b = new box2d.b2Vec2(e, i)
                , a = []
                , d = new Phaser.Physics.Box2D.RayCastCallback(this, n, s);
            this.world.RayCast(d, r, b);
            for (var l = 0; l < d.hits.length; l++) {
                var x = d.hits[l];
                x.point = {
                    x: this.mpx(-x.point.x),
                    y: this.mpx(-x.point.y)
                },
                    x.normal = {
                        x: -x.normal.x,
                        y: -x.normal.y
        ...
        queryAABB: function (o, t, e, i) {
            o = this.pxm(-o),
                t = this.pxm(-t),
                e = this.pxm(e),
                i = this.pxm(i);
            var n = new box2d.b2AABB;
            n.lowerBound.SetXY(o - e, t - i),
                n.upperBound.SetXY(o, t);
            var s = new Phaser.Physics.Box2D.QueryCallback(this);
            return this.world.QueryAABB(s, n),
                s.hits
        },
        queryFixture: function (o) {
            var t = new Phaser.Physics.Box2D.QueryCallback(this);
            return this.world.QueryShape(t, o.GetShape(), o.GetBody().GetTransform()),
                t.hits
        }
    },
    Phaser.Physics.Box2D.RayCastCallback = function (o, t, e) {
        this.world = o,
            this.closestHitOnly = t,
            this.filterFunction = e,
            this.hits = []
    }
    ,
    Phaser.Physics.Box2D.RayCastCallback.prototype.ReportFixture = function (o, t, e, i) {
        if (null !== this.filterFunction) {
            var n = {
                x: this.world.mpx(-t.x),
                y: this.world.mpx(-t.y)
            }
                , s = {
                    x: -e.x,
                    y: -e.y
                ...
                , r = o.GetBody().parent;
            if (!this.filterFunction.call(this, r, o, n, s))
                return -1
        }
        this.closestHitOnly && (this.hits = []);
        var b = {};
        return b.body = o.GetBody().parent,
            b.fixture = o,
            b.point = {
                x: t.x,
                y: t.y
            ...
            this.hits.push(b),
            this.closestHitOnly ? i : 1
    }
    ,
    Phaser.Physics.Box2D.QueryCallback = function (o) {
        this.world = o,
            this.hits = []
    }
    ,
    Phaser.Physics.Box2D.QueryCallback.prototype.ReportFixture = function (o) {
        var t = {};
        return t.body = o.GetBody().parent,
            t.fixture = o,
            this.hits.push(t),
            !0
    }
    ,
    Phaser.Physics.Box2D.renderBody = function (o, t, e, i) {
        e = e || "rgb(255,255,255)",
            void 0 === i && (i = !0);
        var n = t.game.physics.box2d
            , s = t.data
            , r = s.GetTransform();
        n.debugDraw.start(o),
            n.debugDraw.PushTransform(r);
        var b = Phaser.Color.webToColor(e)
            , a = n.debugDraw.color;
        a.r = b.r / 255,
            a.g = b.g / 255,
            a.b = b.b / 255;
        for (var d = s.GetFixtureList(); d; d = d.GetNext())
            n.world.DrawShape(d, a);
        n.debugDraw.PopTransform(),
            n.debugDraw.stop()
    }
    ,
    Phaser.Physics.Box2D.Body = function (o, t, e, i, n, s) {
        void 0 === t && (t = null),
            void 0 === e && (e = 0),
            void 0 === i && (i = 0),
            void 0 === n && (n = 2),
            void 0 === s && (s = o.physics.box2d),
            this.game = o,
            this.world = s,
            ...
            this.bodyDef.position.SetXY(-this.world.pxm(e), -this.world.pxm(i)),
            0 === n ? this.bodyDef.type = box2d.b2BodyType.b2_staticBody : 1 === n ? this.bodyDef.type = box2d.b2BodyType.b2_kinematicBody : 2 === n ? this.bodyDef.type = box2d.b2BodyType.b2_dynamicBody : 3 === n && (this.bodyDef.type = box2d.b2BodyType.b2_bulletBody),
    ...
    Phaser.Physics.Box2D.Body.prototype = {
        setBodyContactCallback: function (o, t, e) {
            var i = -1;
            o.id ? i = o.id : o.body && (i = o.body.id),
                i > -1 && (null === t ? (delete this._bodyContactCallbacks[i],
                    delete this._bodyContactCallbackContext[i]) : (this._bodyContactCallbacks[i] = t,
                        this._bodyContactCallbackContext[i] = e))
        },
        setFixtureContactCallback: function (o, t, e) {
            var i = o.id;
            i > -1 && (null === t ? (delete this._fixtureContactCallbacks[i],
                delete this._fixtureContactCallbackContext[i]) : (this._fixtureContactCallbacks[i] = t,
                    this._fixtureContactCallbackContext[i] = e))
        },
        setCategoryContactCallback: function (o, t, e) {
            null === t ? (delete this._categoryContactCallbacks[o],
                delete this._categoryContactCallbackContext[o]) : (this._categoryContactCallbacks[o] = t,
                    this._categoryContactCallbackContext[o] = e)
        },
        setBodyPresolveCallback: function (o, t, e) {
            var i = -1;
            o.id ? i = o.id : o.body && (i = o.body.id),
                i > -1 && (null === t ? (delete this._bodyPresolveCallbacks[i],
                    delete this._bodyPresolveCallbackContext[i]) : (this._bodyPresolveCallbacks[i] = t,
                        this._bodyPresolveCallbackContext[i] = e))
        },
        setFixturePresolveCallback: function (o, t, e) {
            var i = o.id;
            i > -1 && (null === t ? (delete this._fixturePresolveCallbacks[i],
                delete this._fixturePresolveCallbackContext[i]) : (this._fixturePresolveCallbacks[i] = t,
                    this._fixturePresolveCallbackContext[i] = e))
        },
        setCategoryPresolveCallback: function (o, t, e) {
            null === t ? (delete this._categoryPresolveCallbacks[o],
                delete this._categoryPresolveCallbackContext[o]) : (this._categoryPresolveCallbacks[o] = t,
                    this._categoryPresolveCallbackContext[o] = e)
        },
        setBodyPostsolveCallback: function (o, t, e) {
            var i = -1;
            o.id ? i = o.id : o.body && (i = o.body.id),
                i > -1 && (null === t ? (delete this._bodyPostsolveCallbacks[i],
                    delete this._bodyPostsolveCallbackContext[i]) : (this._bodyPostsolveCallbacks[i] = t,
                        this._bodyPostsolveCallbackContext[i] = e))
        },
        setFixturePostsolveCallback: function (o, t, e) {
            var i = o.id;
            i > -1 && (null === t ? (delete this._fixturePostsolveCallbacks[i],
                delete this._fixturePostsolveCallbackContext[i]) : (this._fixturePostsolveCallbacks[i] = t,
                    this._fixturePostsolveCallbackContext[i] = e))
        },
        setCategoryPostsolveCallback: function (o, t, e) {
            null === t ? (delete this._categoryPostsolveCallbacks[o],
                delete this._categoryPostsolveCallbacksContext[o]) : (this._categoryPostsolveCallbacks[o] = t,
                    this._categoryPostsolveCallbackContext[o] = e)
        },
        setCollisionCategory: function (o, t) {
            if ("undefined" == typeof shape)
                for (var e = this.data.GetFixtureList(); e; e = e.GetNext()) {
                    e.GetFilterData().categoryBits = o
                }
            else
                t.GetFilterData().categoryBits = o
        },
        setCollisionMask: function (o, t) {
            if ("undefined" == typeof shape)
                for (var e = this.data.GetFixtureList(); e; e = e.GetNext()) {
                    e.GetFilterData().maskBits = o
                }
            else
                t.GetFilterData().maskBits = o
        },
        applyForce: function (o, t) {
            this.data.ApplyForce(new box2d.b2Vec2(-o, -t), this.data.GetWorldCenter(), !0)
        },
        ...
        toLocalPoint: function (o, t) {
            return o.x = this.world.pxm(-t.x),
                o.y = this.world.pxm(-t.y),
                this.data.GetLocalPoint(o, o),
                o.x = this.world.mpx(-o.x),
                o.y = this.world.mpx(-o.y),
                o
        },
        toWorldPoint: function (o, t) {
            return o.x = this.world.pxm(-t.x),
                o.y = this.world.pxm(-t.y),
                this.data.GetWorldPoint(o, o),
                o.x = this.world.mpx(-o.x),
                o.y = this.world.mpx(-o.y),
                o
        },
        toLocalVector: function (o, t) {
            return o.x = this.world.pxm(-t.x),
                o.y = this.world.pxm(-t.y),
                this.data.GetLocalVector(o, o),
                o.x = this.world.mpx(-o.x),
                o.y = this.world.mpx(-o.y),
                o
        },
        toWorldVector: function (o, t) {
            o.x = this.world.pxm(-t.x),
                o.y = this.world.pxm(-t.y),
                this.data.GetWorldVector(o, o),
                o.x = this.world.mpx(-o.x),
                o.y = this.world.mpx(-o.y)
        },
        rotateLeft: function (o) {
            this.data.SetAngularVelocity(this.world.pxm(-o))
        },
        rotateRight: function (o) {
            this.data.SetAngularVelocity(this.world.pxm(o))
        },
        moveForward: function (o) {
            var t = this.world.pxm(o)
                , e = new box2d.b2Vec2;
            this.toWorldVector(e, {
                x: 0,
                y: t
            }),
                this.data.SetLinearVelocity(e)
        },
        moveBackward: function (o) {
            var t = this.world.pxm(-o)
                , e = new box2d.b2Vec2;
            this.toWorldVector(e, {
                x: 0,
        ...
        thrust: function (o) {
            var t = this.world.pxm(o) * this.data.GetMass()
                , e = new box2d.b2Vec2;
            this.toWorldVector(e, {
                x: 0,
                y: t
            }),
                this.data.ApplyForce(e, this.data.GetWorldCenter(), !0)
        },
        reverse: function (o) {
            var t = -this.world.pxm(o) * this.data.GetMass()
                , e = new box2d.b2Vec2;
        ...
        postUpdate: function () {
            this.sprite && (this.sprite.x = this.world.mpx(-this.data.GetPosition().x),
        ...
        reset: function (o, t) {
            this.data.SetPositionXY(this.world.pxm(-o), this.world.pxm(-t)),
                this.data.SetActive(!0)
        },
        ...
        clearFixtures: function () {
            for (var o = [], t = this.data.GetFixtureList(); t; t = t.GetNext())
                o.push(t);
            for (var e = o.length; e--;)
                this.data.DestroyFixture(o[e])
        },
        addCircle: function (o, t, e) {
            var i = new box2d.b2CircleShape(this.world.pxm(o));
            i.m_p.SetXY(this.world.pxm(-t), this.world.pxm(-e));
            var n = new box2d.b2FixtureDef;
            n.shape = i,
                n.friction = this.world.friction,
                n.restitution = this.world.restitution,
                n.density = this.world.density;
            var s = this.data.CreateFixture(n);
            return s.id = this.world.getNextFixtureId(),
                s
        },
        addRectangle: function (o, t, e, i, n) {
            void 0 === o && (o = 16),
                void 0 === t && (t = 16),
                void 0 === e && (e = 0),
                void 0 === i && (i = 0),
            ...
            s.SetAsOrientedBox(.5 * o, .5 * t, new box2d.b2Vec2(this.world.pxm(-e), this.world.pxm(-i)), n);
            var r = new box2d.b2FixtureDef;
            r.shape = s,
                r.friction = this.world.friction,
                r.restitution = this.world.restitution,
                r.density = this.world.density;
            var b = this.data.CreateFixture(r);
            return b.id = this.world.getNextFixtureId(),
                b
        },
        addEdge: function (o, t, e, i) {
            var n = new box2d.b2EdgeShape;
            n.Set(new box2d.b2Vec2(this.world.pxm(-o), this.world.pxm(-t)), new box2d.b2Vec2(this.world.pxm(-e), this.world.pxm(-i)));
            var s = new box2d.b2FixtureDef;
            s.shape = n,
                s.friction = this.world.friction,
                s.restitution = this.world.restitution,
                s.density = this.world.density;
            var r = this.data.CreateFixture(s);
            return r.id = this.world.getNextFixtureId(),
                r
        },
        addChain: function (o, t, e, i) {
            if (void 0 === o)
                return null;
            if (o.length < 4)
                return null;
            void 0 === t && (t = 0),
                void 0 === e && (e = (o.length - t) / 2);
            for (var n = [], s = t; s < t + e; s++)
                n.push(new box2d.b2Vec2(this.world.pxm(-o[2 * s]), this.world.pxm(-o[2 * s + 1])));
            var r = new box2d.b2ChainShape;
            i ? r.CreateLoop(n, n.length) : r.CreateChain(n, n.length);
            var b = new box2d.b2FixtureDef;
            b.shape = r,
                b.friction = this.world.friction,
                b.restitution = this.world.restitution,
                b.density = this.world.density;
            var a = this.data.CreateFixture(b);
            return a.id = this.world.getNextFixtureId(),
                a
        },
        addLoop: function (o, t, e) {
            return this.addChain(o, t, e, !0)
        },
        addPolygon: function (o, t, e) {
            if (void 0 === o)
                return null;
            if (o.length < 6)
                return null;
            void 0 === t && (t = 0),
                void 0 === e && (e = (o.length - t) / 2);
            for (var i = [], n = t; n < t + e; n++)
                i.push({
                    x: this.world.pxm(-o[2 * n]),
                    y: this.world.pxm(-o[2 * n + 1])
                });
            var s = new Phaser.Physics.Box2D.Polygon;
            s.setFromXYObjects(i);
            var r = s.decompose(i)
                , b = null;
            for (n = 0; n < r.length; n++) {
                var a = new box2d.b2PolygonShape;
                a.Set(r[n], r[n].length);
                var d = new box2d.b2FixtureDef;
                d.shape = a,
                    d.friction = this.world.friction,
                    d.restitution = this.world.restitution,
                    d.density = this.world.density,
                    (b = this.data.CreateFixture(d)).id = this.world.getNextFixtureId()
            }
            return b
        },
        removeFixture: function (o) {
            return o.GetBody() == this.data && (this.data.DestroyFixture(o),
                !0)
        },
        setCircle: function (o, t, e) {
            return void 0 === o && (o = 32),
                void 0 === t && (t = 0),
                void 0 === e && (e = 0),
                this.clearFixtures(),
                this.addCircle(o, t, e)
        },
        setRectangle: function (o, t, e, i, n) {
            return this.clearFixtures(),
                this.addRectangle(o, t, e, i, n)
        },
        setRectangleFromSprite: function (o) {
            return void 0 === o && (o = this.sprite),
                this.clearFixtures(),
                this.addRectangle(o.width, o.height, 0, 0, o.rotation)
        },
        setEdge: function (o, t, e, i) {
            return void 0 === o && (o = 0),
                void 0 === t && (t = 0),
                void 0 === e && (e = 0),
                void 0 === i && (i = 0),
                this.clearFixtures(),
                this.addEdge(o, t, e, i)
        },
        setChain: function (o, t, e, i) {
            return void 0 === o ? null : o.length < 4 ? null : (void 0 === t && (t = 0),
                void 0 === e && (e = (o.length - t) / 2),
                this.clearFixtures(),
                this.addChain(o, t, e, i))
        },
        setLoop: function (o, t, e) {
            return this.setChain(o, t, e, !0)
        },
        setPolygon: function (o, t, e) {
            return void 0 === o ? null : o.length < 4 ? null : (void 0 === t && (t = 0),
                void 0 === e && (e = (o.length - t) / 2),
                this.clearFixtures(),
                this.addPolygon(o, t, e))
        },
        loadPolygon: function (o, t, e) {
            void 0 === e && (e = null);
            for (var i = this.game.cache.getPhysicsData(o, t), n = 0; n < i.length; n++) {
                for (var s = [], r = 0; r < i[n].shape.length; r += 2)
                    s.push(new box2d.b2Vec2(this.world.pxm(-i[n].shape[r]), this.world.pxm(-i[n].shape[r + 1])));
                if (e)
                    for (var b = this.world.pxm(-.5 * e.width), a = this.world.pxm(-.5 * e.height), d = 0; d < s.length; d++)
                        s[d].x -= b,
                            s[d].y -= a;
                var l = new box2d.b2PolygonShape;
                l.Set(s, s.length);
                var x = new box2d.b2FixtureDef;
                x.shape = l,
                    x.friction = i[n].friction,
                    x.restitution = i[n].bounce,
                    x.density = i[n].density,
                    x.filter.categoryBits = i[n].filter.categoryBits,
                    x.filter.maskBits = i[n].filter.maskBits,
                    this.data.CreateFixture(x).id = this.world.getNextFixtureId()
            }
            return !0
        },
        containsPoint: function (o) {
            for (var t = this.world.pxm(-o.x), e = this.world.pxm(-o.y), i = new box2d.b2Vec2(t, e), n = this.data.GetFixtureList(); n; n = n.GetNext())
                if (n.TestPoint(i))
                    return !0;
            return !1
        }
    ...
    Object.defineProperty(Phaser.Physics.Box2D.Body.prototype, "static", {
        ...
        set: function (o) {
            o && this.data.GetType() !== box2d.b2BodyType.b2_staticBody ? this.data.SetType(box2d.b2BodyType.b2_staticBody) : o || this.data.GetType() !== box2d.b2BodyType.b2_staticBody || this.data.SetType(box2d.b2BodyType.b2_dynamicBody)
        }
    }),
    Object.defineProperty(Phaser.Physics.Box2D.Body.prototype, "dynamic", {
        ...
        set: function (o) {
            o && this.data.GetType() !== box2d.b2BodyType.b2_dynamicBody ? this.data.SetType(box2d.b2BodyType.b2_dynamicBody) : o || this.data.GetType() !== box2d.b2BodyType.b2_dynamicBody || this.data.SetType(box2d.b2BodyType.b2_staticBody)
        }
    }),
    Object.defineProperty(Phaser.Physics.Box2D.Body.prototype, "kinematic", {
        ...
        set: function (o) {
            o && this.data.GetType() !== box2d.b2BodyType.b2_kinematicBody ? this.data.SetType(box2d.b2BodyType.b2_kinematicBody) : o || this.data.GetType() !== box2d.b2BodyType.b2_kinematicBody || this.data.SetType(box2d.b2BodyType.b2_staticBody)
        }
    }),
    Object.defineProperty(Phaser.Physics.Box2D.Body.prototype, "angle", {
        ...
        set: function (o) {
            this.data.SetAngle(Phaser.Math.degToRad(Phaser.Math.wrapAngle(o)))
        }
    }),
    ...
    Object.defineProperty(Phaser.Physics.Box2D.Body.prototype, "angularVelocity", {
        ...
        set: function (o) {
            this.data.SetAngularVelocity(o)
        }
    }),
    ...
    Object.defineProperty(Phaser.Physics.Box2D.Body.prototype, "gravityScale", {
        ...
        set: function (o) {
            this.data.SetGravityScale(o)
        }
    }),
    Object.defineProperty(Phaser.Physics.Box2D.Body.prototype, "friction", {
        get: function () {
            var o = this.data.GetFixtureList();
            return o ? o.GetFriction() : 0
        },
        set: function (o) {
    ...
    Object.defineProperty(Phaser.Physics.Box2D.Body.prototype, "mass", {
        ...
        set: function (o) {
            if (0 === o)
                ...
                for (var t = o / this.data.GetMass(), e = this.data.GetFixtureList(); e; e = e.GetNext()) {
                    var i = e.GetDensity();
                    e.SetDensity(i * t)
                }
    ...
    Object.defineProperty(Phaser.Physics.Box2D.Body.prototype, "x", {
        ...
        set: function (o) {
            this.data.SetPositionXY(this.world.pxm(-o), this.data.GetPosition().y)
        }
    }),
    Object.defineProperty(Phaser.Physics.Box2D.Body.prototype, "y", {
        ...
        set: function (o) {
            this.data.SetPositionXY(this.data.GetPosition().x, this.world.pxm(-o))
        }
    }),
    Object.defineProperty(Phaser.Physics.Box2D.Body.prototype, "collideWorldBounds", {
        get: function () {
            for (var o = this.data.GetFixtureList(); o; o = o.GetNext()) {
                if (o.GetFilterData().maskBits & Phaser.Physics.Box2D.worldBoundsFilterCategory)
                    return !0
            }
            return !1
        },
        set: function (o) {
            for (var t = this.data.GetFixtureList(); t; t = t.GetNext()) {
                var e = t.GetFilterData();
                o ? e.maskBits |= Phaser.Physics.Box2D.worldBoundsFilterCategory : e.maskBits &= ~Phaser.Physics.Box2D.worldBoundsFilterCategory
            }
        }
    }),
    Phaser.Physics.Box2D.PointProxy = function (o, t, e, i) {
        this.world = o,
            this.object = t,
            this.gettor = e,
            this.settor = i
    ...
    Object.defineProperty(Phaser.Physics.Box2D.PointProxy.prototype, "x", {
        ...
        set: function (o) {
            var t = this.gettor.call(this.object);
            t.x = this.world.pxm(-o),
                this.settor.call(this.object, t)
        }
    }),
    Object.defineProperty(Phaser.Physics.Box2D.PointProxy.prototype, "y", {
        ...
        set: function (o) {
            var t = this.gettor.call(this.object);
            t.y = this.world.pxm(-o),
                this.settor.call(this.object, t)
        }
    }),
    Phaser.Physics.Box2D.DefaultDebugDraw = function (o) {
        this.context = null,
    ...
    Phaser.Physics.Box2D.DefaultDebugDraw.prototype.SetFlags = function (o) {
        this.flags = o
    }
    ,
    ...
    ,
    Phaser.Physics.Box2D.DefaultDebugDraw.prototype.start = function (o) {
        this.context = o,
            this.context.save(),
    ...
    ,
    Phaser.Physics.Box2D.DefaultDebugDraw.prototype.PushTransform = function (o) {
        var t = this.context;
        t.save(),
            t.translate(o.p.x, o.p.y),
            t.rotate(o.q.GetAngleRadians())
    }
    ,
    ...
    ,
    Phaser.Physics.Box2D.DefaultDebugDraw.prototype.DrawPolygon = function (o, t, e) {
        if (t) {
            var i = this.context;
            i.lineWidth = 1 / this.pixelsPerMeter,
                i.beginPath(),
                i.moveTo(o[0].x, o[0].y);
            for (var n = 1; n < t; n++)
                i.lineTo(o[n].x, o[n].y);
            i.closePath(),
                i.strokeStyle = e.MakeStyleString(1),
                i.stroke()
        }
    }
    ,
    Phaser.Physics.Box2D.DefaultDebugDraw.prototype.DrawSolidPolygon = function (o, t, e) {
        if (t) {
            var i = this.context;
            i.lineWidth = 1 / this.pixelsPerMeter,
                i.beginPath(),
            ...
            for (var n = 1; n < t; n++)
                i.lineTo(o[n].x, o[n].y);
            i.closePath(),
                i.fillStyle = e.MakeStyleString(.5),
                i.fill(),
                i.strokeStyle = e.MakeStyleString(1),
                i.stroke()
        }
    ...
    ,
    Phaser.Physics.Box2D.DefaultDebugDraw.prototype.DrawCircle = function (o, t, e) {
        if (t) {
            var i = this.context;
            i.beginPath(),
                i.arc(o.x, o.y, t, 0, 2 * Math.PI, !0),
                i.strokeStyle = e.MakeStyleString(1),
                i.stroke()
        }
    }
    ,
    Phaser.Physics.Box2D.DefaultDebugDraw.prototype.DrawSolidCircle = function (o, t, e, i) {
        if (t) {
            var n = this.context;
            n.lineWidth = 1 / this.pixelsPerMeter;
            var s = o.x
                , r = o.y;
            n.beginPath(),
                n.arc(s, r, t, 0, 2 * Math.PI, !0),
                n.moveTo(s, r),
                n.lineTo(s + e.x * t, r + e.y * t),
                n.fillStyle = i.MakeStyleString(.5),
                n.fill(),
                n.strokeStyle = i.MakeStyleString(1),
                n.stroke()
        }
    }
    ,
    Phaser.Physics.Box2D.DefaultDebugDraw.prototype.DrawSegment = function (o, t, e) {
        var i = this.context;
        i.lineWidth = 1 / this.pixelsPerMeter,
            i.beginPath(),
            i.moveTo(o.x, o.y),
    ...
    ,
    Phaser.Physics.Box2D.DefaultDebugDraw.prototype.DrawTransform = function (o) {
        var t = this.context;
        t.lineWidth = 1 / this.pixelsPerMeter,
            this.PushTransform(o),
            t.beginPath(),
            t.moveTo(0, 0),
            t.lineTo(1, 0),
            t.strokeStyle = box2d.b2Color.RED.MakeStyleString(1),
            t.stroke(),
            t.beginPath(),
            t.moveTo(0, 0),
            t.lineTo(0, 1),
            t.strokeStyle = box2d.b2Color.GREEN.MakeStyleString(1),
            t.stroke(),
            this.PopTransform(o)
    }
    ,
    Phaser.Physics.Box2D.DefaultDebugDraw.prototype.DrawPoint = function (o, t, e) {
        var i = this.context;
        i.fillStyle = e.MakeStyleString();
        var n = t / 2;
        i.fillRect(o.x - n, o.y - n, t, t)
    }
    ,
    Phaser.Physics.Box2D.DefaultDebugDraw.prototype.DrawAABB = function (o, t) {
        var e = this.context;
        e.strokeStyle = t.MakeStyleString();
        var i = o.lowerBound.x
            , n = o.lowerBound.y
            , s = o.upperBound.x - o.lowerBound.x
            , r = o.upperBound.y - o.lowerBound.y;
        e.strokeRect(i, n, s, r)
    }
    ,
    Object.defineProperty(Phaser.Physics.Box2D.DefaultDebugDraw.prototype, "shapes", {
        ...
        set: function (o) {
            o ? this.flags |= box2d.b2DrawFlags.e_shapeBit : this.flags &= ~box2d.b2DrawFlags.e_shapeBit
        }
    }),
    Object.defineProperty(Phaser.Physics.Box2D.DefaultDebugDraw.prototype, "joints", {
        ...
        set: function (o) {
            o ? this.flags |= box2d.b2DrawFlags.e_jointBit : this.flags &= ~box2d.b2DrawFlags.e_jointBit
        }
    }),
    Object.defineProperty(Phaser.Physics.Box2D.DefaultDebugDraw.prototype, "aabbs", {
        ...
        set: function (o) {
            o ? this.flags |= box2d.b2DrawFlags.e_aabbBit : this.flags &= ~box2d.b2DrawFlags.e_aabbBit
        }
    }),
    Object.defineProperty(Phaser.Physics.Box2D.DefaultDebugDraw.prototype, "pairs", {
        ...
        set: function (o) {
            o ? this.flags |= box2d.b2DrawFlags.e_pairBit : this.flags &= ~box2d.b2DrawFlags.e_pairBit
        }
    }),
    Object.defineProperty(Phaser.Physics.Box2D.DefaultDebugDraw.prototype, "centerOfMass", {
        ...
        set: function (o) {
            o ? this.flags |= box2d.b2DrawFlags.e_centerOfMassBit : this.flags &= ~box2d.b2DrawFlags.e_centerOfMassBit
        }
    }),
    Phaser.Physics.Box2D.DefaultContactListener = function () { }
    ,
    Phaser.Physics.Box2D.DefaultContactListener.prototype.BeginContact = function (o) {
        this.handleContactBeginOrEnd(o, !0)
    }
    ,
    Phaser.Physics.Box2D.DefaultContactListener.prototype.EndContact = function (o) {
        this.handleContactBeginOrEnd(o, !1)
    }
    ,
    Phaser.Physics.Box2D.DefaultContactListener.prototype.handleContactBeginOrEnd = function (o, t) {
        var e = o.GetFixtureA()
            , i = o.GetFixtureB()
            , n = e.GetBody()
            , s = i.GetBody()
            , r = e.GetFilterData().categoryBits
            , b = i.GetFilterData().categoryBits
            , a = n.parent
            , d = s.parent
            , l = a.id
            , x = d.id;
        a._bodyContactCallbacks[x] && a._bodyContactCallbacks[x].call(a._bodyContactCallbackContext[x], a, d, e, i, t, o),
            d._bodyContactCallbacks[l] && d._bodyContactCallbacks[l].call(d._bodyContactCallbackContext[l], d, a, i, e, t, o),
            a._fixtureContactCallbacks[i.id] && a._fixtureContactCallbacks[i.id].call(a._fixtureContactCallbackContext[i.id], a, d, e, i, t, o),
            d._fixtureContactCallbacks[e.id] && d._fixtureContactCallbacks[e.id].call(d._fixtureContactCallbackContext[e.id], d, a, i, e, t, o),
            a._fixtureContactCallbacks[e.id] && a._fixtureContactCallbacks[e.id].call(a._fixtureContactCallbackContext[e.id], a, a, e, e, t, o),
            d._fixtureContactCallbacks[i.id] && d._fixtureContactCallbacks[i.id].call(d._fixtureContactCallbackContext[i.id], d, d, i, i, t, o),
            a._categoryContactCallbacks[b] && a._categoryContactCallbacks[b].call(a._categoryContactCallbackContext[b], a, d, e, i, t, o),
            d._categoryContactCallbacks[r] && d._categoryContactCallbacks[r].call(d._categoryContactCallbackContext[r], d, a, i, e, t, o),
            a._categoryContactCallbacks[r] && a._categoryContactCallbacks[r].call(a._categoryContactCallbackContext[r], a, a, e, e, t, o),
            d._categoryContactCallbacks[b] && d._categoryContactCallbacks[b].call(d._categoryContactCallbackContext[b], d, d, i, i, t, o)
    }
    ,
    Phaser.Physics.Box2D.DefaultContactListener.prototype.PreSolve = function (o, t) {
        var e = o.GetFixtureA()
            , i = o.GetFixtureB()
            , n = e.GetBody()
            , s = i.GetBody()
            ...
            , l = a.id
            , x = d.id;
        a._bodyPresolveCallbacks[x] && a._bodyPresolveCallbacks[x].call(a._bodyPresolveCallbackContext[x], a, d, e, i, o, t),
            d._bodyPresolveCallbacks[l] && d._bodyPresolveCallbacks[l].call(d._bodyPresolveCallbackContext[l], d, a, i, e, o, t),
            a._fixturePresolveCallbacks[i.id] && a._fixturePresolveCallbacks[i.id].call(a._fixturePresolveCallbackContext[i.id], a, d, e, i, o, t),
            d._fixturePresolveCallbacks[e.id] && d._fixturePresolveCallbacks[e.id].call(d._fixturePresolveCallbackContext[e.id], d, a, i, e, o, t),
            a._categoryPresolveCallbacks[b] && a._categoryPresolveCallbacks[b].call(a._categoryPresolveCallbackContext[b], a, d, e, i, o, t),
            d._categoryPresolveCallbacks[r] && d._categoryPresolveCallbacks[r].call(d._categoryPresolveCallbackContext[r], d, a, i, e, o, t)
    }
    ,
    Phaser.Physics.Box2D.DefaultContactListener.prototype.PostSolve = function (o, t) {
        var e = o.GetFixtureA()
            , i = o.GetFixtureB()
            , n = e.GetBody()
            , s = i.GetBody()
            ...
            , l = a.id
            , x = d.id;
        a._bodyPostsolveCallbacks[x] && a._bodyPostsolveCallbacks[x].call(a._bodyPostsolveCallbackContext[x], a, d, e, i, o, t),
            d._bodyPostsolveCallbacks[l] && d._bodyPostsolveCallbacks[l].call(d._bodyPostsolveCallbackContext[l], d, a, i, e, o, t),
            a._fixturePostsolveCallbacks[i.id] && a._fixturePostsolveCallbacks[i.id].call(a._fixturePostsolveCallbackContext[i.id], a, d, e, i, o, t),
            d._fixturePostsolveCallbacks[e.id] && d._fixturePostsolveCallbacks[e.id].call(d._fixturePostsolveCallbackContext[e.id], d, a, i, e, o, t),
            a._categoryPostsolveCallbacks[b] && a._categoryPostsolveCallbacks[b].call(a._categoryPostsolveCallbackContext[b], a, d, e, i, o, t),
            d._categoryPostsolveCallbacks[r] && d._categoryPostsolveCallbacks[r].call(d._categoryPostsolveCallbackContext[r], d, a, i, e, o, t)
    }
    ,
    ...
    ,
    Phaser.Physics.Box2D.Polygon.prototype.setFromFlatXYCoords = function (o) {
        this.vertices = [];
        for (var t = 0; t < o.length / 2; t++)
            this.vertices.push({
                x: o[2 * t],
                y: o[2 * t + 1]
            })
    ...
    ,
    Phaser.Physics.Box2D.Polygon.prototype.setFromXYObjects = function (o) {
        this.vertices = o.concat()
    }
    ,
    Phaser.Physics.Box2D.Polygon.prototype.addVertex = function (o) {
        this.vertices.push(o)
    }
    ,
    Phaser.Physics.Box2D.Polygon.prototype.at = function (o) {
        var t = this.vertices.length;
        return this.vertices[o < 0 ? o % t + t : o % t]
    }
    ,
    Phaser.Physics.Box2D.Polygon.prototype.indicesAreAdjacent = function (o, t) {
        if ((o %= this.vertices.length) == (t %= this.vertices.length))
            return !0;
        var e = Math.abs(o - t);
        return e < 2 || e == this.vertices.length - 1
    }
    ,
    Phaser.Physics.Box2D.Polygon.prototype.areaInTriangle = function (o, t, e) {
        return o = this.at(o),
            t = this.at(t),
            e = this.at(e),
            .5 * ((t.x - o.x) * (e.y - o.y) - (e.x - o.x) * (t.y - o.y))
    }
    ,
    Phaser.Physics.Box2D.Polygon.prototype.left = function (o, t, e) {
        return this.areaInTriangle(o, t, e) > 0
    }
    ,
    Phaser.Physics.Box2D.Polygon.prototype.leftOn = function (o, t, e) {
        return this.areaInTriangle(o, t, e) >= 0
    }
    ,
    Phaser.Physics.Box2D.Polygon.prototype.right = function (o, t, e) {
        return this.areaInTriangle(o, t, e) < 0
    }
    ,
    Phaser.Physics.Box2D.Polygon.prototype.rightOn = function (o, t, e) {
        return this.areaInTriangle(o, t, e) <= 0
    }
    ,
    Phaser.Physics.Box2D.Polygon.sqdist = function (o, t) {
        var e = t.x - o.x
            , i = t.y - o.y;
        return e * e + i * i
    }
    ...
    Phaser.Physics.Box2D.Polygon.prototype.makeCCW = function () {
        for (var o = 0, t = 1, e = this.vertices.length; t < e; t++)
            (this.at(t).y < this.at(o).y || this.at(t).y === this.at(o).y && this.at(t).x > this.at(o).x) && (o = t);
        return !this.left(o - 1, o, o + 1) && (this.vertices.reverse(),
            !0)
    }
    ,
    Phaser.Physics.Box2D.Polygon.prototype.isConvex = function () {
        for (var o = !1, t = !1, e = 0, i = this.vertices.length; e < i; e++) {
            var n = e
                , s = (e + 1) % i
                , r = (e + 2) % i;
            this.areaInTriangle(this.vertices[n], this.vertices[s], this.vertices[r]) > 0 ? o = !0 : t = !0
        }
        return t ^ o
    }
    ,
    Phaser.Physics.Box2D.Polygon.prototype.isReflex = function (o) {
        return this.right(o - 1, o, o + 1)
    }
    ,
    Phaser.Physics.Box2D.Polygon.areVecsEqual = function (o, t) {
        return o.x == t.x && o.y == t.y
    }
    ,
    Phaser.Physics.Box2D.Polygon.linesCross = function (o, t, e, i) {
        if (Phaser.Physics.Box2D.Polygon.areVecsEqual(t, e) || Phaser.Physics.Box2D.Polygon.areVecsEqual(o, e) || Phaser.Physics.Box2D.Polygon.areVecsEqual(t, i) || Phaser.Physics.Box2D.Polygon.areVecsEqual(o, i))
            return null;
        var n = {};
        box2d.b2SubVV(t, o, n),
            box2d.b2CrossVS(n, 1, n);
        var s = box2d.b2DotVV(n, o)
            , r = box2d.b2DotVV(n, e)
            , b = box2d.b2DotVV(n, i);
        if (r > s && b > s)
            return null;
        ...
        var a = {};
        box2d.b2SubVV(i, e, a),
            box2d.b2CrossVS(a, 1, a);
        r = box2d.b2DotVV(a, e),
            s = box2d.b2DotVV(a, o);
        var d = box2d.b2DotVV(a, t);
        if (s > r && d > r)
            return null;
        if (s < r && d < r)
            return null;
    ...
    ,
    Phaser.Physics.Box2D.Polygon.prototype.canSee = function (o, t) {
        if (this.indicesAreAdjacent(o, t))
            return !1;
        if (this.leftOn(o + 1, o, t) && this.rightOn(o - 1, o, t))
            return !1;
        for (var e = 0; e < this.vertices.length; ++e)
            if ((e + 1) % this.vertices.length != o && e != o && this.leftOn(o, t, e + 1) && this.rightOn(o, t, e) && Phaser.Physics.Box2D.Polygon.linesCross(this.at(o), this.at(t), this.at(e), this.at(e + 1)))
                return !1;
        return !0
    }
    ,
    Phaser.Physics.Box2D.Polygon.prototype.subPolygon = function (o, t) {
        var e = new Phaser.Physics.Box2D.Polygon;
        if (o < t)
            for (var i = o; i < t + 1; i++)
                e.addVertex(this.at(i));
        else {
            for (i = o; i < this.vertices.length; i++)
                e.addVertex(this.at(i));
            for (i = 0; i < t + 1; i++)
                e.addVertex(this.at(i))
        }
    ...
    ,
    Phaser.Physics.Box2D.Polygon.prototype.decomposeOptimal = function (o) {
        if (void 0 === o && (o = 0),
            o > 1)
            return this.vertices;
        this.makeCCW();
        for (var t = [], e = [], i = [], n = Number.MAX_VALUE, s = 0; s < this.vertices.length; s++)
            if (this.isReflex(s))
                for (var r = 0; r < this.vertices.length; r++)
                    this.canSee(s, r) && (e = this.subPolygon(s, r).decompose(o + 1),
                        i = this.subPolygon(r, s).decompose(o + 1),
                        e.length + i.length < n && (n = (t = e.concat(i)).length));
        return 0 === t.length && t.push(this.vertices),
            t
    }
    ,
    Phaser.Physics.Box2D.Polygon.prototype.decompose = function (o) {
        void 0 === o && (o = 0),
            this.makeCCW();
        for (var t, e, i = [], n = Number.MAX_VALUE, s = !1, r = 0; r < this.vertices.length; r++)
            if (this.isReflex(r)) {
                s = !0;
                for (var b = this.at(r), a = 0; a < this.vertices.length; a++)
                    if (this.canSee(r, a)) {
                        var d = this.at(a)
                            , l = d.x - b.x
                            , x = d.y - b.y
        ...
        if (!s && this.vertices.length > 8 && (t = 0,
            e = Math.floor(this.vertices.length / 2),
            s = !0),
            s) {
            var m = this.subPolygon(t, e).decompose(o + 1)
                , h = this.subPolygon(e, t).decompose(o + 1);
            i = m.concat(h)
        }
        return 0 === i.length && i.push(this.vertices),
            i
    }